<script module>
	 ...
	 * @param {import('swarpc').SwarpcClient<typeof import('$ww/procedures.js').PROCEDURES>} swarpc
	 * @param {File[]} files
	 */
	...
	/**
	 * @param {import('swarpc').SwarpcClient<typeof import('$ww/procedures.js').PROCEDURES>} swarp
	 * @param {object} file
