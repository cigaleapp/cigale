...
const protocol = {
	...
	metadata: {
		...
		[namespaced('conservation_status')]: {
			...
			learnMore: 'https://iucnredlist.org/',
			required: false,
			mergeMethod: 'average',
			groupable: true,
			sortable: true,
			options: [
				{
					...
					color: '#16ca85',
					learnMore: 'https://iucnredlist.org/search?redListCategory=lc',
				},
				{
					key: 'nt',
					label: 'NT',
					...
					color: '#006666',
					learnMore: 'https://iucnredlist.org/search?redListCategory=nt',
				},
				{
					key: 'vu',
					label: 'VU',
					...
					color: '#cd9a00',
					learnMore: 'https://iucnredlist.org/search?redListCategory=vu',
				},
				{
					key: 'en',
					label: 'EN',
					...
					color: '#cd6630',
					learnMore: 'https://iucnredlist.org/search?redListCategory=en',
				},
				{
					key: 'cr',
					label: 'CR',
					...
					color: '#cd3030',
					learnMore: 'https://iucnredlist.org/search?redListCategory=cr',
				},
				{
					key: 'ew',
					label: 'EW',
					...
					color: '#3a3a3a',
					learnMore: 'https://iucnredlist.org/search?redListCategory=ew',
				},
				{
					key: 'ex',
					label: 'EX',
					...
					color: '#000000',
					learnMore: 'https://iucnredlist.org/search?redListCategory=ex',
				},
			],
		},
	...
	JSON.stringify(
		{
			...
			summary: 'Version légère de Exemple: arthropodes',
