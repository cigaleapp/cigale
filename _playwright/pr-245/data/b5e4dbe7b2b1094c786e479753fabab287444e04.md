...
```
Error: expect.toBeVisible: Error: strict mode violation: locator('main').locator('img') resolved to 2 elements:
...
Call log:
  ...
  - waiting for locator('main').locator('img')
    ...
    at checkImageTransforms (/home/runner/work/cigale/cigale/tests/cropper.spec.js:360:18)
