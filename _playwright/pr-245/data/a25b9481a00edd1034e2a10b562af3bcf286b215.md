...
Error: locator.evaluate: Error: strict mode violation: locator('main').locator('img') resolved to 2 elements:
    1) <img alt="" class="svelte-1ltywgb" src="blob:http://localhost:4173/f056efaf-9279-4988-b2a7-39ee637cafa7"/> aka locator('img').first()
    2) <img alt="" aria-hidden="true" class="svelte-1ltywgb" src="blob:http://localhost:4173/f056efaf-9279-4988-b2a7-39ee637cafa7"/> aka locator('img').nth(1)

Call log:
  - waiting for locator('main').locator('img')

    at checkImageTransforms (/home/runner/work/cigale/cigale/tests/cropper.spec.js:364:28)
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:398:4
```
