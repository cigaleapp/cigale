...
- Name: Cropper view >> zooming and panning >> recalls zoom and pan between image changes
- Location: /home/runner/work/cigale/cigale/tests/cropper.spec.js:439:3

# Error details

```
Error: locator.evaluate: Error: strict mode violation: locator('main').locator('img') resolved to 2 elements:
    1) <img alt="" class="svelte-1ltywgb" src="blob:http://localhost:4173/3a0db546-90c8-4f3f-a05c-0c55c2bbfe2d"/> aka locator('img').first()
    2) <img alt="" aria-hidden="true" class="svelte-1ltywgb" src="blob:http://localhost:4173/3a0db546-90c8-4f3f-a05c-0c55c2bbfe2d"/> aka locator('img').nth(1)

Call log:
  - waiting for locator('main').locator('img')

    at checkImageTransforms (/home/runner/work/cigale/cigale/tests/cropper.spec.js:364:28)
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:441:4
```
