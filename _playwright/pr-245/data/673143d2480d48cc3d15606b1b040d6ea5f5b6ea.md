...
```
Error: locator.evaluate: Error: strict mode violation: locator('main').locator('img') resolved to 2 elements:
    1) <img alt="" class="svelte-1ltywgb" src="blob:http://localhost:4173/254298d4-edd8-4b86-8ce4-4d11fa7f2dac"/> aka locator('img').first()
    2) <img alt="" aria-hidden="true" class="svelte-1ltywgb" src="blob:http://localhost:4173/254298d4-edd8-4b86-8ce4-4d11fa7f2dac"/> aka locator('img').nth(1)

Call log:
  - waiting for locator('main').locator('img')

    at checkImageTransforms (/home/runner/work/cigale/cigale/tests/cropper.spec.js:364:28)
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:382:4
```
