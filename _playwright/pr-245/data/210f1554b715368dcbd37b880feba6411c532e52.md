...
- Name: Cropper view >> zooming and panning >> should pan with the mouse
- Location: /home/runner/work/cigale/cigale/tests/cropper.spec.js:419:3

# Error details

```
Error: locator.evaluate: Error: strict mode violation: locator('main').locator('img') resolved to 2 elements:
    1) <img alt="" class="svelte-1ltywgb" src="blob:http://localhost:4173/ffae82ba-737a-46d1-be08-c0520ffee170"/> aka locator('img').first()
    2) <img alt="" aria-hidden="true" class="svelte-1ltywgb" src="blob:http://localhost:4173/ffae82ba-737a-46d1-be08-c0520ffee170"/> aka locator('img').nth(1)

Call log:
  - waiting for locator('main').locator('img')

    at checkImageTransforms (/home/runner/work/cigale/cigale/tests/cropper.spec.js:364:28)
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:426:4
```
