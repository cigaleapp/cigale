...
```ts
   ...
   42 | 				await page.waitForURL((u) => u.hash === '#/crop/000001');
   ...
   59 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
   60 | 			await page.waitForTimeout(1000);
   61 | 			await page.getByRole('button', { name: 'Continuer' }).click();
   62 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
   ...
   68 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
   ...
   77 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
   78 |
   ...
   95 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
   96 | 			await page.waitForTimeout(1000);
   97 | 			await page.getByRole('button', { name: 'Continuer' }).click();
   98 | 			await page.waitForURL((u) => u.hash === '#/crop/000002');
  ...
  104 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
  105 | 			await page.waitForTimeout(1000);
  106 | 			await page.keyboard.press('Space');
  107 | 			await page.waitForURL((u) => u.hash === '#/crop/000002');
  ...
  113 | 			await page.waitForURL((u) => u.hash === '#/crop/000001');
  114 |
...
> 119 | 			expect(cropAutoNext).toBe(false);
  ...
  147 | 			await page.waitForURL((u) => u.hash === '#/crop/000002');
