...
- Location: /home/runner/work/cigale/cigale/tests/cropper.spec.js:234:4
...
Call log:
  ...
  - waiting for getByText('Confirmé', { exact: true })
    ...
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:238:50
```
...
> 238 | 				await expect(confirmedCropOverlay(page)).not.toBeVisible();
  ...
  294 |
  295 | /**
  296 |  * Gets the confirmed crop status of the image with the given id in the database.
  297 |  * @param {import('@playwright/test').Page} page
  298 |  * @param {string} id
  299 |  */
  300 | async function isImageConfirmedInDatabase(page, id) {
  301 | 	const image = await getImage({ page }, id);
  302 | 	return (
  303 | 		image?.metadata?.['io.github.cigaleapp.arthropods.transects__crop_is_confirmed']?.value ===
  304 | 		'true'
  305 | 	);
  306 | }
  307 |
