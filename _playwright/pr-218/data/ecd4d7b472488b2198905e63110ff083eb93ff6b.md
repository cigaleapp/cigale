...
Expected: true
Received: false
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:83:25
```
...
- article:
  - img
  - paragraph: Erreur lors de l'extraction des métadonnées EXIF pour cyan.jpeg
  - button:
    - img
- article:
  - img
  - paragraph: Erreur lors de l'extraction des métadonnées EXIF pour leaf.jpeg
  - button:
    - img
- img
- paragraph: Confirmé
...
index b4c0550..dcad8bb 100644
--- a/src/lib/idb.svelte.js
+++ b/src/lib/idb.svelte.js
@@ -403,6 +403,14 @@ export async function openDatabase() {
 		}
 	});
