...
- Location: /home/runner/work/cigale/cigale/tests/cropper.spec.js:39:4
...
Call log:
  ...
  - waiting for getByText(/Cliquer ou déposer des images ici/)
    ...
    at importPhotos (/home/runner/work/cigale/cigale/tests/utils.js:22:68)
    at /home/runner/work/cigale/cigale/tests/cropper.spec.js:6:3
```
...
```ts
   ...
   2 | import { match } from 'arktype';
   3 | import { readdirSync } from 'node:fs';
   4 | import path from 'node:path';
   5 |
   6 | /**
   7 |  * @import { Page } from '@playwright/test';
   8 |  * @import { Settings, MetadataValue } from '$lib/database.js';
   9 |  */
   10 |
   11 | /**
   12 |  *
