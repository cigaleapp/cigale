...
Expected: < 10
Received:   10
    at expectBoxInList (/home/runner/work/cigale/cigale/tests/cropper.spec.js:350:42)
...
```ts
  ...
  347 | 		.map(Number);
  348 |
  349 | 	expect(Math.abs(width - actualWidth)).toBeLessThan(tolerance);
> 350 | 	expect(Math.abs(height - actualHeight)).toBeLessThan(tolerance);
      | 	                                        ^ Error: expect(received).toBeLessThan(expected)
  351 | }
  352 |
  353 | /**
