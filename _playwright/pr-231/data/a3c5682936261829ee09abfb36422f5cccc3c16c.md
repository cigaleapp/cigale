...
Call log:
  ...
  45 × retrying click action
       ...
       - scrolling into view if needed
       - done scrolling
       - <img alt="lil-fella.jpeg" class="svelte-1uv3axg" src="blob:http://localhost:4173/d1054732-12a9-4cc9-9334-80bcc07b601d"/> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
