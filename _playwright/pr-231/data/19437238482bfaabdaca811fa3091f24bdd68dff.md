...
Call log:
  ...
  51 × retrying click action
       ...
       - scrolling into view if needed
       - done scrolling
       - <img alt="lil-fella.jpeg" class="svelte-1uv3axg" src="blob:http://localhost:4173/ab77ed52-b684-4fdc-9a74-5af9abd2f74c"/> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
