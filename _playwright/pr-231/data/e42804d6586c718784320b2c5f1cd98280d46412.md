...
```
Error: expect.toBeVisible: Error: strict mode violation: getByText('leaf.jpeg', { exact: true }) resolved to 2 elements:
    1) <h2 class="svelte-1uv3axg">leaf.jpeg</h2> aka locator('[id="\\30 00001"]').getByRole('heading', { name: 'leaf.jpeg' })
    2) <h2 class="svelte-1uv3axg">leaf.jpeg</h2> aka locator('#loading_1').getByRole('heading', { name: 'leaf.jpeg' })
