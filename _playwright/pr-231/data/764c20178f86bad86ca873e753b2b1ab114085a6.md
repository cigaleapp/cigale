...
- Name: missing analysis file >> fails with the appriopriate error message
- Location: /home/runner/work/cigale/cigale/tests/import.spec.js:187:2
...
Call log:
  ...
  - waiting for getByText('Analyse…').first()
    ...
    at /home/runner/work/cigale/cigale/tests/import.spec.js:184:3
```
...
- article:
  - img
  - paragraph: Aucun fichier d'analyse trouvé dans l'export no-analysis.zip
  - button:
    - img
- main:
  - form:
