...
-       "Deuterosminthurus bicinctus_1.jpeg",
+       "Allacma fusca_5.jpeg",
        "Deuterosminthurus bicinctus_3.jpeg",
-       "Seira ferrarii_1.jpeg",
-       "Seira ferrarii_3.jpeg",
-       "_5.jpeg",
+       "Deuterosminthurus bicinctus_4.jpeg",
+       "Deuterosminthurus bicinctus_5.jpeg",
+       "Seira ferrarii_2.jpeg",
+       "Seira ferrarii_4.jpeg",
+       "Seira ferrarii_5.jpeg",
      ],
    },
    Object {
      "Original": Array [
...
> 143 | 		expect(readdirTreeSync(resultsDir)).toMatchObject([
  ...
  174 | 		await importResults(page, 'no-originals.zip', { waitForLoading: false });
  175 | 	});
  176 |
  ...
  184 | 		await importResults(page, 'no-analysis.zip', { waitForLoading: false });
  185 | 	});
  186 |
  ...
  194 | 		await importResults(page, 'wrong-protocol.zip', { waitForLoading: false });
  195 | 	});
  196 |
  ...
  204 | 		await importResults(page, 'invalid-json-analysis.zip', { waitForLoading: false });
  205 | 	});
  206 |
