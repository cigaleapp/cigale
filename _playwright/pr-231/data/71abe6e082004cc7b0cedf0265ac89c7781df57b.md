...
> 143 | 		expect(readdirTreeSync(resultsDir)).toMatchObject([
  ...
  148 | 					'Allacma fusca_5.jpeg',
  149 | 					'Deuterosminthurus bicinctus_3.jpeg',
  150 | 					'Seira ferrarii_2.jpeg'
  151 | 				]
  152 | 			},
  153 | 			{
  154 | 				Original: [
  ...
  157 | 					'Allacma fusca_5.jpeg',
  158 | 					'Deuterosminthurus bicinctus_3.jpeg',
  159 | 					'Seira ferrarii_2.jpeg'
  160 | 				]
  161 | 			},
  162 | 			'analysis.json',
  163 | 			'metadata.csv'
...
@@ -527,7 +587,7 @@ export function metadataPrettyValue(metadata, value) {
  ...
  * To be used with `metadataPrettyVal
```