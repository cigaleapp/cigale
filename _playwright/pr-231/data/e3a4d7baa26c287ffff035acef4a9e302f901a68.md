...
- Name: missing original photos >> fails with the appriopriate error message
- Location: /home/runner/work/cigale/cigale/tests/import.spec.js:177:2
...
Call log:
  ...
  - waiting for getByText('Analyse…').first()
    ...
    at /home/runner/work/cigale/cigale/tests/import.spec.js:174:3
```
...
- article:
  - img
  - paragraph: Aucune image trouvée dans l'export no-originals.zip. L'export doit contenir les images originales, pas seulement les images recadrées
  - button:
    - img
- main:
  - form:
