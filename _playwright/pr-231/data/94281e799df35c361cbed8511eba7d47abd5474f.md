...
Call log:
  - waiting for getByText(/et images originales/i)
    - locator resolved to <label class="radio svelte-qndy3s">…</label>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <h1 class="svelte-g51rh3">Choisir un protocole</h1> from <div class="contents svelte-1s1jxo8 padded">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <section class="loading svelte-1h8tzpn">…</section> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <input multiple type="file" class="svelte-izvmqg" accept="image/jpeg,application/zip,image/png,image/tiff,.cr2,.rw2,.dng,.crw,.raw,.cr3"/> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 100ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="loading-overlay svelte-1uv3axg">…</div> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  46 × retrying click action
       ...
       - scrolling into view if needed
       - done scrolling
       - <img alt="lil-fella.jpeg" class="svelte-1uv3axg" src="blob:http://localhost:4173/af5cb361-7c36-49d5-aafd-10a2792c210b"/> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms

    at /home/runner/work/cigale/cigale/tests/import.spec.js:127:49
```
...
> 127 | 		await page.getByText(/et images originales/i).click();
  ...
  144 | 			{
  145 | 				Cropped: [
  146 | 					'Allacma fusca_2.jpeg',
  147 | 					'Allacma fusca_4.jpeg',
  148 | 					'Deuterosminthurus bicinctus_1.jpeg',
  149 | 					'Deuterosminthurus bicinctus_3.jpeg',
  150 | 					'Seira ferrarii_1.jpeg',
  151 | 					'Seira ferrarii_3.jpeg',
  152 | 					'_5.jpeg'
  153 | 				]
  154 | 			},
  155 | 			{
  ...
  158 | 					'Allacma fusca_4.jpeg',
  159 | 					'Deuterosminthurus bicinctus_1.jpeg',
  160 | 					'Deuterosminthurus bicinctus_3.jpeg',
  161 | 					'Seira ferrarii_1.jpeg',
  162 | 					'Seira ferrarii_3.jpeg',
  163 | 					'_5.jpeg'
  164 | 				]
  165 | 			},
  166 | 			'analysis.json',
  ...
  170 | });
  171 |
  172 | test.describe('missing original photos', () => {
  173 | 	test.beforeEach(async ({ page }) => {
  174 | 		await importResults(page, 'no-originals.zip');
  175 | 	});
  176 |
  177 | 	test('fails with the appriopriate error message', async ({ page }) => {
  178 | 		await expect(toast(page, 'Aucune image trouvée', { type: 'error' })).toBeVisible();
  179 | 	});
  180 | });
  181 |
  182 | test.describe('missing analysis file', () => {
  183 | 	test.beforeEach(async ({ page }) => {
  184 | 		await importResults(page, 'no-analysis.zip');
  185 | 	});
  186 |
  187 | 	test('fails with the appriopriate error message', async ({ page }) => {
  188 | 		await expect(toast(page, "Aucun fichier d'analyse", { type: 'error' })).toBeVisible();
  189 | 	});
  190 | });
  191 |
  192 | test.describe('wrong protocol used', () => {
  193 | 	test.beforeEach(async ({ page }) => {
  194 | 		await importResults(page, 'wrong-protocol.zip');
  195 | 	});
  196 |
  197 | 	test('fails with the appriopriate error message', async ({ page }) => {
  198 | 		await expect(toast(page, 'le protocole actuel est', { type: 'error' })).toBeVisible();
  199 | 	});
  200 | });
  201 |
  202 | test.describe('invalid json analysis', async () => {
  203 | 	test.beforeEach(async ({ page }) => {
  204 | 		await importResults(page, 'invalid-json-analysis.zip');
  205 | 	});
  206 |
  207 | 	test('fails with the appriopriate error message', async ({ page }) => {
  208 | 		await expect(toast(page, 'JSON', { type: 'error' })).toBeVisible();
  209 | 	});
  210 | });
  211 |
```
