...
- Name: wrong protocol used >> fails with the appriopriate error message
- Location: /home/runner/work/cigale/cigale/tests/import.spec.js:197:2
...
Locator: getByText('Analyse…').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Analyse…').first()

    at importResults (/home/runner/work/cigale/cigale/tests/utils.js:189:51)
    at /home/runner/work/cigale/cigale/tests/import.spec.js:194:3
```
...
- article:
  - img
  - paragraph: Le fichier d'analyse de wrong-protocol.zip a été exporté avec le protocole io.github.cigaleapp.arthropods.another, mais le protocole actuel est io.github.cigaleapp.arthropods.transects
  - button:
    - img
- main:
  - form:
