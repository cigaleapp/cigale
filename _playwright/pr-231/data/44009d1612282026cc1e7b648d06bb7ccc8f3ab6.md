...
- Location: /home/runner/work/cigale/cigale/tests/import.spec.js:11:2
...
Call log:
  ...
  - waiting for getByText('leaf.jpeg', { exact: true })
    ...
    at /home/runner/work/cigale/cigale/tests/import.spec.js:14:62
```
...
```ts
   ...
   8 | 		importResults(page, 'correct.zip');
   9 | 	});
   10 |
