...
```
ParseError: The intersection of distinct morphs at a single path is indeterminate:
Left: (In: [string, string]) => Out<unknown>
Right: (In: [{ [string]: unknown }, string]) => Out<unknown>
    at throwError (/home/runner/work/cigale/cigale/node_modules/@ark/util/out/errors.js:5:11)
    at throwParseError (/home/runner/work/cigale/cigale/node_modules/@ark/util/out/errors.js:10:43)
    at morph (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/morph.js:37:24)
    at _intersectNodes (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/shared/intersections.js:62:16)
    at intersectOrPipeNodes (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/shared/intersections.js:36:39)
    at intersectNodesRoot (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/shared/intersections.js:5:48)
    at MorphNode.rawIntersect (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/root.js:87:16)
    at MorphNode.intersect (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/root.js:81:29)
    at MorphNode.overlaps (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/root.js:195:35)
    at /home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/union.js:487:64
    at orderCandidates (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/union.js:476:41)
    at UnionNode.discriminate (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/union.js:371:50)
    at UnionNode.<instance_members_initializer> (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/union.js:139:25)
    at UnionNode (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/roots/union.js:117:8)
    at createNode (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/parse.js:170:18)
    at parseNode (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/parse.js:101:18)
    at InternalScope.node (/home/runner/work/cigale/cigale/node_modules/@ark/schema/out/scope.js:362:22)
    at InternalChainedMatchParser.default (/home/runner/work/cigale/cigale/node_modules/arktype/out/match.js:81:30)
    at sort (/home/runner/work/cigale/cigale/tests/utils.js:169:13)
    at readdirTreeSync (/home/runner/work/cigale/cigale/tests/utils.js:156:16)
    at /home/runner/work/cigale/cigale/tests/core.spec.js:69:9
```
...
```ts
   69 |  */
   70 | export async function getImage({ page }, id) {
   71 | 	const image = await page.evaluate(async ([id]) => {
   72 | 		const image = await window.DB.get('Image', id);
   73 | 		if (!image) throw new Error(`Image ${id} not found in the database`);
   74 | 		return image;
   75 | 	}, /** @type {const} */ ([id]));
   76 | 	return image;
   77 | }
   ...
   83 |  */
   84 | export async function listTable(page, tableName) {
   85 | 	const table = await page.evaluate(async ([tableName]) => {
   86 | 		const table = await window.DB.getAll(tableName);
   87 | 		if (!table) throw new Error(`Table ${tableName} not found in the database`);
   88 | 		return table;
   89 | 	}, /** @type {const} */ ([tableName]));
   90 | 	return table;
   91 | }
   92 |
   93 | /**
   ...
   96 |  * @param {Page} param0.page
   97 |  * @param {string} id
   98 |  * @param {Record<string, MetadataValue>} metadata
   99 |  */
  100 | export async function setImageMetadata({ page }, id, metadata) {
  101 | 	await page.evaluate(async ([id, metadata]) => {
  102 | 		const image = await window.DB.get('Image', id);
  103 | 		if (!image) throw new Error(`Image ${id} not found in the database`);
  104 | 		await window.DB.put('Image', {
  105 | 			...image,
  106 | 			metadata: {
  107 | 				...image.metadata,
  108 | 				...Object.fromEntries(
  109 | 					Object.entries(metadata).map(([key, { value, ...rest }]) => [
  110 | 						key,
  111 | 						{ ...rest, value: JSON.stringify(value) }
  112 | 					])
  113 | 				)
  114 | 			}
  115 | 		});
  116 | 		console.log('Image updated, refreshing DB', { id, metadata });
  117 | 		await window.refreshDB();
  118 | 	}, /** @type {const} */ ([id, metadata]));
  119 | }
  120 |
  121 | /**
  122 |  *
  123 |  * @param {Page} page
  124 |  */
  125 | export async function chooseDefaultProtocol(page) {
  126 | 	// Choose default protocol
  127 | 	await expect(page.getByTestId('protocol-to-choose')).toBeVisible({ timeout: 20_000 });
  128 | 	await page.getByTestId('protocol-to-choose').click();
  129 | 	await page.waitForURL((u) => u.hash === '#/import');
  130 | }
  131 |
  132 | /**
  133 |  * @template {*} Leaf
  134 |  * @typedef {Array<Leaf | { [dir: string]: ArrayTree<Leaf> }>} ArrayTree
  135 |  */
  136 |
  137 | /**
  138 |  *
  139 |  * @param {string} root
  140 |  * @returns {ArrayTree<string>}
  141 |  */
  142 | export function readdirTreeSync(root) {
  143 | 	const result = [];
  144 | 	const files = readdirSync(root, { withFileTypes: true });
  145 | 	for (const file of files) {
  146 | 		if (file.isDirectory()) {
  147 | 			result.push({
  148 | 				[file.name]: readdirTreeSync(path.join(root, file.name))
  149 | 			});
  150 | 		} else {
  151 | 			result.push(file.name);
  152 | 		}
  153 | 	}
  154 |
  155 | 	const Dir = type({ '[string]': 'unknown' });
  156 | 	return result.sort((a, b) => {
  157 | 		console.log({ sorting: [a, b] });
  158 | 		return (
  159 | 			match
  160 | 				// Sort directories before files
  161 | 				.case(['string', Dir], () => -1)
  162 | 				.case([Dir, 'string'], () => 1)
  163 | 				.case(['string', 'string'], ([a, b]) => a.localeCompare(b))
  164 | 				.case([Dir, Dir], ([a, b]) => {
  165 | 					const aName = Object.keys(a)[0];
  166 | 					const bName = Object.keys(b)[0];
  167 | 					return aName.localeCompare(bName);
  168 | 				})
> 169 | 				.default(() => 0)([a, b])
      | 				        ^ ParseError: The intersection of distinct morphs at a single path is indeterminate:
  170 | 		);
  ...
  175 |  *
  176 |  * @param {Page} page
  177 |  * @param {string|RegExp} message
  178 |  * @param {object} options
  179 |  * @param {boolean} [options.exact]
  180 |  * @param {undefined | import('$lib/toasts.svelte').Toast<null>['type']} [options.type]
  181 |  */
  182 | export function toast(page, message, { exact = false, type = undefined }) {
  183 | 	const area = page.getByTestId('toasts-area');
  184 |
  185 | 	if (type) {
  186 | 		return area.locator(`[data-type='${type}']`).getByText(message, { exact });
  187 | 	}
  188 |
  189 | 	return area.getByText(message, { exact });
  190 | }
  191 |
  192 | /**
  193 |  * @param {import('@playwright/test').Page} page
  194 |  * @param {string} filepath to the zip file, relative to tests/fixtures/exports
  195 |  * @param {object} [options]
  196 |  * @param {boolean} [options.waitForLoading] wait for loading to finish
  197 |  */
  198 | export async function importResults(page, filepath, { waitForLoading = true } = {}) {
  199 | 	await setSettings({ page }, { showTechnicalMetadata: false });
  200 | 	await chooseDefaultProtocol(page);
  201 | 	// Import fixture zip
  202 | 	await expect(page.getByText(/Cliquer ou déposer/)).toBeVisible();
  203 | 	const fileInput = await page.$("input[type='file']");
  204 | 	await fileInput?.setInputFiles(path.join('./tests/fixtures/exports/', filepath));
  205 | 	if (waitForLoading) {
  206 | 		await expect(page.getByText('Analyse…').first()).toBeVisible();
  207 | 		await expect(page.getByText('Analyse…')).toHaveCount(0, { timeout: 10_000 });
  208 | 	}
  209 | }
  210 |
```
