...
Call log:
  ...
  45 × retrying click action
       ...
       - scrolling into view if needed
       - done scrolling
       - <img alt="lil-fella.jpeg" class="svelte-1uv3axg" src="blob:http://localhost:4173/901ef764-8083-4c17-b432-cec3f2b374f7"/> from <div class="contents svelte-1s1jxo8">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
