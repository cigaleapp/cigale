import"../chunks/DsnmJJEf.js";import{aq as Fe,u as fe,av as xe,a4 as i,au as we,b as g,c as w,n as Je,ap as n,al as f,a as o,ar as Te,as as a,d as Le,aw as P,r as e,aL as H,at as Ke,bf as He}from"../chunks/zBAWzje7.js";import{s as t}from"../chunks/CZenHaKa.js";import{a as Me}from"../chunks/BI7krZVD.js";import{i as A}from"../chunks/CXG01tER.js";import{e as ae}from"../chunks/DdI-Fn14.js";import{c as ve}from"../chunks/C2PmX9ra.js";import{L as Re}from"../chunks/GyuhWS1g.js";import{s as Ee}from"../chunks/YDBw-ktk.js";import{g as M}from"../chunks/B0nJzvm_.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ve=je,Ne=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ce():s==="fr"?je():Ve()},Ze=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ze():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??M();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??M();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
