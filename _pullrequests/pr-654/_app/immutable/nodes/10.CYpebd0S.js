import"../chunks/DsnmJJEf.js";import{ao as He,d as ye,ax as fe,g as i,aw as we,h as g,j as w,n as Ie,aq as n,av as y,a as o,ap as Fe,ar as a,k as Je,at as T,l as e,au as L,as as Me,b9 as Le}from"../chunks/pLBs-mSF.js";import{s as t}from"../chunks/Dos-s29q.js";import{a as Ee}from"../chunks/VdNrGBfb.js";import{i as A}from"../chunks/C3Fbln-z.js";import{e as ae}from"../chunks/DbKxOvJB.js";import{c as xe}from"../chunks/DIQ6b9wY.js";import{L as Ke}from"../chunks/e4UGFwRT.js";import{s as Re}from"../chunks/0-DflsyC.js";import{g as E}from"../chunks/DgtYXTMU.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ze=je,Ve=(h={},d={})=>{const s=d.locale??E();return s==="en"?Ce():s==="fr"?je():Ze()},Ne=()=>"About",ke=()=>"À propos",_e=ke,$e=(h={},d={})=>{const s=d.locale??E();return s==="en"?Ne():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(h={},d={})=>{const s=d.locale??E();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(h={},d={})=>{const s=d.locale??E();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:h=>{h=String(h);try{return JSON.parse(h)}catch{return JSON.parse(h.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
