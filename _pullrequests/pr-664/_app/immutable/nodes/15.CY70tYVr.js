import"../chunks/DsnmJJEf.js";import{at as Be,u as fe,aD as xe,h as i,aE as we,b as g,c as w,n as Je,aw as n,au as f,a as o,av as Te,ax as a,d as Le,aB as P,r as e,aC as H,j as Ke,bp as He}from"../chunks/CubkaVmg.js";import{a as t}from"../chunks/BMJp6fNn.js";import{a as Me}from"../chunks/C8Wz2FmG.js";import{i as A}from"../chunks/4o0HRM5L.js";import{e as ae}from"../chunks/DvoZMz7y.js";import{c as ve}from"../chunks/D9W2sM1Y.js";import{L as Re}from"../chunks/ByoR9fnx.js";import{s as Ce}from"../chunks/6oCtnRyf.js";import{g as M}from"../chunks/B0nJzvm_.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ve=je,Ne=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ee():s==="fr"?je():Ve()},Ze=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ze():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??M();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??M();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
