import"../chunks/DsnmJJEf.js";import{at as Je,u as fe,aD as xe,h as i,aE as we,b as g,c as w,n as Be,aw as n,au as f,a as o,av as Me,ax as a,d as He,ay as T,r as e,az as F,j as Le,bp as Fe}from"../chunks/zz4zLkML.js";import{a as t}from"../chunks/CIYB5YjN.js";import{a as Re}from"../chunks/DuQXae4Q.js";import{i as A}from"../chunks/Bpm99Ist.js";import{e as ae}from"../chunks/DDJzNS2U.js";import{c as ve}from"../chunks/DLHBK5eq.js";import{L as Ke}from"../chunks/B-I81xxc.js";import{s as Ee}from"../chunks/DN57PuxM.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ve=je,Ze=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ce():s==="fr"?je():Ve()},Ne=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ne():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
