import"../chunks/DsnmJJEf.js";import{A as De,a as ue,aD as me,g as s,aC as ge,F as u,G as x,I as Ie,aA as n,t as g,i as t,B as ze,aB as i,J as Se,aE as B,K as e,aF as M,D as We,aV as Fe}from"../chunks/DLg_PPZ_.js";import{s as o}from"../chunks/9TbOa8jV.js";import{a as Ye}from"../chunks/C_q2VfFz.js";import{i as Q}from"../chunks/D67Hg_eN.js";import{e as ne}from"../chunks/C4hQLFL9.js";import{s as fe}from"../chunks/BNnFn6yw.js";import{L as Pe}from"../chunks/Bx3yqWKm.js";import{s as Be}from"../chunks/DgdFC4m6.js";const Ge=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,Ue=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,Je={parse:b=>{b=String(b);try{return JSON.parse(b)}catch{return JSON.parse(b.replace(Ge,"$1").replace(Ue,"$1"))}}},Oe=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
...
`,be=(b,A=Ie)=>{var r=Se(),v=x(r);ne(v,19,()=>A().sort(()=>Math.random()-.5),({url:q,name:j})=>q||j,(q,j,R)=>{let X=()=>s(j).url,k=()=>s(j).name;var G=Le(),D=x(G);{var I=p=>{var h=M(",");t(p,h)};Q(D,p=>{s(R)>0&&p(I)})}var T=i(D,2);{var z=p=>{var h=Ke(),S=n(h,!0);e(h),g(()=>{fe(h,"href",X()),o(S,k())}),t(p,h)},E=p=>{var h=M();g(()=>o(h,k())),t(p,h)};Q(T,p=>{X()?p(z):p(E,!1)})}t(q,G)}),t(b,r)};var Ke=u('<a target="_blank"> </a>'),Le=u("<!> <!>",1),He=u('<dd class="svelte-6yh93n"><code> </code></dd>'),Me=u("<!> <code> </code>",1),Re=u('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt>Service workers</dt> <dd class="svelte-6yh93n"></dd>',1),Te=u('<dt>Versions</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Node.js</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Chrome</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Electron</dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),Ee=u('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),Ce=u('<dl class="dependencies svelte-6yh93n"></dl>'),Ve=u("<p>Impossible de charger les dépendances</p> <p> </p>",1),Ne=u("<p>Chargement des dépendances…</p>"),Ze=u(`<header class="svelte-6yh93n"><!> <div class="text"><h1>C.i.g.a.l.e.</h1> <p class="subtitle svelte-6yh93n">Classification Intelligente et Gestion des Arthropodes et de L'Entomofaune</p></div></header> <dl class="svelte-6yh93n"><dt>Développé par</dt> <dd class="svelte-6yh93n"><!></dd> <dt>Sous la supervision de</dt> <dd class="svelte-6yh93n"><!></dd> <dt>Dans le cadre d'un</dt> <dd class="svelte-6yh93n">“Projet long” de l'<a href="https://enseeiht.fr">INP-ENSEEIHT</a></dd> <!> <dt>Parallélisme</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>File de traitement</dt> <dd class="svelte-6yh93n"><code> </code> max.</dd> <dt>sw&rpc</dt> <dd class="svelte-6yh93n"><code> </code> nodes</dd> <dt>Hardware</dt> <dd class="svelte-6yh93n"><code></code> threads</dd></dl></dd> <dt>Code source</dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale">github.com/cigaleapp/cigale</a></dd> <dt>Avec les données</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Aides à l'identification</dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification">Les carnets nature de Jessica</a></dd> <dt>Arbre taxonomique</dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames">API de GBIF</a></dd></dl></dd> <dt>Avec les modèles</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Détection & recadrage</dt> <dd class="svelte-6yh93n">YOLO 11n</dd> <dt>Classification</dt> <dd class="svelte-6yh93n">ResNet50</dd></dl></dd> <dt>Fontes</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/">Host Grotesk</a></dt> <dd class="svelte-6yh93n"><span>par <a href="https://doughkan.com/">Doğukan Karapınar</a> et <a href="https://ibrahimkactioglu.com/">İbrahim Kaçtıoğlu</a>, chez <a href="https://elementtype.co/">Element Type Foundry</a></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code>par <a href="https://www.romanshamin.me/">Roman Shamin</a>, chez <a href="https://evilmartians.com">Evil Martians</a></code></dd></dl></dd> <dt>Icônes</dt> <dd class="svelte-6yh93n"><a href="https://phosphoricons.com/">Phosphor Icons</a> par <a href="https://helenazhang.com">Helena Zhang</a> et <a href="https://tobiasfried.com">Tobias Fried</a></dd> <dt>Grâce aux bibliothèques</dt> <dd class="svelte-6yh93n"><!></dd></dl>`,1);function pn(b,A){De(A,!0),Be({title:"À propos"});let r=ge(void 0);ue(()=>{window.versions&&(me(r,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(a=>{s(r)&&(s(r).os=a,s(r).sw=a.serviceWorkers)}))});let v=ge(0);ue(()=>{const a=setInterval(()=>{me(v,Math.max(1,s(v)+.03),!0)},10);return()=>{s(v)>=1&&clearInterval(a)}});const q=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:a,gitlab:l,url:d})=>({name:a,url:d??`https://git.inpt.fr/${l}`})),j=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function R(){const{workspaces:a,packages:l}=Je.parse(Oe);return[...Object.keys(a[""].dependencies),...Object.keys(a[""].devDependencies)].map(c=>[c,l[c][0].replace(`${c}@`,"")])}var X=Ze(),k=x(X),G=n(k);Pe(G,{get drawpercent(){return s(v)}}),B(2),e(k);var D=i(k,2),I=i(n(D),2),T=n(I);be(T,()=>q),e(I);var z=i(I,4),E=n(z);be(E,()=>j),e(z);var p=i(z,6);{var h=a=>{var l=Te(),d=i(x(l),2),c=n(d),f=i(n(c),2),W=n(f),U=n(W,!0);e(W),e(f);var F=i(f,4),Y=n(F),P=n(Y,!0);e(Y),e(F);var y=i(F,4),J=n(y),O=n(J,!0);e(J),e(y);var K=i(y,2);{var N=Z=>{var oe=Re(),_=x(oe),je=n(_,!0);e(_);var $=i(_,2),pe=n($),ke=n(pe,!0);e(pe),e($);var ce=i($,2);{var Qe=m=>{var w=He(),L=n(w),H=n(L,!0);e(L),e(w),g(()=>o(H,s(r).os.architecture)),t(m,w)};Q(ce,m=>{s(r).os.archIsUnusual&&m(Qe)})}var le=i(ce,4);ne(le,22,()=>s(r).sw,m=>m,(m,w,L)=>{var H=Me(),de=x(H);{var Ae=ee=>{var Xe=M(",");t(ee,Xe)};Q(de,ee=>{s(L)>0&&ee(Ae)})}var he=i(de,2),qe=n(he,!0);e(he),g(()=>o(qe,w)),t(m,H)},m=>{B();var w=M("(aucun)");t(m,w)}),e(le),g(()=>{o(je,s(r).os.name),o(ke,s(r).os.version)}),t(Z,oe)};Q(K,Z=>{"os"in s(r)&&Z(N)})}e(c),e(d),g(()=>{o(U,s(r).node),o(P,s(r).chrome),o(O,s(r).electron)}),t(a,l)};Q(p,a=>{s(r)&&a(h)})}var S=i(p,4),se=n(S),C=i(n(se),2),ie=n(C),xe=n(ie,!0);e(ie),B(),e(C);var V=i(C,4),ae=n(V),ye=n(ae,!0);e(ae),B(),e(V);var re=i(V,4),we=n(re);we.textContent=navigator.hardwareConcurrency,B(),e(re),e(se),e(S);var te=i(S,24),ve=n(te);Ye(ve,R,a=>{var l=Ne();t(a,l)},(a,l)=>{var d=Ce();ne(d,21,()=>s(l),([c,f])=>c,(c,f)=>{var W=We(()=>Fe(s(f),2));let U=()=>s(W)[0],F=()=>s(W)[1];var Y=Ee(),P=x(Y),y=n(P),J=n(y,!0);e(y),e(P);var O=i(P,2),K=n(O),N=n(K,!0);e(K),e(O),g(()=>{fe(y,"href",`https://npmjs.com/package/${U()??""}`),o(J,U()),o(N,F())}),t(c,Y)}),e(d),t(a,d)},(a,l)=>{var d=Ve(),c=i(x(d),2),f=n(c,!0);e(c),g(()=>o(f,s(l))),t(a,d)}),e(te),e(D),g(()=>{o(xe,A.data.parallelism),o(ye,A.data.parallelism)}),t(b,X),ze()}export{pn as component};
