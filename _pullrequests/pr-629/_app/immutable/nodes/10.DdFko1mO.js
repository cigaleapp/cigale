import"../chunks/DsnmJJEf.js";import{ao as Xe,d as le,ax as ce,g as i,aw as de,h as g,j as w,n as We,av as y,a as t,ap as Ue,aq as s,ar as r,k as Ge,at as me,l as e,au as M,as as Ye,b9 as Pe}from"../chunks/pLBs-mSF.js";import{s as o}from"../chunks/Dos-s29q.js";import{a as Te}from"../chunks/VdNrGBfb.js";import{i as A}from"../chunks/C3Fbln-z.js";import{e as ee}from"../chunks/DbKxOvJB.js";import{c as ue}from"../chunks/DIQ6b9wY.js";import{L as Se}from"../chunks/e4UGFwRT.js";import{s as Oe}from"../chunks/0-DflsyC.js";import{g as L}from"../chunks/DEue9iQn.js";const Ie=()=>"Developed by",ge=()=>"Développé par",Be=ge,He=(m={},h={})=>{const n=h.locale??L();return n==="en"?Ie():n==="fr"?ge():Be()},Fe=()=>"About",be=()=>"À propos",Je=be,Me=(m={},h={})=>{const n=h.locale??L();return n==="en"?Fe():n==="fr"?be():Je()},Le=()=>"Under the supervision of",ye=()=>"Sous la supervision de",Ee=ye,Ke=(m={},h={})=>{const n=h.locale??L();return n==="en"?Le():n==="fr"?ye():Ee()},Re=()=>"As part of",fe=()=>"Dans le cadre d'un",Ce=fe,Ze=(m={},h={})=>{const n=h.locale??L();return n==="en"?Re():n==="fr"?fe():Ce()},Ve=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,Ne=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,_e={parse:m=>{m=String(m);try{return JSON.parse(m)}catch{return JSON.parse(m.replace(Ve,"$1").replace(Ne,"$1"))}}},$e=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
