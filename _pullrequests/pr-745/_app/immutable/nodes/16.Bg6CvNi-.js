import"../chunks/DsnmJJEf.js";import{p as as,g as e,u as w,i as un,av as mn,ax as gn,c as g,d as B,n as k,a7 as b,a as h,b as is,ay as s,aw as r,e as rs,r as n,a6 as ne,aY as ts,aA as os}from"../chunks/CEjrMSr3.js";import{a as i}from"../chunks/CzPTknfj.js";import{a as ps}from"../chunks/CS3lvyui.js";import{i as G}from"../chunks/BQwRB0hY.js";import{e as He}from"../chunks/B5t4nw1a.js";import{s as P,_ as cs,g as ls}from"../chunks/CFKIlU8F.js";import{R as z}from"../chunks/KtucAqHY.js";import{L as ds}from"../chunks/B-ei7I0U.js";import{s as hs}from"../chunks/eEn-YRt2.js";const us=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,ms=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,gs={parse:Q=>{Q=String(Q);try{return JSON.parse(Q)}catch{return JSON.parse(Q.replace(us,"$1").replace(ms,"$1"))}}},bs=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
  ...
  "packages": {
    ...
    "@vitest/coverage-v8": ["@vitest/coverage-v8@4.0.4", "", { "dependencies": { "@bcoe/v8-coverage": "^1.0.2", "@vitest/utils": "4.0.4", "ast-v8-to-istanbul": "^0.3.5", "debug": "^4.4.3", "istanbul-lib-coverage": "^3.2.2", "istanbul-lib-report": "^3.0.1", "istanbul-lib-source-maps": "^5.0.6", "istanbul-reports": "^3.2.0", "magicast": "^0.3.5", "std-env": "^3.9.0", "tinyrainbow": "^3.0.3" }, "peerDependencies": { "@vitest/browser": "4.0.4", "vitest": "4.0.4" }, "optionalPeers": ["@vitest/browser"] }, "sha512-YM7gDj2TX2AXyGLz0p/B7hvTsTfaQc+kSV/LU0nEnKlep/ZfbdCDppPND4YQiQC43OXyrhkG3y8ZSTqYb2CKqQ=="],
    ...
    "@vitest/ui": ["@vitest/ui@4.0.4", "", { "dependencies": { "@vitest/utils": "4.0.4", "fflate": "^0.8.2", "flatted": "^3.3.3", "pathe": "^2.0.3", "sirv": "^3.0.2", "tinyglobby": "^0.2.15", "tinyrainbow": "^3.0.3" }, "peerDependencies": { "vitest": "4.0.4" } }, "sha512-CmuFQLKw5SaLU/Flo8dLiQw2P2ONguhjfhBL9AYkTeDZPToE8laGvObXqRzS5G+4RD4SgWcI1USAmGxMVIqT0g=="],
    ...
    "electron": ["electron@38.4.0", "", { "dependencies": { "@electron/get": "^2.0.0", "@types/node": "^22.7.7", "extract-zip": "^2.0.1" }, "bin": { "electron": "cli.js" } }, "sha512-9CsXKbGf2qpofVe2pQYSgom2E//zLDJO2rGLLbxgy9tkdTOs7000Gte+d/PUtzLjI/DS95jDK0ojYAeqjLvpYg=="],
    ...
    "eslint-plugin-oxlint": ["eslint-plugin-oxlint@1.24.0", "", { "dependencies": { "jsonc-parser": "^3.3.1" } }, "sha512-eK41VTdYfq8HJH5tGxC6EMdfmCpzXbM5SAqyAU9HProtb5YRCxM9vT2PUfLbGw9EptUvPGF4o9cVUvK9hCCB1g=="],
    ...
    "google-auth-library": ["google-auth-library@10.4.2", "", { "dependencies": { "base64-js": "^1.3.0", "ecdsa-sig-formatter": "^1.0.11", "gaxios": "^7.0.0", "gcp-metadata": "^8.0.0", "google-logging-utils": "^1.0.0", "gtoken": "^8.0.0", "jws": "^4.0.0" } }, "sha512-EKiQasw6aEdxSovPEf1oBxCEvxjFamZ6MPaVOSPXZMnqKFLo+rrYjHyjKlFfZcXiKi9qAH6cutr5WRqqa1jKhg=="],
    ...
    "knip": ["knip@5.66.3", "", { "dependencies": { "@nodelib/fs.walk": "^1.2.3", "fast-glob": "^3.3.3", "formatly": "^0.3.0", "jiti": "^2.6.0", "js-yaml": "^4.1.0", "minimist": "^1.2.8", "oxc-resolver": "^11.8.3", "picocolors": "^1.1.1", "picomatch": "^4.0.1", "smol-toml": "^1.4.1", "strip-json-comments": "5.0.2", "zod": "^4.1.11" }, "peerDependencies": { "@types/node": ">=18", "typescript": ">=5.0.4 <7" }, "bin": { "knip": "bin/knip.js", "knip-bun": "bin/knip-bun.js" } }, "sha512-BEe9ZCI8fm4TJzehnrCt+L/Faqu6qfMH6VrwSfck+lCGotQzf0jh5dVXysPWjWqMpdUSr6+MpMu9JW/G6wiAcQ=="],
...
`,bn=(Q,O=k)=>{var a=rs(),f=B(a);He(f,19,()=>O().sort(()=>Math.random()-.5),({url:q,name:U})=>q||U,(q,U,se)=>{let N=()=>e(U).url,T=()=>e(U).name;var J=ws(),H=B(J);{var Z=x=>{var v=ne(",");h(x,v)};G(H,x=>{e(se)>0&&x(Z)})}var C=r(H,2);{var ae=x=>{var v=fs(),L=s(v,!0);n(v),b(()=>{P(v,"href",N()),i(L,T())}),h(x,v)},_=x=>{var v=ne();b(()=>i(v,T())),h(x,v)};G(C,x=>{N()?x(ae):x(_,!1)})}h(q,J)}),h(Q,a)};var fs=g('<a target="_blank"> </a>'),ws=g("<!> <!>",1),ys=g('<a href="https://enseeiht.fr"> </a>'),xs=g('<dd class="svelte-6yh93n"><code> </code></dd>'),vs=g("<!> <code> </code>",1),js=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"></dd>',1),ks=g('<dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),Qs=g("<code> </code>"),qs=g("<code> </code>"),As=g("<code></code>"),Xs=g("<a> </a>"),Ys=g("<a> </a>"),Bs=g("<a> </a>"),Is=g("<a> </a>"),Ds=g("<a> </a>"),Ss=g('<a href="https://remixicon.com"> </a>'),zs=g('<a href="https://www.zhangxiaochun.com/"> </a>'),Ps=g('<a href="https://gaoquanquan.com/"> </a>'),Us=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),Js=g('<dl class="dependencies svelte-6yh93n"></dl>'),Es=g("<p> </p> <p> </p>",1),Ks=g("<p> </p>"),Ws=g('<header class="svelte-6yh93n"><!> <div class="text"><h1> </h1> <p class="subtitle svelte-6yh93n"> </p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames"> </a></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <dt> </dt> <dd class="svelte-6yh93n"> </dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/"> </a></dt> <dd class="svelte-6yh93n"><span><!></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code><!></code></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl>',1);function Ns(Q,O){as(O,!0);const a=w(()=>cs(ls("main")));hs({title:e(a).t(206)});let f=gn(void 0);un(()=>{window.versions&&(mn(f,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(d=>{e(f)&&(e(f).os=d,e(f).sw=d.serviceWorkers)}))});let q=gn(0);un(()=>{const d=setInterval(()=>{mn(q,Math.max(1,e(q)+.03),!0)},10);return()=>{e(q)>=1&&clearInterval(d)}});const U=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:d,gitlab:c,url:t})=>({name:d,url:t??`https://git.inpt.fr/${c}`})),se=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function N(){const{workspaces:d,packages:c}=gs.parse(bs);return[...Object.keys(d[""].dependencies),...Object.keys(d[""].devDependencies)].map(o=>[o,c[o][0].replace(`${o}@`,"")])}var T=Ws(),J=B(T),H=s(J);ds(H,{get drawpercent(){return e(q)}});var Z=r(H,2),C=s(Z),ae=s(C,!0);n(C);var _=r(C,2),x=s(_,!0);n(_),n(Z),n(J);var v=r(J,2),L=s(v),fn=s(L,!0);n(L);var ie=r(L,2),wn=s(ie);bn(wn,()=>U),n(ie);var re=r(ie,2),yn=s(re,!0);n(re);var te=r(re,2),xn=s(te);bn(xn,()=>se),n(te);var oe=r(te,2),vn=s(oe,!0);n(oe);var pe=r(oe,2);{const d=(c,t=k)=>{var o=ys(),l=s(o,!0);n(o),b(p=>i(l,p),[()=>e(a).tx(t())]),h(c,o)};var jn=s(pe);{let c=w(()=>[d]),t=w(()=>e(a).cx(208));z(jn,{get t(){return e(c)},get x(){return e(t)}})}n(pe)}var Ce=r(pe,2);{var kn=d=>{var c=ks(),t=B(c),o=s(t,!0);n(t);var l=r(t,2),p=s(l),u=s(p),m=s(u,!0);n(u);var y=r(u,2),A=s(y),I=s(A,!0);n(A),n(y);var D=r(y,2),E=s(D,!0);n(D);var X=r(D,2),K=s(X),Ue=s(K,!0);n(K),n(X);var R=r(X,2),Je=s(R,!0);n(R);var M=r(R,2),$=s(M),Ee=s($,!0);n($),n(M);var Ke=r(M,2);{var We=S=>{var W=js(),V=B(W),Fe=s(V,!0);n(V);var Ge=r(V,2),pn=s(Ge),Zn=s(pn,!0);n(pn),n(Ge);var cn=r(Ge,2);{var _n=j=>{var Y=xs(),F=s(Y),ee=s(F,!0);n(F),n(Y),b(()=>i(ee,e(f).os.architecture)),h(j,Y)};G(cn,j=>{e(f).os.archIsUnusual&&j(_n)})}var Oe=r(cn,2),$n=s(Oe,!0);n(Oe);var ln=r(Oe,2);He(ln,22,()=>e(f).sw,j=>j,(j,Y,F)=>{var ee=vs(),dn=B(ee);{var es=Te=>{var ss=ne(",");h(Te,ss)};G(dn,Te=>{e(F)>0&&Te(es)})}var hn=r(dn,2),ns=s(hn,!0);n(hn),b(()=>i(ns,Y)),h(j,ee)},j=>{os();var Y=ne();b(F=>i(Y,F),[()=>e(a).t(209)]),h(j,Y)}),n(ln),b(j=>{i(Fe,e(f).os.name),i(Zn,e(f).os.version),i($n,j)},[()=>e(a).t(166)]),h(S,W)};G(Ke,S=>{"os"in e(f)&&S(We)})}n(p),n(l),b((S,W,V,Fe)=>{i(o,S),i(m,W),i(I,e(f).node),i(E,V),i(Ue,e(f).chrome),i(Je,Fe),i(Ee,e(f).electron)},[()=>e(a).t(191),()=>e(a).t(137),()=>e(a).t(62),()=>e(a).t(84)]),h(d,c)};G(Ce,d=>{e(f)&&d(kn)})}var ce=r(Ce,2),Qn=s(ce,!0);n(ce);var le=r(ce,2),Le=s(le),de=s(Le),qn=s(de,!0);n(de);var he=r(de,2);{const d=c=>{var t=Qs(),o=s(t,!0);n(t),b(()=>i(o,O.data.parallelism)),h(c,t)};var An=s(he);{let c=w(()=>[d]),t=w(()=>e(a).cx(19));z(An,{get t(){return e(c)},get x(){return e(t)}})}n(he)}var ue=r(he,2),Xn=s(ue,!0);n(ue);var me=r(ue,2);{const d=c=>{var t=qs(),o=s(t,!0);n(t),b(()=>i(o,O.data.parallelism)),h(c,t)};var Yn=s(me);{let c=w(()=>[d]),t=w(()=>e(a).cx(20));z(Yn,{get t(){return e(c)},get x(){return e(t)}})}n(me)}var ge=r(me,2),Bn=s(ge,!0);n(ge);var Re=r(ge,2);{const d=c=>{var t=As();t.textContent=navigator.hardwareConcurrency,h(c,t)};var In=s(Re);{let c=w(()=>[d]),t=w(()=>e(a).cx(22));z(In,{get t(){return e(c)},get x(){return e(t)}})}n(Re)}n(Le),n(le);var be=r(le,2),Dn=s(be,!0);n(be);var fe=r(be,2),Me=s(fe),Sn=s(Me,!0);n(Me),n(fe);var we=r(fe,2),zn=s(we,!0);n(we);var ye=r(we,2),Ve=s(ye),xe=s(Ve),Pn=s(xe,!0);n(xe);var ve=r(xe,2),Ne=s(ve),Un=s(Ne,!0);n(Ne),n(ve);var je=r(ve,2),Jn=s(je,!0);n(je);var Ze=r(je,2),_e=s(Ze),En=s(_e,!0);n(_e),n(Ze),n(Ve),n(ye);var ke=r(ye,2),Kn=s(ke,!0);n(ke);var Qe=r(ke,2),$e=s(Qe),qe=s($e),Wn=s(qe,!0);n(qe);var Ae=r(qe,2),Fn=s(Ae,!0);n(Ae);var Xe=r(Ae,2),Gn=s(Xe,!0);n(Xe);var en=r(Xe,2),On=s(en,!0);n(en),n($e),n(Qe);var Ye=r(Qe,2),Tn=s(Ye,!0);n(Ye);var Be=r(Ye,2),nn=s(Be),Ie=s(nn),sn=s(Ie),Hn=s(sn,!0);n(sn),n(Ie);var De=r(Ie,2),an=s(De);{const d=(o,l=k)=>{var p=Xs(),u=s(p,!0);n(p),b((m,y)=>{P(p,"href",m),i(u,y)},[()=>e(a).t(222),()=>e(a).tx(l())]),h(o,p)},c=(o,l=k)=>{var p=Ys(),u=s(p,!0);n(p),b((m,y)=>{P(p,"href",m),i(u,y)},[()=>e(a).t(223),()=>e(a).tx(l())]),h(o,p)},t=(o,l=k)=>{var p=Bs(),u=s(p,!0);n(p),b((m,y)=>{P(p,"href",m),i(u,y)},[()=>e(a).t(224),()=>e(a).tx(l())]),h(o,p)};var Cn=s(an);{let o=w(()=>[d,c,t]),l=w(()=>e(a).cx(198));z(Cn,{get t(){return e(o)},get x(){return e(l)}})}n(an)}n(De);var rn=r(De,4),tn=s(rn);{const d=(t,o=k)=>{var l=Is(),p=s(l,!0);n(l),b((u,m)=>{P(l,"href",u),i(p,m)},[()=>e(a).t(219),()=>e(a).tx(o())]),h(t,l)},c=(t,o=k)=>{var l=Ds(),p=s(l,!0);n(l),b((u,m)=>{P(l,"href",u),i(p,m)},[()=>e(a).t(220),()=>e(a).tx(o())]),h(t,l)};var Ln=s(tn);{let t=w(()=>[d,c]),o=w(()=>e(a).cx(221));z(Ln,{get t(){return e(t)},get x(){return e(o)}})}n(tn)}n(rn),n(nn),n(Be);var Se=r(Be,2),Rn=s(Se,!0);n(Se);var ze=r(Se,2);{const d=(o,l=k)=>{var p=Ss(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)},c=(o,l=k)=>{var p=zs(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)},t=(o,l=k)=>{var p=Ps(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)};var Mn=s(ze);{let o=w(()=>[d,c,t]),l=w(()=>e(a).cx(380));z(Mn,{get t(){return e(o)},get x(){return e(l)}})}n(ze)}var Pe=r(ze,2),Vn=s(Pe,!0);n(Pe);var on=r(Pe,2),Nn=s(on);ps(Nn,N,d=>{var c=Ks(),t=s(c,!0);n(c),b(o=>i(t,o),[()=>e(a).t(54)]),h(d,c)},(d,c)=>{var t=Js();He(t,21,()=>e(c),([o,l])=>o,(o,l)=>{var p=w(()=>ts(e(l),2));let u=()=>e(p)[0],m=()=>e(p)[1];var y=Us(),A=B(y),I=s(A),D=s(I,!0);n(I),n(A);var E=r(A,2),X=s(E),K=s(X,!0);n(X),n(E),b(()=>{P(I,"href",`https://npmjs.com/package/${u()??""}`),i(D,u()),i(K,m())}),h(o,y)}),n(t),h(d,t)},(d,c)=>{var t=Es(),o=B(t),l=s(o,!0);n(o);var p=r(o,2),u=s(p,!0);n(p),b(m=>{i(l,m),i(u,e(c))},[()=>e(a).t(115)]),h(d,t)}),n(on),n(v),b((d,c,t,o,l,p,u,m,y,A,I,D,E,X,K,Ue,R,Je,M,$,Ee,Ke,We,S,W)=>{i(ae,d),i(x,c),i(fn,t),i(yn,o),i(vn,l),i(Qn,p),i(qn,u),i(Xn,m),i(Bn,y),i(Dn,A),i(Sn,I),i(zn,D),i(Pn,E),i(Un,X),i(Jn,K),i(En,Ue),i(Kn,R),i(Wn,Je),i(Fn,M),i(Gn,$),i(On,Ee),i(Tn,Ke),i(Hn,We),i(Rn,S),i(Vn,W)},[()=>e(a).t(45),()=>e(a).t(64),()=>e(a).t(82),()=>e(a).t(167),()=>e(a).t(75),()=>e(a).t(145),()=>e(a).t(213),()=>e(a).t(201),()=>e(a).t(102),()=>e(a).t(68),()=>e(a).t(197),()=>e(a).t(42),()=>e(a).t(28),()=>e(a).t(125),()=>e(a).t(32),()=>e(a).t(23),()=>e(a).t(43),()=>e(a).t(81),()=>e(a).t(193),()=>e(a).t(63),()=>e(a).t(160),()=>e(a).t(98),()=>e(a).t(103),()=>e(a).t(104),()=>e(a).t(100)]),h(Q,T),is()}export{Ns as component};
