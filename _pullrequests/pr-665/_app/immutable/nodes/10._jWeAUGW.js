import"../chunks/DsnmJJEf.js";import{ao as Oe,d as fe,ax as we,g as i,aw as ye,h as g,j as y,n as Be,aq as n,av as f,a as o,ap as Le,ar as a,k as He,at as J,l as e,au as F,as as Me,b8 as Fe}from"../chunks/C7-SyOmZ.js";import{s as t}from"../chunks/DTkINwIJ.js";import{a as Re}from"../chunks/5yStqDHl.js";import{i as A}from"../chunks/D0ESjDJY.js";import{e as ae}from"../chunks/DNYXL8V7.js";import{c as ve}from"../chunks/BqbaD9oV.js";import{L as Ee}from"../chunks/F0kFAels.js";import{s as Ce}from"../chunks/DZ4HI5AA.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ke=()=>"Developed by",je=()=>"Développé par",Ne=je,Ve=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ke():s==="fr"?je():Ne()},Ze=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ze():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
