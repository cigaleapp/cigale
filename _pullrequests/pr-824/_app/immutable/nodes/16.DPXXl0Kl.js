import"../chunks/DsnmJJEf.js";import{f as js,a as h,p as un,g as s,u as w,k as ws,i as ys,s as xs,c as g,d as B,n as Q,ab as f,b as mn,az as n,aA as i,e as gn,r as e,aa as ae,bn,aB as fn}from"../chunks/C7_gkQdF.js";import{a as r}from"../chunks/DW9-Bmrz.js";import{a as wn}from"../chunks/CL98pt8_.js";import{r as ks,i as C}from"../chunks/tiGVKddq.js";import{e as Re}from"../chunks/D2b0n_Rj.js";import{c as yn}from"../chunks/DpyvUMqG.js";import{a as Qs,s as P,c as xn,_ as vn,g as jn}from"../chunks/km9UxZsa.js";import{R as J}from"../chunks/DhxDcUJl.js";import{C as kn}from"../chunks/IJPT4Ceo.js";import{C as Qn}from"../chunks/vh1hJMDI.js";import{E as qn}from"../chunks/MHi9geIz.js";import{L as An}from"../chunks/DCfYgWZc.js";import{s as Xn}from"../chunks/G0TZvtaf.js";const Dn=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,zn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,In={parse:y=>{y=String(y);try{return JSON.parse(y)}catch{return JSON.parse(y.replace(Dn,"$1").replace(zn,"$1"))}}};var Bn=js('<svg><path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10m0-2a8 8 0 1 0 0-16a8 8 0 0 0 0 16M11 7h2v2h-2zm0 4h2v6h-2z"></path></svg>');function Yn(y,v){const a=ks(v,["$$slots","$$events","$$legacy"]);var u=Bn();Qs(u,()=>({class:"icon",viewBox:"0 0 24 24",width:"1.2em",height:"1.2em",...a})),h(y,u)}var Sn=js('<svg><path fill="currentColor" d="M21 4H3v2h18zm0 7H8v2h13zm0 7H8v2h13zM5 11H3v9h2z"></path></svg>');function Un(y,v){const a=ks(v,["$$slots","$$events","$$legacy"]);var u=Sn();Qs(u,()=>({class:"icon",viewBox:"0 0 24 24",width:"1.2em",height:"1.2em",...a})),h(y,u)}const Jn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
      "dependencies": {
        ...
        "piexifjs": "^1.0.6",
        "runed": "^0.35.1",
        "svelte-mathml": "gwennlbh/svelte-mathml#86b159f33f018ff39d903c000f9d2f673b33fb69",
  ...
  "packages": {
    ...
    "@vitest/ui": ["@vitest/ui@4.0.6", "", { "dependencies": { "@vitest/utils": "4.0.6", "fflate": "^0.8.2", "flatted": "^3.3.3", "pathe": "^2.0.3", "sirv": "^3.0.2", "tinyglobby": "^0.2.15", "tinyrainbow": "^3.0.3" }, "peerDependencies": { "vitest": "4.0.6" } }, "sha512-1ekpBsYNUm0Xv/0YsTvoSRmiRkmzz9Pma7qQ3Ui76sg2gwp2/ewSWqx4W/HfaN5dF0E8iBbidFo1wGaeqXYIrQ=="],
    ...
    "@wuchale/svelte": ["@wuchale/svelte@0.16.6", "", { "dependencies": { "svelte": "^5.37.0", "wuchale": "^0.17.5" } }, "sha512-1Syz9Ct7YbjWP1S4wQcXlycyJu/TYQM/1yvXGKxvBG+aPn7Zynp0HsACh3qsudO8bMRAZZv2cG7ofVCIM/E6tg=="],

    "@wuchale/vite-plugin": ["@wuchale/vite-plugin@0.14.8", "", { "dependencies": { "wuchale": "^0.17.0" } }, "sha512-rPTW3wxvJ70AJcF5qE5OatMWn8UJuRRU66o823nmOrEn8e68j3jcikDz/gNoeQH6TI+XrQIJ3t2dPAqezZltMg=="],
    ...
    "electron": ["electron@39.0.0", "", { "dependencies": { "@electron/get": "^2.0.0", "@types/node": "^22.7.7", "extract-zip": "^2.0.1" }, "bin": { "electron": "cli.js" } }, "sha512-UejnuOK4jpRZUq7MkEAnR/szsRWLKBJAdvn6j3xdQLT57fVv13VSNdaUHHjSheaqGzNhCGIdkPsPJnGJVh5kiA=="],
    ...
    "eslint-plugin-oxlint": ["eslint-plugin-oxlint@1.25.0", "", { "dependencies": { "jsonc-parser": "^3.3.1" } }, "sha512-grS4KdR9FAxoQC+wMkepeQHL4osMhoYfUI11Pot6Gitqr4wWi+JZrX0Shr8Bs9fjdWhEjtaZIV6cr4mbfytmyw=="],
    ...
    "fake-indexeddb": ["fake-indexeddb@6.2.4", "", {}, "sha512-INKeIKEtSViN4yVtEWEUqbsqmaIy7Ls+MfU0yxQVXg67pOJ/sH1ZxcVrP8XrKULUFohcPD9gnmym+qBfEybACw=="],
    ...
    "googleapis": ["googleapis@164.1.0", "", { "dependencies": { "google-auth-library": "^10.2.0", "googleapis-common": "^8.0.0" } }, "sha512-dIN768H8so9qGucFtjYPBZJ+OCEgDi/xYyvYQHniPL1ZCYvrRDBTmtbjVjKCPG1CuOhG4CKHZDXiFe6QZ2qBeQ=="],
    ...
    "pdf-to-png-converter": ["pdf-to-png-converter@3.10.0", "", { "dependencies": { "@napi-rs/canvas": "~0.1.80", "pdfjs-dist": "~5.4.149" } }, "sha512-kRRoacnX88gvpRPQWtPd9igsSXnyItXnPy8hIKBDmhOauCImHjP7+3DClKsVZc2PR4/u9p2cJmXJ4Ry1g6U2Xw=="],

    "pdfjs-dist": ["pdfjs-dist@5.4.149", "", { "optionalDependencies": { "@napi-rs/canvas": "^0.1.77" } }, "sha512-Xe8/1FMJEQPUVSti25AlDpwpUm2QAVmNOpFP0SIahaPIOKBKICaefbzogLdwey3XGGoaP4Lb9wqiw2e9Jqp0LA=="],
    ...
    "svelte-mathml": ["svelte-mathml@github:gwennlbh/svelte-mathml#86b159f", { "peerDependencies": { "svelte": "^5.43.2" } }, "gwennlbh-svelte-mathml-86b159f"],
    ...
    "swarpc": ["swarpc@0.14.0", "", { "peerDependencies": { "arktype": "^2.1.22" } }, "sha512-uKmRd68wglC/ibr9M21yVIw6+iJTqZyA41os/p76vgpqLwmPE6jz56W0tPGeBqsi2l0fHKZMLePzkeSkE+B0ew=="],
    ...
    "wuchale": ["wuchale@0.17.5", "", { "dependencies": { "@sveltejs/acorn-typescript": "^1.0.6", "acorn": "^8.15.0", "chokidar": "^4.0.3", "magic-string": "^0.30.19", "picomatch": "^4.0.3", "pofile": "^1.1.4", "tinyglobby": "^0.2.15" }, "bin": { "wuchale": "dist/cli/index.js" } }, "sha512-l3GAQhaLlktg2/uEASAHIq8NCecQkaQjGE7DTWukB6OHNe7dTfhWItrouTTFmY1xkMLHnvlHwA61h8coi14YjQ=="],
    ...
    "@wuchale/svelte/svelte": ["svelte@5.41.1", "", { "dependencies": { "@jridgewell/remapping": "^2.3.4", "@jridgewell/sourcemap-codec": "^1.5.0", "@sveltejs/acorn-typescript": "^1.0.5", "@types/estree": "^1.0.5", "acorn": "^8.12.1", "aria-query": "^5.3.1", "axobject-query": "^4.1.0", "clsx": "^2.1.1", "esm-env": "^1.2.1", "esrap": "^2.1.0", "is-reference": "^3.0.3", "locate-character": "^3.0.0", "magic-string": "^0.30.11", "zimmerframe": "^1.1.2" } }, "sha512-0a/huwc8e2es+7KFi70esqsReRfRbrT8h1cJSY/+z1lF0yKM6TT+//HYu28Yxstr50H7ifaqZRDGd0KuKDxP7w=="],

    "@wuchale/vite-plugin/wuchale": ["wuchale@0.17.4", "", { "dependencies": { "@sveltejs/acorn-typescript": "^1.0.6", "acorn": "^8.15.0", "chokidar": "^4.0.3", "magic-string": "^0.30.19", "picomatch": "^4.0.3", "pofile": "^1.1.4", "tinyglobby": "^0.2.15" }, "bin": { "wuchale": "dist/cli/index.js" } }, "sha512-lQTWe/xlzH1lmo6JtBXLla8O6wPv7QTxcHUw4ZnrHWHmUNilqTbg6Fa9gzI0c4/8cPTbis0VhhDPSry9MR8euA=="],
    ...
    "eslint-plugin-svelte/globals": ["globals@16.4.0", "", {}, "sha512-ob/2LcVVaVGCYN+r14cnwnoDPUufjiYgSqRhiFD0Q1iI4Odora5RE8Iv1D24hAz5oMophRGkGz+yuvQmmUMnMw=="],
    ...
    "googleapis/google-auth-library": ["google-auth-library@10.4.2", "", { "dependencies": { "base64-js": "^1.3.0", "ecdsa-sig-formatter": "^1.0.11", "gaxios": "^7.0.0", "gcp-metadata": "^8.0.0", "google-logging-utils": "^1.0.0", "gtoken": "^8.0.0", "jws": "^4.0.0" } }, "sha512-EKiQasw6aEdxSovPEf1oBxCEvxjFamZ6MPaVOSPXZMnqKFLo+rrYjHyjKlFfZcXiKi9qAH6cutr5WRqqa1jKhg=="],
    ...
    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-android-arm64": ["@napi-rs/canvas-android-arm64@0.1.79", "", { "os": "android", "cpu": "arm64" }, "sha512-ih6ZIztNDEXl7axvC4swOwLFrM9lOyJa9VAMq7xIBtEZhR/8IVDa0ZTup2fZEiTCmnjmXolzv7uDviHkOTEMKQ=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-darwin-arm64": ["@napi-rs/canvas-darwin-arm64@0.1.79", "", { "os": "darwin", "cpu": "arm64" }, "sha512-REMz1Fac2VlOYJDg+JjmQWSJc459cCgVom6GvKwWkDqzSjvG9BSo72MDmQY3uhb7r49Xuz5gTFcLYTfNcm4MoA=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-darwin-x64": ["@napi-rs/canvas-darwin-x64@0.1.79", "", { "os": "darwin", "cpu": "x64" }, "sha512-uQxLg6Bll7zv/ljp/YIeiUFWfV9C/ESv+2ioUh60hIAypuhtg6hhtWE/KnoW7G48wQls5VUStvEnJbnJ7bPKlA=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-linux-arm-gnueabihf": ["@napi-rs/canvas-linux-arm-gnueabihf@0.1.79", "", { "os": "linux", "cpu": "arm" }, "sha512-X37B//TVIipL/3RyvyfNlbQK2uyIaK3PJ2bH7ZeU+jpkaYprBsV15GCN/LHTYAi6R0F/c53zK3aSFNKkGHM/Og=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-linux-arm64-gnu": ["@napi-rs/canvas-linux-arm64-gnu@0.1.79", "", { "os": "linux", "cpu": "arm64" }, "sha512-+T1fuau1heabE6zGXiqZBGPH5fTIQF+xEu/u4fuugxEiChRYlhnPjkw26MBi8ePg/jmzxLfJEij6LMJQ4AQa2A=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-linux-arm64-musl": ["@napi-rs/canvas-linux-arm64-musl@0.1.79", "", { "os": "linux", "cpu": "arm64" }, "sha512-KsrsR3+6uXv70W/1/kY0yRK4/bbdJgA1Vuxw4KyfSc6mjl1DMoYXDAjpBT/5w7AXy6cGG44jm3upvvt/y/dPfg=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-linux-riscv64-gnu": ["@napi-rs/canvas-linux-riscv64-gnu@0.1.79", "", { "os": "linux", "cpu": "none" }, "sha512-EXaENnSJD6au6z4aKN2PpU9eVNWUsRI2cApm8gCa0WSRMaiYXZsFkXQmhB+Vz2pXahOS8BN2Zd8S1IeML/LCtg=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-linux-x64-gnu": ["@napi-rs/canvas-linux-x64-gnu@0.1.79", "", { "os": "linux", "cpu": "x64" }, "sha512-3xZhHlE9e3cd9D7Comy6/TTSs/8PUGXEXymIwYQrA1QxHojAlAOFlVai4rffzXd0bHylZu+/wD76LodvYqF1Yw=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-linux-x64-musl": ["@napi-rs/canvas-linux-x64-musl@0.1.79", "", { "os": "linux", "cpu": "x64" }, "sha512-4yv550uCjIEoTFgrpxYZK67nFlDMCQa3LAheM2QrO+B8w1p5w04usIQSCHqHe6aPWlbLQCIqfVcew6/7Q4KuHg=="],

    "pdfjs-dist/@napi-rs/canvas/@napi-rs/canvas-win32-x64-msvc": ["@napi-rs/canvas-win32-x64-msvc@0.1.79", "", { "os": "win32", "cpu": "x64" }, "sha512-sD5qP2njBRnhNlTNFJDdpeCN6aR3qVamLySTwhX3ec8sdfeT/chf/x2dw2UXoIGMoVaVk/y2ifwxBj/h2a2jug=="],
...
`,vs=(y,v=Q)=>{var a=gn(),u=B(a);Re(u,19,()=>v().sort(()=>Math.random()-.5),({url:q,name:X})=>q||X,(q,X,T)=>{let K=()=>s(X).url,H=()=>s(X).name;var W=Kn(),R=B(W);{var $=j=>{var k=ae(",");h(j,k)};C(R,j=>{s(T)>0&&j($)})}var L=i(R,2);{var ie=j=>{var k=Pn(),V=n(k,!0);e(k),f(()=>{P(k,"href",K()),r(V,H())}),h(j,k)},ee=j=>{var k=ae();f(()=>r(k,H())),h(j,k)};C(L,j=>{K()?j(ie):j(ee,!1)})}h(q,W)}),h(y,a)},_=(y,v=Q,a=Q)=>{var u=Wn();let q;var X=n(u);yn(X,a,(T,K)=>{K(T,{})}),e(u),f(()=>q=xn(u,"",q,{color:`var(--fg-${v()??""})`,"background-color":`var(--bg-${v()??""})`})),h(y,u)};var Pn=g('<a target="_blank"> </a>'),Kn=g("<!> <!>",1),Wn=g('<div class="swatch svelte-6yh93n"><!></div>'),Fn=g('<a href="https://enseeiht.fr"> </a>'),On=g('<dd class="svelte-6yh93n"><code> </code></dd>'),En=g("<!> <code> </code>",1),Gn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"></dd>',1),Cn=g('<dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),Tn=g("<code> </code>"),Hn=g("<code> </code>"),Rn=g("<code></code>"),Ln=g("<a> </a>"),Vn=g("<a> </a>"),Nn=g("<a> </a>"),Mn=g("<a> </a>"),Zn=g("<a> </a>"),_n=g('<a href="https://remixicon.com"> </a>'),$n=g('<a href="https://www.zhangxiaochun.com/"> </a>'),ea=g('<a href="https://gaoquanquan.com/"> </a>'),sa=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),na=g('<dl class="dependencies svelte-6yh93n"></dl>'),aa=g("<p> </p> <p> </p>",1),ia=g("<p> </p>"),ra=g('<header class="svelte-6yh93n"><!> <div class="text"><h1> </h1> <p class="subtitle svelte-6yh93n"> </p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames"> </a></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <dt> </dt> <dd class="svelte-6yh93n"> </dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/"> </a></dt> <dd class="svelte-6yh93n"><span><!></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code><!></code></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt></dt> <dd class="svelte-6yh93n"><!> <!> <!> <!> <!></dd></dl>',1);function xa(y,v){un(v,!0);const a=w(()=>vn(jn("main")));Xn({title:s(a).t(206)});let u=xs(void 0);ws(()=>{window.versions&&(ys(u,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(d=>{s(u)&&(s(u).os=d,s(u).sw=d.serviceWorkers)}))});let q=xs(0);ws(()=>{const d=setInterval(()=>{ys(q,Math.max(1,s(q)+.03),!0)},10);return()=>{s(q)>=1&&clearInterval(d)}});const X=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:d,gitlab:p,url:t})=>({name:d,url:t??`https://git.inpt.fr/${p}`})),T=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function K(){const{workspaces:d,packages:p}=In.parse(Jn);return[...Object.keys(d[""].dependencies),...Object.keys(d[""].devDependencies)].map(o=>[o,p[o][0].replace(`${o}@`,"")])}var H=ra(),W=B(H),R=n(W);An(R,{get drawpercent(){return s(q)}});var $=i(R,2),L=n($),ie=n(L,!0);e(L);var ee=i(L,2),j=n(ee,!0);e(ee),e($),e(W);var k=i(W,2),V=n(k),qs=n(V,!0);e(V);var re=i(V,2),As=n(re);vs(As,()=>X),e(re);var te=i(re,2),Xs=n(te,!0);e(te);var oe=i(te,2),Ds=n(oe);vs(Ds,()=>T),e(oe);var ce=i(oe,2),zs=n(ce,!0);e(ce);var pe=i(ce,2);{const d=(p,t=Q)=>{var o=Fn(),l=n(o,!0);e(o),f(c=>r(l,c),[()=>s(a).tx(t())]),h(p,o)};var Is=n(pe);{let p=w(()=>[d]),t=w(()=>s(a).cx(208));J(Is,{get t(){return s(p)},get x(){return s(t)}})}e(pe)}var Le=i(pe,2);{var Bs=d=>{var p=Cn(),t=B(p),o=n(t,!0);e(t);var l=i(t,2),c=n(l),m=n(c),b=n(m,!0);e(m);var x=i(m,2),D=n(x),Y=n(D,!0);e(D),e(x);var S=i(x,2),F=n(S,!0);e(S);var z=i(S,2),O=n(z),Ke=n(O,!0);e(O),e(z);var N=i(z,2),We=n(N,!0);e(N);var M=i(N,2),se=n(M),Fe=n(se,!0);e(se),e(M);var Oe=i(M,2);{var Ee=U=>{var E=Gn(),Z=B(E),Ge=n(Z,!0);e(Z);var Ce=i(Z,2),us=n(Ce),on=n(us,!0);e(us),e(Ce);var ms=i(Ce,2);{var cn=A=>{var I=On(),G=n(I),ne=n(G,!0);e(G),e(I),f(()=>r(ne,s(u).os.architecture)),h(A,I)};C(ms,A=>{s(u).os.archIsUnusual&&A(cn)})}var Te=i(ms,2),pn=n(Te,!0);e(Te);var gs=i(Te,2);Re(gs,22,()=>s(u).sw,A=>A,(A,I,G)=>{var ne=En(),bs=B(ne);{var ln=He=>{var hn=ae(",");h(He,hn)};C(bs,He=>{s(G)>0&&He(ln)})}var fs=i(bs,2),dn=n(fs,!0);e(fs),f(()=>r(dn,I)),h(A,ne)},A=>{fn();var I=ae();f(G=>r(I,G),[()=>s(a).t(209)]),h(A,I)}),e(gs),f(A=>{r(Ge,s(u).os.name),r(on,s(u).os.version),r(pn,A)},[()=>s(a).t(166)]),h(U,E)};C(Oe,U=>{"os"in s(u)&&U(Ee)})}e(c),e(l),f((U,E,Z,Ge)=>{r(o,U),r(b,E),r(Y,s(u).node),r(F,Z),r(Ke,s(u).chrome),r(We,Ge),r(Fe,s(u).electron)},[()=>s(a).t(191),()=>s(a).t(137),()=>s(a).t(62),()=>s(a).t(84)]),h(d,p)};C(Le,d=>{s(u)&&d(Bs)})}var le=i(Le,2),Ys=n(le,!0);e(le);var de=i(le,2),Ve=n(de),he=n(Ve),Ss=n(he,!0);e(he);var ue=i(he,2);{const d=p=>{var t=Tn(),o=n(t,!0);e(t),f(()=>r(o,v.data.parallelism)),h(p,t)};var Us=n(ue);{let p=w(()=>[d]),t=w(()=>s(a).cx(19));J(Us,{get t(){return s(p)},get x(){return s(t)}})}e(ue)}var me=i(ue,2),Js=n(me,!0);e(me);var ge=i(me,2);{const d=p=>{var t=Hn(),o=n(t,!0);e(t),f(()=>r(o,v.data.parallelism)),h(p,t)};var Ps=n(ge);{let p=w(()=>[d]),t=w(()=>s(a).cx(20));J(Ps,{get t(){return s(p)},get x(){return s(t)}})}e(ge)}var be=i(ge,2),Ks=n(be,!0);e(be);var Ne=i(be,2);{const d=p=>{var t=Rn();t.textContent=navigator.hardwareConcurrency,h(p,t)};var Ws=n(Ne);{let p=w(()=>[d]),t=w(()=>s(a).cx(22));J(Ws,{get t(){return s(p)},get x(){return s(t)}})}e(Ne)}e(Ve),e(de);var fe=i(de,2),Fs=n(fe,!0);e(fe);var we=i(fe,2),Me=n(we),Os=n(Me,!0);e(Me),e(we);var ye=i(we,2),Es=n(ye,!0);e(ye);var xe=i(ye,2),Ze=n(xe),ve=n(Ze),Gs=n(ve,!0);e(ve);var je=i(ve,2),_e=n(je),Cs=n(_e,!0);e(_e),e(je);var ke=i(je,2),Ts=n(ke,!0);e(ke);var $e=i(ke,2),es=n($e),Hs=n(es,!0);e(es),e($e),e(Ze),e(xe);var Qe=i(xe,2),Rs=n(Qe,!0);e(Qe);var qe=i(Qe,2),ss=n(qe),Ae=n(ss),Ls=n(Ae,!0);e(Ae);var Xe=i(Ae,2),Vs=n(Xe,!0);e(Xe);var De=i(Xe,2),Ns=n(De,!0);e(De);var ns=i(De,2),Ms=n(ns,!0);e(ns),e(ss),e(qe);var ze=i(qe,2),Zs=n(ze,!0);e(ze);var Ie=i(ze,2),as=n(Ie),Be=n(as),is=n(Be),_s=n(is,!0);e(is),e(Be);var Ye=i(Be,2),rs=n(Ye);{const d=(o,l=Q)=>{var c=Ln(),m=n(c,!0);e(c),f((b,x)=>{P(c,"href",b),r(m,x)},[()=>s(a).t(222),()=>s(a).tx(l())]),h(o,c)},p=(o,l=Q)=>{var c=Vn(),m=n(c,!0);e(c),f((b,x)=>{P(c,"href",b),r(m,x)},[()=>s(a).t(223),()=>s(a).tx(l())]),h(o,c)},t=(o,l=Q)=>{var c=Nn(),m=n(c,!0);e(c),f((b,x)=>{P(c,"href",b),r(m,x)},[()=>s(a).t(224),()=>s(a).tx(l())]),h(o,c)};var $s=n(rs);{let o=w(()=>[d,p,t]),l=w(()=>s(a).cx(198));J($s,{get t(){return s(o)},get x(){return s(l)}})}e(rs)}e(Ye);var ts=i(Ye,4),os=n(ts);{const d=(t,o=Q)=>{var l=Mn(),c=n(l,!0);e(l),f((m,b)=>{P(l,"href",m),r(c,b)},[()=>s(a).t(219),()=>s(a).tx(o())]),h(t,l)},p=(t,o=Q)=>{var l=Zn(),c=n(l,!0);e(l),f((m,b)=>{P(l,"href",m),r(c,b)},[()=>s(a).t(220),()=>s(a).tx(o())]),h(t,l)};var en=n(os);{let t=w(()=>[d,p]),o=w(()=>s(a).cx(221));J(en,{get t(){return s(t)},get x(){return s(o)}})}e(os)}e(ts),e(as),e(Ie);var Se=i(Ie,2),sn=n(Se,!0);e(Se);var Ue=i(Se,2);{const d=(o,l=Q)=>{var c=_n(),m=n(c,!0);e(c),f(b=>r(m,b),[()=>s(a).tx(l())]),h(o,c)},p=(o,l=Q)=>{var c=$n(),m=n(c,!0);e(c),f(b=>r(m,b),[()=>s(a).tx(l())]),h(o,c)},t=(o,l=Q)=>{var c=ea(),m=n(c,!0);e(c),f(b=>r(m,b),[()=>s(a).tx(l())]),h(o,c)};var nn=n(Ue);{let o=w(()=>[d,p,t]),l=w(()=>s(a).cx(380));J(nn,{get t(){return s(o)},get x(){return s(l)}})}e(Ue)}var Je=i(Ue,2),an=n(Je,!0);e(Je);var Pe=i(Je,2),rn=n(Pe);wn(rn,K,d=>{var p=ia(),t=n(p,!0);e(p),f(o=>r(t,o),[()=>s(a).t(54)]),h(d,p)},(d,p)=>{var t=na();Re(t,21,()=>s(p),([o,l])=>o,(o,l)=>{var c=w(()=>bn(s(l),2));let m=()=>s(c)[0],b=()=>s(c)[1];var x=sa(),D=B(x),Y=n(D),S=n(Y,!0);e(Y),e(D);var F=i(D,2),z=n(F),O=n(z,!0);e(z),e(F),f(()=>{P(Y,"href",`https://npmjs.com/package/${m()??""}`),r(S,m()),r(O,b())}),h(o,x)}),e(t),h(d,t)},(d,p)=>{var t=aa(),o=B(t),l=n(o,!0);e(o);var c=i(o,2),m=n(c,!0);e(c),f(b=>{r(l,b),r(m,s(p))},[()=>s(a).t(115)]),h(d,t)}),e(Pe);var cs=i(Pe,4),ps=n(cs);_(ps,()=>"error",()=>Qn);var ls=i(ps,2);_(ls,()=>"warning",()=>qn);var ds=i(ls,2);_(ds,()=>"success",()=>kn);var hs=i(ds,2);_(hs,()=>"primary",()=>Yn);var tn=i(hs,2);_(tn,()=>"neutral",()=>Un),e(cs),e(k),f((d,p,t,o,l,c,m,b,x,D,Y,S,F,z,O,Ke,N,We,M,se,Fe,Oe,Ee,U,E)=>{r(ie,d),r(j,p),r(qs,t),r(Xs,o),r(zs,l),r(Ys,c),r(Ss,m),r(Js,b),r(Ks,x),r(Fs,D),r(Os,Y),r(Es,S),r(Gs,F),r(Cs,z),r(Ts,O),r(Hs,Ke),r(Rs,N),r(Ls,We),r(Vs,M),r(Ns,se),r(Ms,Fe),r(Zs,Oe),r(_s,Ee),r(sn,U),r(an,E)},[()=>s(a).t(45),()=>s(a).t(64),()=>s(a).t(82),()=>s(a).t(167),()=>s(a).t(75),()=>s(a).t(145),()=>s(a).t(213),()=>s(a).t(201),()=>s(a).t(102),()=>s(a).t(68),()=>s(a).t(197),()=>s(a).t(42),()=>s(a).t(28),()=>s(a).t(125),()=>s(a).t(32),()=>s(a).t(23),()=>s(a).t(43),()=>s(a).t(81),()=>s(a).t(193),()=>s(a).t(63),()=>s(a).t(160),()=>s(a).t(98),()=>s(a).t(103),()=>s(a).t(104),()=>s(a).t(100)]),h(y,H),mn()}export{xa as component};
