import"../chunks/DsnmJJEf.js";import{an as Je,u as fe,as as xe,a6 as i,ao as we,b as g,c as w,n as Be,at as n,ap as f,a as o,aq as Me,ar as a,d as He,av as T,r as e,aw as F,au as Le,bg as Fe}from"../chunks/DXyNsHU5.js";import{s as t}from"../chunks/DLhwE2ue.js";import{a as Re}from"../chunks/vwtOFZHG.js";import{i as A}from"../chunks/IoEVXbRs.js";import{e as ae}from"../chunks/DEVHofr0.js";import{s as ve}from"../chunks/DZ5flPZE.js";import{L as Ke}from"../chunks/g9AwcNFP.js";import{s as Ce}from"../chunks/DP4k2qoJ.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ve=je,Ze=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ee():s==="fr"?je():Ve()},Ne=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ne():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
