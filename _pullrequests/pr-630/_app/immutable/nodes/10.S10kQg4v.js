import"../chunks/DsnmJJEf.js";import{an as Be,u as fe,as as xe,a6 as i,ao as we,b as g,c as w,n as Je,at as n,ap as f,a as o,aq as Te,ar as a,d as Le,av as P,r as e,aM as M,au as Ke,bg as Me}from"../chunks/DB7sMo_p.js";import{s as t}from"../chunks/CkTv1Zh3.js";import{a as He}from"../chunks/x3BWD8_b.js";import{i as A}from"../chunks/BU-apHb0.js";import{e as ae}from"../chunks/BPo66P45.js";import{s as ve}from"../chunks/DYaIaAA0.js";import{L as Ce}from"../chunks/Cqv-63Bf.js";import{s as Re}from"../chunks/ClS8oKkQ.js";import{g as H}from"../chunks/B0nJzvm_.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ve=je,Ne=(u={},d={})=>{const s=d.locale??H();return s==="en"?Ee():s==="fr"?je():Ve()},Ze=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??H();return s==="en"?Ze():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??H();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??H();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
