import"../chunks/DsnmJJEf.js";import{ao as Xe,d as le,at as ce,g as i,ap as de,h as g,j as w,n as We,aq as y,a as t,ar as Ue,au as s,as as r,k as Ge,aw as me,l as e,ax as M,av as Ye,b9 as Pe}from"../chunks/BWVk_GV2.js";import{s as o}from"../chunks/CSPdK7lp.js";import{a as Te}from"../chunks/Bk2qNnrd.js";import{i as A}from"../chunks/BAwvluI4.js";import{e as ee}from"../chunks/D2nioleA.js";import{s as ue}from"../chunks/Cxna-3d7.js";import{L as Se}from"../chunks/DIEsF4xQ.js";import{s as Oe}from"../chunks/CbktSlfY.js";import{g as L}from"../chunks/DEue9iQn.js";const Be=()=>"Developed by",ge=()=>"Développé par",He=ge,Ie=(m={},h={})=>{const n=h.locale??L();return n==="en"?Be():n==="fr"?ge():He()},Fe=()=>"About",be=()=>"À propos",Je=be,Me=(m={},h={})=>{const n=h.locale??L();return n==="en"?Fe():n==="fr"?be():Je()},Le=()=>"Under the supervision of",ye=()=>"Sous la supervision de",Ee=ye,Ke=(m={},h={})=>{const n=h.locale??L();return n==="en"?Le():n==="fr"?ye():Ee()},Re=()=>"As part of",fe=()=>"Dans le cadre d'un",Ce=fe,Ze=(m={},h={})=>{const n=h.locale??L();return n==="en"?Re():n==="fr"?fe():Ce()},Ve=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,Ne=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,_e={parse:m=>{m=String(m);try{return JSON.parse(m)}catch{return JSON.parse(m.replace(Ve,"$1").replace(Ne,"$1"))}}},$e=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
  ...
  "packages": {
    ...
    "@inlang/paraglide-js": ["@inlang/paraglide-js@2.3.0", "", { "dependencies": { "@inlang/recommend-sherlock": "0.2.1", "@inlang/sdk": "2.4.9", "commander": "11.1.0", "consola": "3.4.0", "json5": "2.2.3", "unplugin": "^2.1.2", "urlpattern-polyfill": "^10.0.0" }, "bin": { "paraglide-js": "bin/run.js" } }, "sha512-BXrQ77UL04zs5lRhfNW+DmTNbCcH1xBt5eDxntq+or5YHbJP1Srf57mRUHybX1A0XOQFThd+pvtkzcrnBvlc1w=="],
    ...
    "swarpc": ["swarpc@0.12.0", "", { "dependencies": { "arktype": "^2.1.22" } }, "sha512-wSmNXsfzDg51452aIMW6/9Gf3+TiEJniKG/UQydVhdmHs6dnY86cwPRLUGRNMI1T0Fn3qrrfXKfYV6DO/70eyQ=="],
...
`,he=(m,h=We)=>{var n=Ge(),j=w(n);ee(j,19,()=>h().sort(()=>Math.random()-.5),({url:q,name:k})=>q||k,(q,k,E)=>{let D=()=>i(k).url,Q=()=>i(k).name;var S=nn(),z=w(S);{var X=p=>{var u=M(",");t(p,u)};A(z,p=>{i(E)>0&&p(X)})}var K=r(z,2);{var W=p=>{var u=en(),U=s(u,!0);e(u),y(()=>{ue(u,"href",D()),o(U,Q())}),t(p,u)},R=p=>{var u=M();y(()=>o(u,Q())),t(p,u)};A(K,p=>{D()?p(W):p(R,!1)})}t(q,S)}),t(m,n)};var en=g('<a target="_blank"> </a>'),nn=g("<!> <!>",1),sn=g('<dd class="svelte-6yh93n"><code> </code></dd>'),an=g("<!> <code> </code>",1),rn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt>Service workers</dt> <dd class="svelte-6yh93n"></dd>',1),tn=g('<dt>Versions</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Node.js</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Chrome</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Electron</dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),on=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code> </code></dd>',1),pn=g('<dl class="svelte-6yh93n"></dl>'),ln=g("<p>Impossible de charger les dépendances</p> <p> </p>",1),cn=g("<p>Chargement des dépendances…</p>"),dn=g(`<header class="svelte-6yh93n"><!> <div class="text"><h1>C.i.g.a.l.e.</h1> <p class="subtitle svelte-6yh93n">Classification Intelligente et Gestion des Arthropodes et de L'Entomofaune</p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n">“Projet long” de l'<a href="https://enseeiht.fr">INP-ENSEEIHT</a></dd> <!> <dt>Code source</dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale">github.com/cigaleapp/cigale</a></dd> <dt>Avec les données</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Aides à l'identification</dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification">Les carnets nature de Jessica</a></dd> <dt>Arbre taxonomique</dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames">API de GBIF</a></dd></dl></dd> <dt>Avec les modèles</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Détection & recadrage</dt> <dd class="svelte-6yh93n">YOLO 11n</dd> <dt>Classification</dt> <dd class="svelte-6yh93n">ResNet50</dd></dl></dd> <dt>Fontes</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/">Host Grotesk</a></dt> <dd class="svelte-6yh93n">par <a href="https://doughkan.com/">Doğukan Karapınar</a> et <a href="https://ibrahimkactioglu.com/">İbrahim Kaçtıoğlu</a>, chez <a href="https://elementtype.co/">Element Type Foundry</a></dd> <dt><a href="https://github.com/weiweihuanghuang/fragment-mono/"><code>Fragment Mono</code></a></dt> <dd class="svelte-6yh93n"><code>par <a href="https://weiweihuanghuang.github.io/">Wei Huang</a>, chez <a href="https://studiolin.org/projects/374-2/">Studio Lin</a></code></dd></dl></dd> <dt>Icônes</dt> <dd class="svelte-6yh93n"><a href="https://phosphoricons.com/">Phosphor Icons</a> par <a href="https://helenazhang.com">Helena Zhang</a> et <a href="https://tobiasfried.com">Tobias Fried</a></dd> <dt>Grâce aux bibliothèques</dt> <dd class="svelte-6yh93n"><!></dd></dl>`,1);function jn(m,h){Xe(h,!0),Oe({title:Me()});let n=de(void 0);le(()=>{window.versions&&(ce(n,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(a=>{i(n)&&(i(n).os=a,i(n).sw=a.serviceWorkers)}))});let j=de(0);le(()=>{const a=setInterval(()=>{ce(j,Math.max(1,i(j)+.03),!0)},10);return()=>{i(j)>=1&&clearInterval(a)}});const q=[{name:"Achraf Khairoun",gitlab:"khairoa"},{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:a,gitlab:l,url:c})=>({name:a,url:c??`https://git.inpt.fr/${l}`})),k=[{name:"Axel C.",url:""},{name:"Maxime C.",url:""},{name:"Rémy E.",url:""},{name:"Thomas F.",url:""}];async function E(){const{workspaces:a,packages:l}=_e.parse($e);return[...Object.keys(a[""].dependencies),...Object.keys(a[""].devDependencies)].map(d=>[d,l[d][0].replace(`${d}@`,"")])}var D=dn(),Q=w(D),S=s(Q);Se(S,{get drawpercent(){return i(j)}}),me(2),e(Q);var z=r(Q,2),X=s(z),K=s(X,!0);e(X);var W=r(X,2),R=s(W);he(R,()=>q),e(W);var p=r(W,2),u=s(p,!0);e(p);var U=r(p,2),we=s(U);he(we,()=>k),e(U);var C=r(U,2),ve=s(C,!0);e(C);var ne=r(C,4);{var xe=a=>{var l=tn(),c=r(w(l),2),d=s(c),f=r(s(d),2),G=s(f),O=s(G,!0);e(G),e(f);var Y=r(f,4),P=s(Y),T=s(P,!0);e(P),e(Y);var v=r(Y,4),B=s(v),H=s(B,!0);e(B),e(v);var I=r(v,2);{var Z=V=>{var ie=rn(),N=w(ie),ke=s(N,!0);e(N);var _=r(N,2),ae=s(_),Qe=s(ae,!0);e(ae),e(_);var re=r(_,2);{var Ae=b=>{var x=sn(),F=s(x),J=s(F,!0);e(F),e(x),y(()=>o(J,i(n).os.architecture)),t(b,x)};A(re,b=>{i(n).os.archIsUnusual&&b(Ae)})}var te=r(re,4);ee(te,22,()=>i(n).sw,b=>b,(b,x,F)=>{var J=an(),oe=w(J);{var qe=$=>{var ze=M(",");t($,ze)};A(oe,$=>{i(F)>0&&$(qe)})}var pe=r(oe,2),De=s(pe,!0);e(pe),y(()=>o(De,x)),t(b,J)},b=>{me();var x=M("(none)");t(b,x)}),e(te),y(()=>{o(ke,i(n).os.name),o(Qe,i(n).os.version)}),t(V,ie)};A(I,V=>{"os"in i(n)&&V(Z)})}e(d),e(c),y(()=>{o(O,i(n).node),o(T,i(n).chrome),o(H,i(n).electron)}),t(a,l)};A(ne,a=>{i(n)&&a(xe)})}var se=r(ne,24),je=s(se);Te(je,E,a=>{var l=cn();t(a,l)},(a,l)=>{var c=pn();ee(c,21,()=>i(l),([d,f])=>d,(d,f)=>{var G=Ye(()=>Pe(i(f),2));let O=()=>i(G)[0],Y=()=>i(G)[1];var P=on(),T=w(P),v=s(T),B=s(v,!0);e(v),e(T);var H=r(T,2),I=s(H),Z=s(I,!0);e(I),e(H),y(()=>{ue(v,"href",`https://npmjs.com/package/${O()??""}`),o(B,O()),o(Z,Y())}),t(d,P)}),e(c),t(a,c)},(a,l)=>{var c=ln(),d=r(w(c),2),f=s(d,!0);e(d),y(()=>o(f,i(l))),t(a,c)}),e(se),e(z),y((a,l,c)=>{o(K,a),o(u,l),o(ve,c)},[()=>Ie(),()=>Ke(),()=>Ze()]),t(m,D),Ue()}export{jn as component};
