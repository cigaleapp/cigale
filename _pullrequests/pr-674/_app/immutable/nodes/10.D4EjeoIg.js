import"../chunks/DsnmJJEf.js";import{an as Oe,u as fe,aw as we,a6 as i,av as xe,b as g,c as x,n as Be,ap as n,au as f,a as o,ao as He,aq as a,d as Le,as as T,r as e,at as F,ar as Me,bg as Fe}from"../chunks/DjE0KoJq.js";import{s as t}from"../chunks/vPXWHGWZ.js";import{a as Re}from"../chunks/DfTOaXJ3.js";import{i as A}from"../chunks/36hShb1C.js";import{e as ae}from"../chunks/D8PTDlqF.js";import{c as ve}from"../chunks/DUZ0vp7F.js";import{L as Ke}from"../chunks/D3y8LFRC.js";import{s as Ce}from"../chunks/COGdxch9.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ze=je,Ne=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ee():s==="fr"?je():Ze()},Ve=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ve():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  ...
  "packages": {
    ...
    "@cigale/beamup": ["@cigale/beamup@0.2.0", "", { "dependencies": { "arktype": "^2.1.22" }, "peerDependencies": { "typescript": "^5" } }, "sha512-hzsYn1vuotslAikLujD8+WOKbq9oR0pZNg3UeXJulGEYtvuh8hqMe26tOg3G+udSBT4PBzlRS8yPMcgAaPrGQw=="],
