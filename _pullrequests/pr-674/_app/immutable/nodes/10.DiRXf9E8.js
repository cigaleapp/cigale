import"../chunks/DsnmJJEf.js";import{an as Oe,u as fe,aw as we,a6 as i,av as xe,b as g,c as x,n as Be,ap as n,au as f,a as o,ao as He,aq as a,d as Le,as as T,r as e,at as F,ar as Me,bg as Fe}from"../chunks/DjE0KoJq.js";import{s as t}from"../chunks/vPXWHGWZ.js";import{a as Re}from"../chunks/DfTOaXJ3.js";import{i as A}from"../chunks/36hShb1C.js";import{e as ae}from"../chunks/D8PTDlqF.js";import{c as ve}from"../chunks/DUZ0vp7F.js";import{L as Ke}from"../chunks/D3y8LFRC.js";import{s as Ee}from"../chunks/COGdxch9.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ze=je,Ne=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ce():s==="fr"?je():Ze()},Ve=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ve():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
