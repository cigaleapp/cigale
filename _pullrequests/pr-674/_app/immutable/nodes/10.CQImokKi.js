import"../chunks/DsnmJJEf.js";import{al as Je,u as fe,au as xe,a4 as i,at as we,b as g,c as w,n as Be,an as n,as as f,a as o,am as Le,ao as a,d as Me,aq as O,r as e,ar as F,ap as He,bf as Fe}from"../chunks/CM16E1jt.js";import{s as t}from"../chunks/C0QqCeqR.js";import{a as Re}from"../chunks/BvvZIn_s.js";import{i as A}from"../chunks/BLy80i-_.js";import{e as ae}from"../chunks/B2G_MwUN.js";import{c as ve}from"../chunks/Buals9dB.js";import{L as Ke}from"../chunks/BElUICck.js";import{s as Ee}from"../chunks/B3kzUd_A.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ze=je,Ve=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ce():s==="fr"?je():Ze()},Ne=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ne():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
  ...
  "packages": {
    ...
    "@cigale/beamup": ["@cigale/beamup@0.2.1", "", { "dependencies": { "arktype": "^2.1.22" }, "peerDependencies": { "typescript": "^5" } }, "sha512-H15RR1RUP0+1xq6LUdmb59DUT7V18VUwU5Y3cY4McjiFzEZoEODbPgLDmF8Z45nO271VSatTERXFAZKWLtItFg=="],
