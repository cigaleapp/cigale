import"../chunks/DsnmJJEf.js";import{al as Je,u as fe,ax as xe,a4 as i,aw as we,b as g,c as w,n as Be,an as n,as as f,a as o,am as Me,ao as a,d as He,aq as O,r as e,ar as F,ap as Le,bf as Fe}from"../chunks/j9Ouhb1s.js";import{s as t}from"../chunks/CM5uo1r_.js";import{a as Re}from"../chunks/BWrW5_Vb.js";import{i as A}from"../chunks/eVq5crI4.js";import{e as ae}from"../chunks/CzeNYNil.js";import{c as ve}from"../chunks/CQ0hGQWZ.js";import{L as Ke}from"../chunks/DttYshRv.js";import{s as Ce}from"../chunks/CJRSyN_z.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ze=je,Ve=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ee():s==="fr"?je():Ze()},Ne=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ne():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
