import"../chunks/DsnmJJEf.js";import{p as as,m as e,u as f,B as un,z as mn,x as gn,n as g,o as B,q as k,t as b,a as h,l as is,az as s,aA as r,v as rs,w as n,ak as ne,aZ as ts,aB as os}from"../chunks/BDtOiZFO.js";import{a as i}from"../chunks/DR030_pn.js";import{a as ps}from"../chunks/Cul-3UY5.js";import{i as G}from"../chunks/BcJ04aCr.js";import{e as Te}from"../chunks/YgQWdiyO.js";import{s as U,_ as cs,g as ls}from"../chunks/DbnuYJg0.js";import{R as S}from"../chunks/gUGbINso.js";import{L as ds}from"../chunks/B2Plq7_0.js";import{s as hs}from"../chunks/BGJy3jh2.js";const us=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,ms=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,gs={parse:Q=>{Q=String(Q);try{return JSON.parse(Q)}catch{return JSON.parse(Q.replace(us,"$1").replace(ms,"$1"))}}},bs=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
      "dependencies": {
        ...
        "piexifjs": "^1.0.6",
        "runed": "^0.34.0",
        "svelte-mathml": "gwennlbh/svelte-mathml#9a0ff3dced87297077a186ca343b6c6b105320c6",
  ...
  "packages": {
    ...
    "@cigale/beamup": ["@cigale/beamup@0.6.4", "", { "dependencies": { "arktype": "^2.1.22" }, "peerDependencies": { "typescript": "^5.9.2" } }, "sha512-9IkRhEOrUwUrd3AYNpvpqMmSQKzEhcZp+AjukqCZLFEHiDk8lIMpfg2ZAlBT8qBiH6Ch/qBsv5+Sf244gaWU7Q=="],
    ...
    "@wuchale/svelte": ["@wuchale/svelte@0.16.4", "", { "dependencies": { "svelte": "^5.37.0", "wuchale": "^0.17.1" } }, "sha512-DQsbNg9ohFCl/RPfg462BhEkswGUHyCWR3iorWxyit1vRS8WXXkWiKToujYZpG+Ab3keA7QkzNNcBdyQ+BAVOw=="],
    ...
    "eslint-plugin-oxlint": ["eslint-plugin-oxlint@1.22.0", "", { "dependencies": { "jsonc-parser": "^3.3.1" } }, "sha512-EOzcSweCPXfy2ncWriSHlA5omZhXrnY60ESOLRxarOQxmOfZnwHciFsw6IRG2K6X1MCimRK9ak5uuEi1DElZJQ=="],
    ...
    "fake-indexeddb": ["fake-indexeddb@6.2.3", "", {}, "sha512-idzJXFtDIHNShFZ9ssS8IdsRgAP0t9zwWvSdCKsWK2dgh2xcXA6/2Oteaxar5GJqmwzZXCrKRO6F5IEiR4yJzw=="],
    ...
    "knip": ["knip@5.64.3", "", { "dependencies": { "@nodelib/fs.walk": "^1.2.3", "fast-glob": "^3.3.3", "formatly": "^0.3.0", "jiti": "^2.6.0", "js-yaml": "^4.1.0", "minimist": "^1.2.8", "oxc-resolver": "^11.8.3", "picocolors": "^1.1.1", "picomatch": "^4.0.1", "smol-toml": "^1.4.1", "strip-json-comments": "5.0.2", "zod": "^4.1.11" }, "peerDependencies": { "@types/node": ">=18", "typescript": ">=5.0.4 <7" }, "bin": { "knip": "bin/knip.js", "knip-bun": "bin/knip-bun.js" } }, "sha512-P9dZetEZfSBwNBFwj55CAnPAMdzVLTTscWx6rdB8eBmPqXPji8F3L+hhWi+Xp+u9O6Xp2ClRDq2JENSK8Z04Qg=="],
    ...
    "svelte-mathml": ["svelte-mathml@github:gwennlbh/svelte-mathml#9a0ff3d", { "peerDependencies": { "svelte": "^5.0.0" } }, "gwennlbh-svelte-mathml-9a0ff3d"],
...
`,bn=(Q,O=k)=>{var a=rs(),w=B(a);Te(w,19,()=>O().sort(()=>Math.random()-.5),({url:A,name:J})=>A||J,(A,J,se)=>{let Z=()=>e(J).url,L=()=>e(J).name;var P=fs(),T=B(P);{var N=y=>{var v=ne(",");h(y,v)};G(T,y=>{e(se)>0&&y(N)})}var C=r(T,2);{var ae=y=>{var v=ws(),R=s(v,!0);n(v),b(()=>{U(v,"href",Z()),i(R,L())}),h(y,v)},_=y=>{var v=ne();b(()=>i(v,L())),h(y,v)};G(C,y=>{Z()?y(ae):y(_,!1)})}h(A,P)}),h(Q,a)};var ws=g('<a target="_blank"> </a>'),fs=g("<!> <!>",1),xs=g('<a href="https://enseeiht.fr"> </a>'),ys=g('<dd class="svelte-6yh93n"><code> </code></dd>'),vs=g("<!> <code> </code>",1),js=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"></dd>',1),ks=g('<dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),Qs=g("<code> </code>"),As=g("<code> </code>"),qs=g("<code></code>"),Xs=g("<a> </a>"),Ys=g("<a> </a>"),Bs=g("<a> </a>"),Is=g("<a> </a>"),zs=g("<a> </a>"),Ds=g('<a href="https://phosphoricons.com/"> </a>'),Ss=g('<a href="https://helenazhang.com"> </a>'),Us=g('<a href="https://tobiasfried.com"> </a>'),Js=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),Ps=g('<dl class="dependencies svelte-6yh93n"></dl>'),Fs=g("<p> </p> <p> </p>",1),Ws=g("<p> </p>"),Es=g('<header class="svelte-6yh93n"><!> <div class="text"><h1> </h1> <p class="subtitle svelte-6yh93n"> </p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames"> </a></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <dt> </dt> <dd class="svelte-6yh93n"> </dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/"> </a></dt> <dd class="svelte-6yh93n"><span><!></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code><!></code></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl>',1);function Zs(Q,O){as(O,!0);const a=f(()=>cs(ls("main")));hs({title:e(a).t(220)});let w=gn(void 0);un(()=>{window.versions&&(mn(w,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(d=>{e(w)&&(e(w).os=d,e(w).sw=d.serviceWorkers)}))});let A=gn(0);un(()=>{const d=setInterval(()=>{mn(A,Math.max(1,e(A)+.03),!0)},10);return()=>{e(A)>=1&&clearInterval(d)}});const J=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:d,gitlab:c,url:t})=>({name:d,url:t??`https://git.inpt.fr/${c}`})),se=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function Z(){const{workspaces:d,packages:c}=gs.parse(bs);return[...Object.keys(d[""].dependencies),...Object.keys(d[""].devDependencies)].map(o=>[o,c[o][0].replace(`${o}@`,"")])}var L=Es(),P=B(L),T=s(P);ds(T,{get drawpercent(){return e(A)}});var N=r(T,2),C=s(N),ae=s(C,!0);n(C);var _=r(C,2),y=s(_,!0);n(_),n(N),n(P);var v=r(P,2),R=s(v),wn=s(R,!0);n(R);var ie=r(R,2),fn=s(ie);bn(fn,()=>J),n(ie);var re=r(ie,2),xn=s(re,!0);n(re);var te=r(re,2),yn=s(te);bn(yn,()=>se),n(te);var oe=r(te,2),vn=s(oe,!0);n(oe);var pe=r(oe,2);{const d=(c,t=k)=>{var o=xs(),l=s(o,!0);n(o),b(p=>i(l,p),[()=>e(a).tx(t())]),h(c,o)};var jn=s(pe);{let c=f(()=>[d]),t=f(()=>e(a).cx(222));S(jn,{get t(){return e(c)},get x(){return e(t)}})}n(pe)}var Ce=r(pe,2);{var kn=d=>{var c=ks(),t=B(c),o=s(t,!0);n(t);var l=r(t,2),p=s(l),u=s(p),m=s(u,!0);n(u);var x=r(u,2),q=s(x),I=s(q,!0);n(q),n(x);var z=r(x,2),F=s(z,!0);n(z);var X=r(z,2),W=s(X),Je=s(W,!0);n(W),n(X);var H=r(X,2),Pe=s(H,!0);n(H);var V=r(H,2),$=s(V),Fe=s($,!0);n($),n(V);var We=r(V,2);{var Ee=D=>{var E=js(),M=B(E),Ke=s(M,!0);n(M);var Ge=r(M,2),pn=s(Ge),Nn=s(pn,!0);n(pn),n(Ge);var cn=r(Ge,2);{var _n=j=>{var Y=ys(),K=s(Y),ee=s(K,!0);n(K),n(Y),b(()=>i(ee,e(w).os.architecture)),h(j,Y)};G(cn,j=>{e(w).os.archIsUnusual&&j(_n)})}var Oe=r(cn,2),$n=s(Oe,!0);n(Oe);var ln=r(Oe,2);Te(ln,22,()=>e(w).sw,j=>j,(j,Y,K)=>{var ee=vs(),dn=B(ee);{var es=Le=>{var ss=ne(",");h(Le,ss)};G(dn,Le=>{e(K)>0&&Le(es)})}var hn=r(dn,2),ns=s(hn,!0);n(hn),b(()=>i(ns,Y)),h(j,ee)},j=>{os();var Y=ne();b(K=>i(Y,K),[()=>e(a).t(223)]),h(j,Y)}),n(ln),b(j=>{i(Ke,e(w).os.name),i(Nn,e(w).os.version),i($n,j)},[()=>e(a).t(180)]),h(D,E)};G(We,D=>{"os"in e(w)&&D(Ee)})}n(p),n(l),b((D,E,M,Ke)=>{i(o,D),i(m,E),i(I,e(w).node),i(F,M),i(Je,e(w).chrome),i(Pe,Ke),i(Fe,e(w).electron)},[()=>e(a).t(205),()=>e(a).t(146),()=>e(a).t(68),()=>e(a).t(90)]),h(d,c)};G(Ce,d=>{e(w)&&d(kn)})}var ce=r(Ce,2),Qn=s(ce,!0);n(ce);var le=r(ce,2),Re=s(le),de=s(Re),An=s(de,!0);n(de);var he=r(de,2);{const d=c=>{var t=Qs(),o=s(t,!0);n(t),b(()=>i(o,O.data.parallelism)),h(c,t)};var qn=s(he);{let c=f(()=>[d]),t=f(()=>e(a).cx(23));S(qn,{get t(){return e(c)},get x(){return e(t)}})}n(he)}var ue=r(he,2),Xn=s(ue,!0);n(ue);var me=r(ue,2);{const d=c=>{var t=As(),o=s(t,!0);n(t),b(()=>i(o,O.data.parallelism)),h(c,t)};var Yn=s(me);{let c=f(()=>[d]),t=f(()=>e(a).cx(24));S(Yn,{get t(){return e(c)},get x(){return e(t)}})}n(me)}var ge=r(me,2),Bn=s(ge,!0);n(ge);var He=r(ge,2);{const d=c=>{var t=qs();t.textContent=navigator.hardwareConcurrency,h(c,t)};var In=s(He);{let c=f(()=>[d]),t=f(()=>e(a).cx(26));S(In,{get t(){return e(c)},get x(){return e(t)}})}n(He)}n(Re),n(le);var be=r(le,2),zn=s(be,!0);n(be);var we=r(be,2),Ve=s(we),Dn=s(Ve,!0);n(Ve),n(we);var fe=r(we,2),Sn=s(fe,!0);n(fe);var xe=r(fe,2),Me=s(xe),ye=s(Me),Un=s(ye,!0);n(ye);var ve=r(ye,2),Ze=s(ve),Jn=s(Ze,!0);n(Ze),n(ve);var je=r(ve,2),Pn=s(je,!0);n(je);var Ne=r(je,2),_e=s(Ne),Fn=s(_e,!0);n(_e),n(Ne),n(Me),n(xe);var ke=r(xe,2),Wn=s(ke,!0);n(ke);var Qe=r(ke,2),$e=s(Qe),Ae=s($e),En=s(Ae,!0);n(Ae);var qe=r(Ae,2),Kn=s(qe,!0);n(qe);var Xe=r(qe,2),Gn=s(Xe,!0);n(Xe);var en=r(Xe,2),On=s(en,!0);n(en),n($e),n(Qe);var Ye=r(Qe,2),Ln=s(Ye,!0);n(Ye);var Be=r(Ye,2),nn=s(Be),Ie=s(nn),sn=s(Ie),Tn=s(sn,!0);n(sn),n(Ie);var ze=r(Ie,2),an=s(ze);{const d=(o,l=k)=>{var p=Xs(),u=s(p,!0);n(p),b((m,x)=>{U(p,"href",m),i(u,x)},[()=>e(a).t(236),()=>e(a).tx(l())]),h(o,p)},c=(o,l=k)=>{var p=Ys(),u=s(p,!0);n(p),b((m,x)=>{U(p,"href",m),i(u,x)},[()=>e(a).t(237),()=>e(a).tx(l())]),h(o,p)},t=(o,l=k)=>{var p=Bs(),u=s(p,!0);n(p),b((m,x)=>{U(p,"href",m),i(u,x)},[()=>e(a).t(238),()=>e(a).tx(l())]),h(o,p)};var Cn=s(an);{let o=f(()=>[d,c,t]),l=f(()=>e(a).cx(212));S(Cn,{get t(){return e(o)},get x(){return e(l)}})}n(an)}n(ze);var rn=r(ze,4),tn=s(rn);{const d=(t,o=k)=>{var l=Is(),p=s(l,!0);n(l),b((u,m)=>{U(l,"href",u),i(p,m)},[()=>e(a).t(233),()=>e(a).tx(o())]),h(t,l)},c=(t,o=k)=>{var l=zs(),p=s(l,!0);n(l),b((u,m)=>{U(l,"href",u),i(p,m)},[()=>e(a).t(234),()=>e(a).tx(o())]),h(t,l)};var Rn=s(tn);{let t=f(()=>[d,c]),o=f(()=>e(a).cx(235));S(Rn,{get t(){return e(t)},get x(){return e(o)}})}n(tn)}n(rn),n(nn),n(Be);var De=r(Be,2),Hn=s(De,!0);n(De);var Se=r(De,2);{const d=(o,l=k)=>{var p=Ds(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)},c=(o,l=k)=>{var p=Ss(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)},t=(o,l=k)=>{var p=Us(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)};var Vn=s(Se);{let o=f(()=>[d,c,t]),l=f(()=>e(a).cx(27));S(Vn,{get t(){return e(o)},get x(){return e(l)}})}n(Se)}var Ue=r(Se,2),Mn=s(Ue,!0);n(Ue);var on=r(Ue,2),Zn=s(on);ps(Zn,Z,d=>{var c=Ws(),t=s(c,!0);n(c),b(o=>i(t,o),[()=>e(a).t(59)]),h(d,c)},(d,c)=>{var t=Ps();Te(t,21,()=>e(c),([o,l])=>o,(o,l)=>{var p=f(()=>ts(e(l),2));let u=()=>e(p)[0],m=()=>e(p)[1];var x=Js(),q=B(x),I=s(q),z=s(I,!0);n(I),n(q);var F=r(q,2),X=s(F),W=s(X,!0);n(X),n(F),b(()=>{U(I,"href",`https://npmjs.com/package/${u()??""}`),i(z,u()),i(W,m())}),h(o,x)}),n(t),h(d,t)},(d,c)=>{var t=Fs(),o=B(t),l=s(o,!0);n(o);var p=r(o,2),u=s(p,!0);n(p),b(m=>{i(l,m),i(u,e(c))},[()=>e(a).t(121)]),h(d,t)}),n(on),n(v),b((d,c,t,o,l,p,u,m,x,q,I,z,F,X,W,Je,H,Pe,V,$,Fe,We,Ee,D,E)=>{i(ae,d),i(y,c),i(wn,t),i(xn,o),i(vn,l),i(Qn,p),i(An,u),i(Xn,m),i(Bn,x),i(zn,q),i(Dn,I),i(Sn,z),i(Un,F),i(Jn,X),i(Pn,W),i(Fn,Je),i(Wn,H),i(En,Pe),i(Kn,V),i(Gn,$),i(On,Fe),i(Ln,We),i(Tn,Ee),i(Hn,D),i(Mn,E)},[()=>e(a).t(50),()=>e(a).t(70),()=>e(a).t(88),()=>e(a).t(181),()=>e(a).t(81),()=>e(a).t(154),()=>e(a).t(227),()=>e(a).t(215),()=>e(a).t(108),()=>e(a).t(74),()=>e(a).t(211),()=>e(a).t(47),()=>e(a).t(33),()=>e(a).t(132),()=>e(a).t(37),()=>e(a).t(28),()=>e(a).t(48),()=>e(a).t(87),()=>e(a).t(207),()=>e(a).t(69),()=>e(a).t(174),()=>e(a).t(104),()=>e(a).t(109),()=>e(a).t(110),()=>e(a).t(106)]),h(Q,L),is()}export{Zs as component};
