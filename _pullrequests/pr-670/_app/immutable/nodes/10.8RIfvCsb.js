import"../chunks/DsnmJJEf.js";import{ao as Oe,d as fe,ax as we,g as i,aw as xe,h as g,j as x,n as Be,aq as n,av as f,a as o,ap as He,ar as a,k as Le,at as J,l as e,au as F,as as Me,b8 as Fe}from"../chunks/C7-SyOmZ.js";import{s as t}from"../chunks/DTkINwIJ.js";import{a as Re}from"../chunks/5yStqDHl.js";import{i as A}from"../chunks/D0ESjDJY.js";import{e as ae}from"../chunks/DNYXL8V7.js";import{c as ve}from"../chunks/BqbaD9oV.js";import{L as Ce}from"../chunks/F0kFAels.js";import{s as Ke}from"../chunks/DZ4HI5AA.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ze=je,Ne=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ee():s==="fr"?je():Ze()},Ve=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ve():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  ...
  "packages": {
    ...
    "pdf-to-png-converter": ["pdf-to-png-converter@3.8.0", "", { "dependencies": { "@napi-rs/canvas": "~0.1.80", "pdfjs-dist": "~5.4.149" } }, "sha512-7usuMvb14vYPomFZnA2CB9jdrtgAYctzLLfIJhlYBh4Ddx/9K5YnSNVtJZzm4r7ta66x2GA7FtlwsdGaMQTlqQ=="],
