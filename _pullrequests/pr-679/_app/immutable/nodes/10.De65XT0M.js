import"../chunks/DsnmJJEf.js";import{an as Oe,u as fe,aw as we,a6 as i,av as xe,b as g,c as x,n as Be,ap as n,au as f,a as o,ao as Le,aq as a,d as He,as as S,r as e,at as F,ar as Me,bg as Fe}from"../chunks/Bb5GQOzu.js";import{s as t}from"../chunks/DHm4hF0_.js";import{a as Re}from"../chunks/D1CsqKRT.js";import{i as q}from"../chunks/Ct_8C1sG.js";import{e as ae}from"../chunks/fBFoglH1.js";import{c as ve}from"../chunks/DD00unQA.js";import{L as Ce}from"../chunks/gSlSYwUW.js";import{s as Ke}from"../chunks/DJRwFUr5.js";import{g as R}from"../chunks/DgtYXTMU.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ze=je,Ne=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ee():s==="fr"?je():Ze()},Ve=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ve():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",qe=()=>"Dans le cadre d'un",rn=qe,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?qe():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
