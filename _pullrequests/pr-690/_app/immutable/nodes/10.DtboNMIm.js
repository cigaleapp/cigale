import"../chunks/DsnmJJEf.js";import{an as Be,u as fe,aw as ye,a6 as i,av as we,b as g,c as w,n as Fe,ap as n,au as f,a as o,ao as Te,aq as a,d as He,as as P,r as e,at as L,ar as Ke,bg as Le}from"../chunks/Bb5GQOzu.js";import{s as t}from"../chunks/DHm4hF0_.js";import{a as Me}from"../chunks/D1CsqKRT.js";import{i as A}from"../chunks/Ct_8C1sG.js";import{e as ae}from"../chunks/fBFoglH1.js";import{c as ve}from"../chunks/DD00unQA.js";import{L as Re}from"../chunks/gSlSYwUW.js";import{s as Ce}from"../chunks/DJRwFUr5.js";import{g as M}from"../chunks/DgtYXTMU.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ne=je,Ze=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ee():s==="fr"?je():Ne()},Ve=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ve():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??M();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??M();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
  ...
  "packages": {
    ...
    "@iconify/utils": ["@iconify/utils@3.0.1", "", { "dependencies": { "@antfu/install-pkg": "^1.1.0", "@antfu/utils": "^9.2.0", "@iconify/types": "^2.0.0", "debug": "^4.4.1", "globals": "^15.15.0", "kolorist": "^1.8.0", "local-pkg": "^1.1.1", "mlly": "^1.7.4" } }, "sha512-A78CUEnFGX8I/WlILxJCuIJXloL0j/OJ9PSchPAfCargEIKmUBWvvEMmKWB5oONwiUqlNt+5eRufdkLxeHIWYw=="],

    "@inlang/paraglide-js": ["@inlang/paraglide-js@2.3.2", "", { "dependencies": { "@inlang/recommend-sherlock": "0.2.1", "@inlang/sdk": "2.4.9", "commander": "11.1.0", "consola": "3.4.0", "json5": "2.2.3", "unplugin": "^2.1.2", "urlpattern-polyfill": "^10.0.0" }, "bin": { "paraglide-js": "bin/run.js" } }, "sha512-mF7ku1AaXQxa6fnbBczXiEAM7lxhYzaAH7FnDVvAbpzNtgRJESi11KN0bzpCH0YhsKLdimFrQlzjaSVlo9Uh+Q=="],
    ...
    "@oxc-resolver/binding-android-arm-eabi": ["@oxc-resolver/binding-android-arm-eabi@11.8.2", "", { "os": "android", "cpu": "arm" }, "sha512-7hykBf8S24IRbO4ueulT9SfYQjTeSOOimKc/CQrWXIWQy1WTePXSNcPq2RkVHO7DdLM8p8X4DVPYy+850Bo93g=="],

    "@oxc-resolver/binding-android-arm64": ["@oxc-resolver/binding-android-arm64@11.8.2", "", { "os": "android", "cpu": "arm64" }, "sha512-y41bxENMjlFuLSLCPWd4A+1PR7T5rU9+e7+4alje3sHgrpRmS3hIU+b1Cvck4qmcUgd0I98NmYxRM65kXGEObQ=="],

    "@oxc-resolver/binding-darwin-arm64": ["@oxc-resolver/binding-darwin-arm64@11.8.2", "", { "os": "darwin", "cpu": "arm64" }, "sha512-P/Zobk9OwQAblAMeiVyOtuX2LjGN8oq5HonvN3mp9S6Kx1GKxREbf5qW+g24Rvhf5WS7et+EmopUGRHSdAItGQ=="],

    "@oxc-resolver/binding-darwin-x64": ["@oxc-resolver/binding-darwin-x64@11.8.2", "", { "os": "darwin", "cpu": "x64" }, "sha512-EMAQoO9uTiz2H0z71bVzTL77eoBAlN5+KD7HUc9ayYJ5TprU+Oeaml4y4fmsFyspSPN/vGJzEvOWl5GR0adwtw=="],

    "@oxc-resolver/binding-freebsd-x64": ["@oxc-resolver/binding-freebsd-x64@11.8.2", "", { "os": "freebsd", "cpu": "x64" }, "sha512-Fzeupf4tH9woMm6O/pirEtuzO5docwTrs747Nxqh33OSkz7GbrevyDpx1Q1pc2l3JA2BlDX4zm18tW5ys65bjA=="],

    "@oxc-resolver/binding-linux-arm-gnueabihf": ["@oxc-resolver/binding-linux-arm-gnueabihf@11.8.2", "", { "os": "linux", "cpu": "arm" }, "sha512-r9IiPTwc5STC2JahU/rfkbO2BE14MqAVmFbtF7uW7KFaZX/lUnFltkQ5jpwAgKqcef5aIZTJI95qJ03XZw08Rg=="],

    "@oxc-resolver/binding-linux-arm-musleabihf": ["@oxc-resolver/binding-linux-arm-musleabihf@11.8.2", "", { "os": "linux", "cpu": "arm" }, "sha512-Q5D8FbxOyQYcWn5s9yv+DyFvcMSUXE87hmL9WG6ICdNZiMUA8DmIbzK1xEnOtDjorEFU44bwH3I9SnqL1kyOsg=="],

    "@oxc-resolver/binding-linux-arm64-gnu": ["@oxc-resolver/binding-linux-arm64-gnu@11.8.2", "", { "os": "linux", "cpu": "arm64" }, "sha512-8g2Y72gavZ8fesZD22cKo0Z8g8epynwShu7M+wpAoOq432IGUyUxPUKB2/nvyogPToaAlb1OsRiX/za8W4h8Aw=="],

    "@oxc-resolver/binding-linux-arm64-musl": ["@oxc-resolver/binding-linux-arm64-musl@11.8.2", "", { "os": "linux", "cpu": "arm64" }, "sha512-N3BPWnIDRmHn/xPDZGKnzFwWxwH1hvs3aVnw4jvMAYarPNDZfbAY+fjHSIwkypV+ozMoJ5lK5PzRO5BOtEx2oQ=="],

    "@oxc-resolver/binding-linux-ppc64-gnu": ["@oxc-resolver/binding-linux-ppc64-gnu@11.8.2", "", { "os": "linux", "cpu": "ppc64" }, "sha512-AXW2AyjENmzNuZD3Z2TO1QWoZzfULWR1otDzw/+MAVMRXBy3W50XxDqNAflRiLB4o0aI0oDTwMfeyuhVv9Ur8Q=="],

    "@oxc-resolver/binding-linux-riscv64-gnu": ["@oxc-resolver/binding-linux-riscv64-gnu@11.8.2", "", { "os": "linux", "cpu": "none" }, "sha512-oX+qxJdqOfrJUkGWmcNpu7wiFs6E7KH6hqUORkMAgl4yW+LZxPTz5P4DHvTqTFMywbs9hXVu2KQrdD8ROrdhMQ=="],

    "@oxc-resolver/binding-linux-riscv64-musl": ["@oxc-resolver/binding-linux-riscv64-musl@11.8.2", "", { "os": "linux", "cpu": "none" }, "sha512-TG7LpxXjqlpD1aWnAXw6vMgY74KNV92exPixzEj4AKm4LdGsfnSWYTTJcTQ7deFMYxvBGrZ+qEy8DjGx+5w9GQ=="],

    "@oxc-resolver/binding-linux-s390x-gnu": ["@oxc-resolver/binding-linux-s390x-gnu@11.8.2", "", { "os": "linux", "cpu": "s390x" }, "sha512-1PpXMq0KMD3CQPn3v/UqU4NM2JFjry+mLIH1d3iNVL2vlwRt9lxRfpXTiyiFJrtroUIyeKhw0QbHbF2UfnZVKQ=="],

    "@oxc-resolver/binding-linux-x64-gnu": ["@oxc-resolver/binding-linux-x64-gnu@11.8.2", "", { "os": "linux", "cpu": "x64" }, "sha512-V1iYhEDbjQzj+o7JgTYVllRgNZ56Tjw0rPBWw03KJQ8Nphy00Vf7AySf22vV0K/93V1lPCgOSbI5/iunRnIfAw=="],

    "@oxc-resolver/binding-linux-x64-musl": ["@oxc-resolver/binding-linux-x64-musl@11.8.2", "", { "os": "linux", "cpu": "x64" }, "sha512-2hYNXEZSUM7qLEk4uuY3GmMqLU+860v+8PzbloVvRRjTWtHsLZyB5w+5p2gel38eaTcSYfZ2zvp3xcSpKDAbaw=="],

    "@oxc-resolver/binding-wasm32-wasi": ["@oxc-resolver/binding-wasm32-wasi@11.8.2", "", { "dependencies": { "@napi-rs/wasm-runtime": "^1.0.5" }, "cpu": "none" }, "sha512-TjFqB+1siSqhd+S64Hf2qbxqWqtFIlld4DDEVotxOjj5//rX/6uwAL1HWnUHSNIni+wpcyQoXPhO3fBgppCvuA=="],

    "@oxc-resolver/binding-win32-arm64-msvc": ["@oxc-resolver/binding-win32-arm64-msvc@11.8.2", "", { "os": "win32", "cpu": "arm64" }, "sha512-fs0X6RcAC/khWbXIhPaYQjFHkrFVUtC2IOw1QEx2unRoe6M11tlYbY9NHr3VFBC3nwVpodX+b14A7jGMkAQK8A=="],

    "@oxc-resolver/binding-win32-ia32-msvc": ["@oxc-resolver/binding-win32-ia32-msvc@11.8.2", "", { "os": "win32", "cpu": "ia32" }, "sha512-7oEl1ThswVePprRQFc3tzW9IZgVi5xaus/KP3k56eKi2tYpAM0hBvehD8WBsmpgBEb7pe2pI08h9OZveAddt3Q=="],

    "@oxc-resolver/binding-win32-x64-msvc": ["@oxc-resolver/binding-win32-x64-msvc@11.8.2", "", { "os": "win32", "cpu": "x64" }, "sha512-MngRjE/gpQpg3QcnWRqxX5Nbr/vZJSG7oxhXeHUeOhdFgg+0xCuGpDtwqFmGGVKnd6FQg0gKVo1MqDAERLkEPA=="],
    ...
    "eslint-plugin-oxlint": ["eslint-plugin-oxlint@1.16.0", "", { "dependencies": { "jsonc-parser": "^3.3.1" } }, "sha512-OwxJcCOt2S2xMA8LvbAbPjgi5IyIBpK8znvKYlhSWz3R0BWgKVhNcYIDEndAxvDcfob4WPahrq+53TUeJqqeFg=="],
    ...
    "googleapis": ["googleapis@160.0.0", "", { "dependencies": { "google-auth-library": "^10.2.0", "googleapis-common": "^8.0.0" } }, "sha512-lAGFQVSeYvWKCxeCQKo20xWFFDgnWuJYbLn92IgLrT4UTYVOGdrZ9XTqgWJf316isE9KdfuDY5X8Tu4ZrXSFig=="],
    ...
    "knip": ["knip@5.64.0", "", { "dependencies": { "@nodelib/fs.walk": "^1.2.3", "fast-glob": "^3.3.3", "formatly": "^0.3.0", "jiti": "^2.5.1", "js-yaml": "^4.1.0", "minimist": "^1.2.8", "oxc-resolver": "^11.8.2", "picocolors": "^1.1.1", "picomatch": "^4.0.1", "smol-toml": "^1.4.1", "strip-json-comments": "5.0.2", "zod": "^3.25.0", "zod-validation-error": "^3.0.3" }, "peerDependencies": { "@types/node": ">=18", "typescript": ">=5.0.4" }, "bin": { "knip": "bin/knip.js", "knip-bun": "bin/knip-bun.js" } }, "sha512-UqDlVXXacGy5YL+PXKrolqRpC7DkGTYs+to67KmWBHIUrTh8SX9gQoGNdFsNZtbj4pCdM/RmC/Rbze555+MhSA=="],
    ...
    "oxc-resolver": ["oxc-resolver@11.8.2", "", { "dependencies": { "napi-postinstall": "^0.3.0" }, "optionalDependencies": { "@oxc-resolver/binding-android-arm-eabi": "11.8.2", "@oxc-resolver/binding-android-arm64": "11.8.2", "@oxc-resolver/binding-darwin-arm64": "11.8.2", "@oxc-resolver/binding-darwin-x64": "11.8.2", "@oxc-resolver/binding-freebsd-x64": "11.8.2", "@oxc-resolver/binding-linux-arm-gnueabihf": "11.8.2", "@oxc-resolver/binding-linux-arm-musleabihf": "11.8.2", "@oxc-resolver/binding-linux-arm64-gnu": "11.8.2", "@oxc-resolver/binding-linux-arm64-musl": "11.8.2", "@oxc-resolver/binding-linux-ppc64-gnu": "11.8.2", "@oxc-resolver/binding-linux-riscv64-gnu": "11.8.2", "@oxc-resolver/binding-linux-riscv64-musl": "11.8.2", "@oxc-resolver/binding-linux-s390x-gnu": "11.8.2", "@oxc-resolver/binding-linux-x64-gnu": "11.8.2", "@oxc-resolver/binding-linux-x64-musl": "11.8.2", "@oxc-resolver/binding-wasm32-wasi": "11.8.2", "@oxc-resolver/binding-win32-arm64-msvc": "11.8.2", "@oxc-resolver/binding-win32-ia32-msvc": "11.8.2", "@oxc-resolver/binding-win32-x64-msvc": "11.8.2" } }, "sha512-SM31gnF1l4T8YA7dkAcBhA+jc336bc8scy0Tetz6ndzGmV6c0R99SRnx6In0V5ffwvn1Isjo9I9EGSLF4xi3TA=="],
    ...
    "runed": ["runed@0.32.0", "", { "dependencies": { "dequal": "^2.0.3", "esm-env": "^1.0.0", "lz-string": "^1.5.0" }, "peerDependencies": { "@sveltejs/kit": "^2.21.0", "svelte": "^5.7.0" }, "optionalPeers": ["@sveltejs/kit"] }, "sha512-rV6pFQUk3LjyPbY6x1o07qUly7XpiI1qsIf38/sA5f1yWrOn9s8cnC1ytSkOq053uWyihCkCuMmXX8B4hF9OOA=="],
    ...
    "@malept/electron-installer-flatpak/yargs": ["yargs@16.2.0", "", { "dependencies": { "cliui": "^7.0.2", "escalade": "^3.1.1", "get-caller-file": "^2.0.5", "require-directory": "^2.1.1", "string-width": "^4.2.0", "y18n": "^5.0.5", "yargs-parser": "^20.2.2" } }, "sha512-D1mvvtDG0L5ft/jGWkLpG1+m0eQxOfaBvTNELraWj22wSVUMWxZUvYgJYcKh6jGGIkJFhH4IZPQhR4TKpc8mBw=="],
    ...
    "lint-staged/commander": ["commander@14.0.1", "", {}, "sha512-2JkV3gUZUVrbNA+1sjBOYLsMZ5cEEl8GTFP2a4AVz5hvasAMCQ1D2l2le/cX+pV4N6ZU17zjUahLpIXRrnWL8A=="],

    "lint-staged/listr2": ["listr2@9.0.4", "", { "dependencies": { "cli-truncate": "^5.0.0", "colorette": "^2.0.20", "eventemitter3": "^5.0.1", "log-update": "^6.1.0", "rfdc": "^1.4.1", "wrap-ansi": "^9.0.0" } }, "sha512-1wd/kpAdKRLwv7/3OKC8zZ5U8e/fajCfWMxacUvB79S5nLrYGPtUI/8chMQhn3LQjsRVErTb9i1ECAwW0ZIHnQ=="],
    ...
    "@malept/electron-installer-flatpak/yargs/cliui": ["cliui@7.0.4", "", { "dependencies": { "string-width": "^4.2.0", "strip-ansi": "^6.0.0", "wrap-ansi": "^7.0.0" } }, "sha512-OcRE68cOsVMXp1Yvonl/fzkQOyjLSu/8bhPDfQt0e0/Eb283TKP20Fs2MqoPsr9SwA595rRCA+QMzYc9nBP+JQ=="],

    "@malept/electron-installer-flatpak/yargs/y18n": ["y18n@5.0.8", "", {}, "sha512-0pfFzegeDWJHJIAmTLRP2DwHjdF5s7jo9tuztdQxAhINCdvS+3nGINqPd00AphqJR/0LhANUS6/+7SCb98YOfA=="],

    "@malept/electron-installer-flatpak/yargs/yargs-parser": ["yargs-parser@20.2.9", "", {}, "sha512-y11nGElTIV+CT3Zv9t7VKl+Q3hTQoT9a1Qzezhhl6Rp21gJ/IVTW7Z3y9EWXhuUBC2Shnf+DX0antecpAwSP8w=="],
    ...
    "lint-staged/listr2/cli-truncate": ["cli-truncate@5.1.0", "", { "dependencies": { "slice-ansi": "^7.1.0", "string-width": "^8.0.0" } }, "sha512-7JDGG+4Zp0CsknDCedl0DYdaeOhc46QNpXi3NLQblkZpXXgA6LncLDUUyvrjSvZeF3VRQa+KiMGomazQrC1V8g=="],
    ...
    "@malept/electron-installer-flatpak/yargs/cliui/wrap-ansi": ["wrap-ansi@7.0.0", "", { "dependencies": { "ansi-styles": "^4.0.0", "string-width": "^4.1.0", "strip-ansi": "^6.0.0" } }, "sha512-YVGIj2kamLSTxw6NsZjoBxfSwsn0ycdesmc4p+Q21c5zPuZ1pl+NfxVdxPtdHvmNVOQ6XSYG4AUtyt/Fi7D16Q=="],
    ...
    "lint-staged/listr2/cli-truncate/slice-ansi": ["slice-ansi@7.1.2", "", { "dependencies": { "ansi-styles": "^6.2.1", "is-fullwidth-code-point": "^5.0.0" } }, "sha512-iOBWFgUX7caIZiuutICxVgX1SdxwAVFFKwt1EvMYYec/NWO5meOJ6K5uQxhrYBdQJne4KxiqZc+KptFOWFSI9w=="],

    "lint-staged/listr2/cli-truncate/string-width": ["string-width@8.1.0", "", { "dependencies": { "get-east-asian-width": "^1.3.0", "strip-ansi": "^7.1.0" } }, "sha512-Kxl3KJGb/gxkaUMOjRsQ8IrXiGW75O4E3RPjFIINOVH8AMl2SQ/yWdTzWwF3FevIX9LcMAjJW+GRwAlAbTSXdg=="],

    "lint-staged/listr2/log-update/ansi-escapes": ["ansi-escapes@7.1.0", "", { "dependencies": { "environment": "^1.0.0" } }, "sha512-YdhtCd19sKRKfAAUsrcC1wzm4JuzJoiX4pOJqIoW2qmKj5WzG/dL8uUJ0361zaXtHqK7gEhOwtAtz7t3Yq3X5g=="],
    ...
    "lint-staged/listr2/cli-truncate/slice-ansi/ansi-styles": ["ansi-styles@6.2.3", "", {}, "sha512-4Dj6M28JB+oAH8kFkTLUo+a2jwOFkuqb3yucU0CANcRRUbxS0cP0nZYCGjcc3BNXwRIsUVmDGgzawme7zvJHvg=="],

    "lint-staged/listr2/cli-truncate/slice-ansi/is-fullwidth-code-point": ["is-fullwidth-code-point@5.1.0", "", { "dependencies": { "get-east-asian-width": "^1.3.1" } }, "sha512-5XHYaSyiqADb4RnZ1Bdad6cPp8Toise4TzEjcOYDHZkTCbKgiUl7WTUCpNWHuxmDt91wnsZBc9xinNzopv3JMQ=="],
    ...
    "lint-staged/listr2/wrap-ansi/string-width/emoji-regex": ["emoji-regex@10.5.0", "", {}, "sha512-lb49vf1Xzfx080OKA0o6l8DQQpV+6Vg95zyCJX9VB/BqKYlhG7N4wgROUUHRA+ZPUefLnteQOad7z1kT2bV7bg=="],
...
`,xe=(u,d=Fe)=>{var s=He(),j=w(s);ae(j,19,()=>d().sort(()=>Math.random()-.5),({url:q,name:k})=>q||k,(q,k,R)=>{let X=()=>i(k).url,Q=()=>i(k).name;var J=hn(),D=w(J);{var I=p=>{var m=L(",");o(p,m)};A(D,p=>{i(R)>0&&p(I)})}var C=a(D,2);{var z=p=>{var m=dn(),W=n(m,!0);e(m),f(()=>{ve(m,"href",X()),t(W,Q())}),o(p,m)},E=p=>{var m=L();f(()=>t(m,Q())),o(p,m)};A(C,p=>{X()?p(z):p(E,!1)})}o(q,J)}),o(u,s)};var dn=g('<a target="_blank"> </a>'),hn=g("<!> <!>",1),un=g('<dd class="svelte-6yh93n"><code> </code></dd>'),mn=g("<!> <code> </code>",1),gn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt>Service workers</dt> <dd class="svelte-6yh93n"></dd>',1),bn=g('<dt>Versions</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Node.js</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Chrome</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Electron</dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),fn=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code> </code></dd>',1),yn=g('<dl class="svelte-6yh93n"></dl>'),wn=g("<p>Impossible de charger les dépendances</p> <p> </p>",1),xn=g("<p>Chargement des dépendances…</p>"),vn=g(`<header class="svelte-6yh93n"><!> <div class="text"><h1>C.i.g.a.l.e.</h1> <p class="subtitle svelte-6yh93n">Classification Intelligente et Gestion des Arthropodes et de L'Entomofaune</p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n">“Projet long” de l'<a href="https://enseeiht.fr">INP-ENSEEIHT</a></dd> <!> <dt>Parallélisme</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Task queue</dt> <dd class="svelte-6yh93n"><code> </code> max.</dd> <dt>sw&rpc</dt> <dd class="svelte-6yh93n"><code> </code> nodes</dd> <dt>Hardware</dt> <dd class="svelte-6yh93n"><code></code> threads</dd></dl></dd> <dt>Code source</dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale">github.com/cigaleapp/cigale</a></dd> <dt>Avec les données</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Aides à l'identification</dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification">Les carnets nature de Jessica</a></dd> <dt>Arbre taxonomique</dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames">API de GBIF</a></dd></dl></dd> <dt>Avec les modèles</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Détection & recadrage</dt> <dd class="svelte-6yh93n">YOLO 11n</dd> <dt>Classification</dt> <dd class="svelte-6yh93n">ResNet50</dd></dl></dd> <dt>Fontes</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/">Host Grotesk</a></dt> <dd class="svelte-6yh93n">par <a href="https://doughkan.com/">Doğukan Karapınar</a> et <a href="https://ibrahimkactioglu.com/">İbrahim Kaçtıoğlu</a>, chez <a href="https://elementtype.co/">Element Type Foundry</a></dd> <dt><a href="https://github.com/weiweihuanghuang/fragment-mono/"><code>Fragment Mono</code></a></dt> <dd class="svelte-6yh93n"><code>par <a href="https://weiweihuanghuang.github.io/">Wei Huang</a>, chez <a href="https://studiolin.org/projects/374-2/">Studio Lin</a></code></dd></dl></dd> <dt>Icônes</dt> <dd class="svelte-6yh93n"><a href="https://phosphoricons.com/">Phosphor Icons</a> par <a href="https://helenazhang.com">Helena Zhang</a> et <a href="https://tobiasfried.com">Tobias Fried</a></dd> <dt>Grâce aux bibliothèques</dt> <dd class="svelte-6yh93n"><!></dd></dl>`,1);function Un(u,d){Be(d,!0),Ce({title:$e()});let s=we(void 0);fe(()=>{window.versions&&(ye(s,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(r=>{i(s)&&(i(s).os=r,i(s).sw=r.serviceWorkers)}))});let j=we(0);fe(()=>{const r=setInterval(()=>{ye(j,Math.max(1,i(j)+.03),!0)},10);return()=>{i(j)>=1&&clearInterval(r)}});const q=[{name:"Achraf Khairoun",gitlab:"khairoa"},{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:r,gitlab:l,url:c})=>({name:r,url:c??`https://git.inpt.fr/${l}`})),k=[{name:"Axel C.",url:""},{name:"Maxime C.",url:""},{name:"Rémy E.",url:""},{name:"Thomas F.",url:""}];async function R(){const{workspaces:r,packages:l}=ln.parse(cn);return[...Object.keys(r[""].dependencies),...Object.keys(r[""].devDependencies)].map(h=>[h,l[h][0].replace(`${h}@`,"")])}var X=vn(),Q=w(X),J=n(Q);Re(J,{get drawpercent(){return i(j)}}),P(2),e(Q);var D=a(Q,2),I=n(D),C=n(I,!0);e(I);var z=a(I,2),E=n(z);xe(E,()=>q),e(z);var p=a(z,2),m=n(p,!0);e(p);var W=a(p,2),qe=n(W);xe(qe,()=>k),e(W);var N=a(W,2),Xe=n(N,!0);e(N);var re=a(N,4);{var De=r=>{var l=bn(),c=a(w(l),2),h=n(c),y=a(n(h),2),U=n(y),S=n(U,!0);e(U),e(y);var G=a(y,4),Y=n(G),O=n(Y,!0);e(Y),e(G);var x=a(G,4),B=n(x),F=n(B,!0);e(B),e(x);var T=a(x,2);{var $=ee=>{var de=gn(),ne=w(de),Ge=n(ne,!0);e(ne);var se=a(ne,2),he=n(se),Ye=n(he,!0);e(he),e(se);var ue=a(se,2);{var Oe=b=>{var v=un(),H=n(v),K=n(H,!0);e(H),e(v),f(()=>t(K,i(s).os.architecture)),o(b,v)};A(ue,b=>{i(s).os.archIsUnusual&&b(Oe)})}var me=a(ue,4);ae(me,22,()=>i(s).sw,b=>b,(b,v,H)=>{var K=mn(),ge=w(K);{var Pe=ie=>{var Se=L(",");o(ie,Se)};A(ge,ie=>{i(H)>0&&ie(Pe)})}var be=a(ge,2),Je=n(be,!0);e(be),f(()=>t(Je,v)),o(b,K)},b=>{P();var v=L("(none)");o(b,v)}),e(me),f(()=>{t(Ge,i(s).os.name),t(Ye,i(s).os.version)}),o(ee,de)};A(T,ee=>{"os"in i(s)&&ee($)})}e(h),e(c),f(()=>{t(S,i(s).node),t(O,i(s).chrome),t(F,i(s).electron)}),o(r,l)};A(re,r=>{i(s)&&r(De)})}var Z=a(re,4),te=n(Z),V=a(n(te),2),oe=n(V),Ie=n(oe,!0);e(oe),P(),e(V);var _=a(V,4),pe=n(_),ze=n(pe,!0);e(pe),P(),e(_);var le=a(_,4),We=n(le);We.textContent=navigator.hardwareConcurrency,P(),e(le),e(te),e(Z);var ce=a(Z,24),Ue=n(ce);Me(Ue,R,r=>{var l=xn();o(r,l)},(r,l)=>{var c=yn();ae(c,21,()=>i(l),([h,y])=>h,(h,y)=>{var U=Ke(()=>Le(i(y),2));let S=()=>i(U)[0],G=()=>i(U)[1];var Y=fn(),O=w(Y),x=n(O),B=n(x,!0);e(x),e(O);var F=a(O,2),T=n(F),$=n(T,!0);e(T),e(F),f(()=>{ve(x,"href",`https://npmjs.com/package/${S()??""}`),t(B,S()),t($,G())}),o(h,Y)}),e(c),o(r,c)},(r,l)=>{var c=wn(),h=a(w(c),2),y=n(h,!0);e(h),f(()=>t(y,i(l))),o(r,c)}),e(ce),e(D),f((r,l,c)=>{t(C,r),t(m,l),t(Xe,c),t(Ie,d.data.parallelism),t(ze,d.data.parallelism)},[()=>Ze(),()=>sn(),()=>tn()]),o(u,X),Te()}export{Un as component};
