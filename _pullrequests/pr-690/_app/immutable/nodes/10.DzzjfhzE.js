import"../chunks/DsnmJJEf.js";import{ao as Je,u as fe,au as ye,a6 as i,at as xe,b as g,c as x,n as Ge,an as n,ap as f,a as o,aq as Ke,ar as a,d as Le,av as P,r as e,aK as H,as as Te,bg as He}from"../chunks/Bi1W6lpD.js";import{s as t}from"../chunks/DGY6JwHd.js";import{a as Re}from"../chunks/CZiWqn5q.js";import{i as A}from"../chunks/7ESRx852.js";import{e as ae}from"../chunks/DR_UNFlg.js";import{c as ve}from"../chunks/Cuwi7Ow6.js";import{L as Me}from"../chunks/BY7-GQ35.js";import{s as Ce}from"../chunks/Bi6yO-AK.js";import{g as R}from"../chunks/B0nJzvm_.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ve=je,Ne=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ee():s==="fr"?je():Ve()},Ze=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??R();return s==="en"?Ze():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??R();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??R();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
  ...
  "packages": {
    ...
    "electron": ["electron@38.2.0", "", { "dependencies": { "@electron/get": "^2.0.0", "@types/node": "^22.7.7", "extract-zip": "^2.0.1" }, "bin": { "electron": "cli.js" } }, "sha512-Cw5Mb+N5NxsG0Hc1qr8I65Kt5APRrbgTtEEn3zTod30UNJRnAE1xbGk/1NOaDn3ODzI/MYn6BzT9T9zreP7xWA=="],
    ...
    "google-auth-library": ["google-auth-library@10.3.1", "", { "dependencies": { "base64-js": "^1.3.0", "ecdsa-sig-formatter": "^1.0.11", "gaxios": "^7.0.0", "gcp-metadata": "^7.0.0", "google-logging-utils": "^1.0.0", "gtoken": "^8.0.0", "jws": "^4.0.0" } }, "sha512-w6bmyfvB7Fezdb70admbJlDYY8MdzRZPssCYO1M/zrIx2HWNhsycIoFf/tZ8qdWSg5l4BUTAt2ax8Pv/R6NnSw=="],
    ...
    "googleapis/google-auth-library": ["google-auth-library@10.3.0", "", { "dependencies": { "base64-js": "^1.3.0", "ecdsa-sig-formatter": "^1.0.11", "gaxios": "^7.0.0", "gcp-metadata": "^7.0.0", "google-logging-utils": "^1.0.0", "gtoken": "^8.0.0", "jws": "^4.0.0" } }, "sha512-ylSE3RlCRZfZB56PFJSfUCuiuPq83Fx8hqu1KPWGK8FVdSaxlp/qkeMMX/DT/18xkwXIHvXEXkZsljRwfrdEfQ=="],
    ...
    "knip/jiti": ["jiti@2.6.0", "", { "bin": { "jiti": "lib/jiti-cli.mjs" } }, "sha512-VXe6RjJkBPj0ohtqaO8vSWP3ZhAKo66fKrFNCll4BTcwljPLz03pCbaNKfzGP5MbrCYcbJ7v0nOYYwUzTEIdXQ=="],
...
`,we=(u,d=Ge)=>{var s=Le(),j=x(s);ae(j,19,()=>d().sort(()=>Math.random()-.5),({url:q,name:k})=>q||k,(q,k,M)=>{let X=()=>i(k).url,Q=()=>i(k).name;var O=hn(),z=x(O);{var D=p=>{var m=H(",");o(p,m)};A(z,p=>{i(M)>0&&p(D)})}var C=a(z,2);{var I=p=>{var m=dn(),W=n(m,!0);e(m),f(()=>{ve(m,"href",X()),t(W,Q())}),o(p,m)},E=p=>{var m=H();f(()=>t(m,Q())),o(p,m)};A(C,p=>{X()?p(I):p(E,!1)})}o(q,O)}),o(u,s)};var dn=g('<a target="_blank"> </a>'),hn=g("<!> <!>",1),un=g('<dd class="svelte-6yh93n"><code> </code></dd>'),mn=g("<!> <code> </code>",1),gn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt>Service workers</dt> <dd class="svelte-6yh93n"></dd>',1),bn=g('<dt>Versions</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Node.js</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Chrome</dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt>Electron</dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),fn=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code> </code></dd>',1),yn=g('<dl class="svelte-6yh93n"></dl>'),xn=g("<p>Impossible de charger les dépendances</p> <p> </p>",1),wn=g("<p>Chargement des dépendances…</p>"),vn=g(`<header class="svelte-6yh93n"><!> <div class="text"><h1>C.i.g.a.l.e.</h1> <p class="subtitle svelte-6yh93n">Classification Intelligente et Gestion des Arthropodes et de L'Entomofaune</p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n">“Projet long” de l'<a href="https://enseeiht.fr">INP-ENSEEIHT</a></dd> <!> <dt>Parallélisme</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Task queue</dt> <dd class="svelte-6yh93n"><code> </code> max.</dd> <dt>sw&rpc</dt> <dd class="svelte-6yh93n"><code> </code> nodes</dd> <dt>Hardware</dt> <dd class="svelte-6yh93n"><code></code> threads</dd></dl></dd> <dt>Code source</dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale">github.com/cigaleapp/cigale</a></dd> <dt>Avec les données</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Aides à l'identification</dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification">Les carnets nature de Jessica</a></dd> <dt>Arbre taxonomique</dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames">API de GBIF</a></dd></dl></dd> <dt>Avec les modèles</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt>Détection & recadrage</dt> <dd class="svelte-6yh93n">YOLO 11n</dd> <dt>Classification</dt> <dd class="svelte-6yh93n">ResNet50</dd></dl></dd> <dt>Fontes</dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/">Host Grotesk</a></dt> <dd class="svelte-6yh93n">par <a href="https://doughkan.com/">Doğukan Karapınar</a> et <a href="https://ibrahimkactioglu.com/">İbrahim Kaçtıoğlu</a>, chez <a href="https://elementtype.co/">Element Type Foundry</a></dd> <dt><a href="https://github.com/weiweihuanghuang/fragment-mono/"><code>Fragment Mono</code></a></dt> <dd class="svelte-6yh93n"><code>par <a href="https://weiweihuanghuang.github.io/">Wei Huang</a>, chez <a href="https://studiolin.org/projects/374-2/">Studio Lin</a></code></dd></dl></dd> <dt>Icônes</dt> <dd class="svelte-6yh93n"><a href="https://phosphoricons.com/">Phosphor Icons</a> par <a href="https://helenazhang.com">Helena Zhang</a> et <a href="https://tobiasfried.com">Tobias Fried</a></dd> <dt>Grâce aux bibliothèques</dt> <dd class="svelte-6yh93n"><!></dd></dl>`,1);function Sn(u,d){Je(d,!0),Ce({title:$e()});let s=xe(void 0);fe(()=>{window.versions&&(ye(s,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(r=>{i(s)&&(i(s).os=r,i(s).sw=r.serviceWorkers)}))});let j=xe(0);fe(()=>{const r=setInterval(()=>{ye(j,Math.max(1,i(j)+.03),!0)},10);return()=>{i(j)>=1&&clearInterval(r)}});const q=[{name:"Achraf Khairoun",gitlab:"khairoa"},{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:r,gitlab:l,url:c})=>({name:r,url:c??`https://git.inpt.fr/${l}`})),k=[{name:"Axel C.",url:""},{name:"Maxime C.",url:""},{name:"Rémy E.",url:""},{name:"Thomas F.",url:""}];async function M(){const{workspaces:r,packages:l}=ln.parse(cn);return[...Object.keys(r[""].dependencies),...Object.keys(r[""].devDependencies)].map(h=>[h,l[h][0].replace(`${h}@`,"")])}var X=vn(),Q=x(X),O=n(Q);Me(O,{get drawpercent(){return i(j)}}),P(2),e(Q);var z=a(Q,2),D=n(z),C=n(D,!0);e(D);var I=a(D,2),E=n(I);we(E,()=>q),e(I);var p=a(I,2),m=n(p,!0);e(p);var W=a(p,2),qe=n(W);we(qe,()=>k),e(W);var V=a(W,2),Xe=n(V,!0);e(V);var re=a(V,4);{var ze=r=>{var l=bn(),c=a(x(l),2),h=n(c),y=a(n(h),2),S=n(y),B=n(S,!0);e(S),e(y);var U=a(y,4),Y=n(U),F=n(Y,!0);e(Y),e(U);var w=a(U,4),J=n(w),G=n(J,!0);e(J),e(w);var K=a(w,2);{var $=ee=>{var de=gn(),ne=x(de),Ue=n(ne,!0);e(ne);var se=a(ne,2),he=n(se),Ye=n(he,!0);e(he),e(se);var ue=a(se,2);{var Fe=b=>{var v=un(),L=n(v),T=n(L,!0);e(L),e(v),f(()=>t(T,i(s).os.architecture)),o(b,v)};A(ue,b=>{i(s).os.archIsUnusual&&b(Fe)})}var me=a(ue,4);ae(me,22,()=>i(s).sw,b=>b,(b,v,L)=>{var T=mn(),ge=x(T);{var Pe=ie=>{var Be=H(",");o(ie,Be)};A(ge,ie=>{i(L)>0&&ie(Pe)})}var be=a(ge,2),Oe=n(be,!0);e(be),f(()=>t(Oe,v)),o(b,T)},b=>{P();var v=H("(none)");o(b,v)}),e(me),f(()=>{t(Ue,i(s).os.name),t(Ye,i(s).os.version)}),o(ee,de)};A(K,ee=>{"os"in i(s)&&ee($)})}e(h),e(c),f(()=>{t(B,i(s).node),t(F,i(s).chrome),t(G,i(s).electron)}),o(r,l)};A(re,r=>{i(s)&&r(ze)})}var N=a(re,4),te=n(N),Z=a(n(te),2),oe=n(Z),De=n(oe,!0);e(oe),P(),e(Z);var _=a(Z,4),pe=n(_),Ie=n(pe,!0);e(pe),P(),e(_);var le=a(_,4),We=n(le);We.textContent=navigator.hardwareConcurrency,P(),e(le),e(te),e(N);var ce=a(N,24),Se=n(ce);Re(Se,M,r=>{var l=wn();o(r,l)},(r,l)=>{var c=yn();ae(c,21,()=>i(l),([h,y])=>h,(h,y)=>{var S=Te(()=>He(i(y),2));let B=()=>i(S)[0],U=()=>i(S)[1];var Y=fn(),F=x(Y),w=n(F),J=n(w,!0);e(w),e(F);var G=a(F,2),K=n(G),$=n(K,!0);e(K),e(G),f(()=>{ve(w,"href",`https://npmjs.com/package/${B()??""}`),t(J,B()),t($,U())}),o(h,Y)}),e(c),o(r,c)},(r,l)=>{var c=xn(),h=a(x(c),2),y=n(h,!0);e(h),f(()=>t(y,i(l))),o(r,c)}),e(ce),e(z),f((r,l,c)=>{t(C,r),t(m,l),t(Xe,c),t(De,d.data.parallelism),t(Ie,d.data.parallelism)},[()=>Ne(),()=>sn(),()=>tn()]),o(u,X),Ke()}export{Sn as component};
