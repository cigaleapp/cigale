import"../chunks/DsnmJJEf.js";import{ao as He,d as ye,ax as fe,g as i,aw as we,h as g,j as w,n as Ie,aq as n,av as y,a as o,ap as Je,ar as a,k as Fe,at as S,l as e,au as M,as as Le,b9 as Me}from"../chunks/pLBs-mSF.js";import{s as t}from"../chunks/Dos-s29q.js";import{a as Ke}from"../chunks/VdNrGBfb.js";import{i as A}from"../chunks/C3Fbln-z.js";import{e as ae}from"../chunks/DbKxOvJB.js";import{c as xe}from"../chunks/DIQ6b9wY.js";import{L as Ee}from"../chunks/e4UGFwRT.js";import{s as Re}from"../chunks/0-DflsyC.js";import{g as K}from"../chunks/DgtYXTMU.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ne=je,Ze=(m={},d={})=>{const s=d.locale??K();return s==="en"?Ce():s==="fr"?je():Ne()},Ve=()=>"About",ke=()=>"À propos",_e=ke,$e=(m={},d={})=>{const s=d.locale??K();return s==="en"?Ve():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(m={},d={})=>{const s=d.locale??K();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(m={},d={})=>{const s=d.locale??K();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:m=>{m=String(m);try{return JSON.parse(m)}catch{return JSON.parse(m.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
