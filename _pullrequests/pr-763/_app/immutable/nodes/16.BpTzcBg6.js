...
`,bn=(Q,T=k)=>{var a=rs(),w=B(a);Re(w,19,()=>T().sort(()=>Math.random()-.5),({url:q,name:P})=>q||P,(q,P,se)=>{let N=()=>e(P).url,G=()=>e(P).name;var J=fs(),R=B(J);{var Z=x=>{var v=ne(",");h(x,v)};O(R,x=>{e(se)>0&&x(Z)})}var H=r(R,2);{var ae=x=>{var v=ws(),L=s(v,!0);n(v),b(()=>{U(v,"href",N()),i(L,G())}),h(x,v)},_=x=>{var v=ne();b(()=>i(v,G())),h(x,v)};O(H,x=>{N()?x(ae):x(_,!1)})}h(q,J)}),h(Q,a)};var ws=g('<a target="_blank"> </a>'),fs=g("<!> <!>",1),ys=g('<a href="https://enseeiht.fr"> </a>'),xs=g('<dd class="svelte-6yh93n"><code> </code></dd>'),vs=g("<!> <code> </code>",1),js=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"></dd>',1),ks=g('<dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),Qs=g("<code> </code>"),qs=g("<code> </code>"),As=g("<code></code>"),Xs=g("<a> </a>"),Ys=g("<a> </a>"),Bs=g("<a> </a>"),Is=g("<a> </a>"),Ds=g("<a> </a>"),zs=g('<a href="https://remixicon.com"> </a>'),Ss=g('<a href="https://www.zhangxiaochun.com/"> </a>'),Us=g('<a href="https://gaoquanquan.com/"> </a>'),Ps=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),Js=g('<dl class="dependencies svelte-6yh93n"></dl>'),Fs=g("<p> </p> <p> </p>",1),Es=g("<p> </p>"),Ks=g('<header class="svelte-6yh93n"><!> <div class="text"><h1> </h1> <p class="subtitle svelte-6yh93n"> </p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames"> </a></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <dt> </dt> <dd class="svelte-6yh93n"> </dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/"> </a></dt> <dd class="svelte-6yh93n"><span><!></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code><!></code></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl>',1);function Ns(Q,T){as(T,!0);const a=f(()=>cs(ls("main")));hs({title:e(a).t(206)});let w=gn(void 0);un(()=>{window.versions&&(mn(w,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(d=>{e(w)&&(e(w).os=d,e(w).sw=d.serviceWorkers)}))});let q=gn(0);un(()=>{const d=setInterval(()=>{mn(q,Math.max(1,e(q)+.03),!0)},10);return()=>{e(q)>=1&&clearInterval(d)}});const P=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:d,gitlab:c,url:t})=>({name:d,url:t??`https://git.inpt.fr/${c}`})),se=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function N(){const{workspaces:d,packages:c}=gs.parse(bs);return[...Object.keys(d[""].dependencies),...Object.keys(d[""].devDependencies)].map(o=>[o,c[o][0].replace(`${o}@`,"")])}var G=Ks(),J=B(G),R=s(J);ds(R,{get drawpercent(){return e(q)}});var Z=r(R,2),H=s(Z),ae=s(H,!0);n(H);var _=r(H,2),x=s(_,!0);n(_),n(Z),n(J);var v=r(J,2),L=s(v),wn=s(L,!0);n(L);var ie=r(L,2),fn=s(ie);bn(fn,()=>P),n(ie);var re=r(ie,2),yn=s(re,!0);n(re);var te=r(re,2),xn=s(te);bn(xn,()=>se),n(te);var oe=r(te,2),vn=s(oe,!0);n(oe);var pe=r(oe,2);{const d=(c,t=k)=>{var o=ys(),l=s(o,!0);n(o),b(p=>i(l,p),[()=>e(a).tx(t())]),h(c,o)};var jn=s(pe);{let c=f(()=>[d]),t=f(()=>e(a).cx(208));S(jn,{get t(){return e(c)},get x(){return e(t)}})}n(pe)}var He=r(pe,2);{var kn=d=>{var c=ks(),t=B(c),o=s(t,!0);n(t);var l=r(t,2),p=s(l),u=s(p),m=s(u,!0);n(u);var y=r(u,2),A=s(y),I=s(A,!0);n(A),n(y);var D=r(y,2),F=s(D,!0);n(D);var X=r(D,2),E=s(X),Pe=s(E,!0);n(E),n(X);var C=r(X,2),Je=s(C,!0);n(C);var M=r(C,2),$=s(M),Fe=s($,!0);n($),n(M);var Ee=r(M,2);{var Ke=z=>{var K=js(),V=B(K),We=s(V,!0);n(V);var Oe=r(V,2),pn=s(Oe),Zn=s(pn,!0);n(pn),n(Oe);var cn=r(Oe,2);{var _n=j=>{var Y=xs(),W=s(Y),ee=s(W,!0);n(W),n(Y),b(()=>i(ee,e(w).os.architecture)),h(j,Y)};O(cn,j=>{e(w).os.archIsUnusual&&j(_n)})}var Te=r(cn,2),$n=s(Te,!0);n(Te);var ln=r(Te,2);Re(ln,22,()=>e(w).sw,j=>j,(j,Y,W)=>{var ee=vs(),dn=B(ee);{var es=Ge=>{var ss=ne(",");h(Ge,ss)};O(dn,Ge=>{e(W)>0&&Ge(es)})}var hn=r(dn,2),ns=s(hn,!0);n(hn),b(()=>i(ns,Y)),h(j,ee)},j=>{os();var Y=ne();b(W=>i(Y,W),[()=>e(a).t(209)]),h(j,Y)}),n(ln),b(j=>{i(We,e(w).os.name),i(Zn,e(w).os.version),i($n,j)},[()=>e(a).t(166)]),h(z,K)};O(Ee,z=>{"os"in e(w)&&z(Ke)})}n(p),n(l),b((z,K,V,We)=>{i(o,z),i(m,K),i(I,e(w).node),i(F,V),i(Pe,e(w).chrome),i(Je,We),i(Fe,e(w).electron)},[()=>e(a).t(191),()=>e(a).t(137),()=>e(a).t(62),()=>e(a).t(84)]),h(d,c)};O(He,d=>{e(w)&&d(kn)})}var ce=r(He,2),Qn=s(ce,!0);n(ce);var le=r(ce,2),Le=s(le),de=s(Le),qn=s(de,!0);n(de);var he=r(de,2);{const d=c=>{var t=Qs(),o=s(t,!0);n(t),b(()=>i(o,T.data.parallelism)),h(c,t)};var An=s(he);{let c=f(()=>[d]),t=f(()=>e(a).cx(19));S(An,{get t(){return e(c)},get x(){return e(t)}})}n(he)}var ue=r(he,2),Xn=s(ue,!0);n(ue);var me=r(ue,2);{const d=c=>{var t=qs(),o=s(t,!0);n(t),b(()=>i(o,T.data.parallelism)),h(c,t)};var Yn=s(me);{let c=f(()=>[d]),t=f(()=>e(a).cx(20));S(Yn,{get t(){return e(c)},get x(){return e(t)}})}n(me)}var ge=r(me,2),Bn=s(ge,!0);n(ge);var Ce=r(ge,2);{const d=c=>{var t=As();t.textContent=navigator.hardwareConcurrency,h(c,t)};var In=s(Ce);{let c=f(()=>[d]),t=f(()=>e(a).cx(22));S(In,{get t(){return e(c)},get x(){return e(t)}})}n(Ce)}n(Le),n(le);var be=r(le,2),Dn=s(be,!0);n(be);var we=r(be,2),Me=s(we),zn=s(Me,!0);n(Me),n(we);var fe=r(we,2),Sn=s(fe,!0);n(fe);var ye=r(fe,2),Ve=s(ye),xe=s(Ve),Un=s(xe,!0);n(xe);var ve=r(xe,2),Ne=s(ve),Pn=s(Ne,!0);n(Ne),n(ve);var je=r(ve,2),Jn=s(je,!0);n(je);var Ze=r(je,2),_e=s(Ze),Fn=s(_e,!0);n(_e),n(Ze),n(Ve),n(ye);var ke=r(ye,2),En=s(ke,!0);n(ke);var Qe=r(ke,2),$e=s(Qe),qe=s($e),Kn=s(qe,!0);n(qe);var Ae=r(qe,2),Wn=s(Ae,!0);n(Ae);var Xe=r(Ae,2),On=s(Xe,!0);n(Xe);var en=r(Xe,2),Tn=s(en,!0);n(en),n($e),n(Qe);var Ye=r(Qe,2),Gn=s(Ye,!0);n(Ye);var Be=r(Ye,2),nn=s(Be),Ie=s(nn),sn=s(Ie),Rn=s(sn,!0);n(sn),n(Ie);var De=r(Ie,2),an=s(De);{const d=(o,l=k)=>{var p=Xs(),u=s(p,!0);n(p),b((m,y)=>{U(p,"href",m),i(u,y)},[()=>e(a).t(222),()=>e(a).tx(l())]),h(o,p)},c=(o,l=k)=>{var p=Ys(),u=s(p,!0);n(p),b((m,y)=>{U(p,"href",m),i(u,y)},[()=>e(a).t(223),()=>e(a).tx(l())]),h(o,p)},t=(o,l=k)=>{var p=Bs(),u=s(p,!0);n(p),b((m,y)=>{U(p,"href",m),i(u,y)},[()=>e(a).t(224),()=>e(a).tx(l())]),h(o,p)};var Hn=s(an);{let o=f(()=>[d,c,t]),l=f(()=>e(a).cx(198));S(Hn,{get t(){return e(o)},get x(){return e(l)}})}n(an)}n(De);var rn=r(De,4),tn=s(rn);{const d=(t,o=k)=>{var l=Is(),p=s(l,!0);n(l),b((u,m)=>{U(l,"href",u),i(p,m)},[()=>e(a).t(219),()=>e(a).tx(o())]),h(t,l)},c=(t,o=k)=>{var l=Ds(),p=s(l,!0);n(l),b((u,m)=>{U(l,"href",u),i(p,m)},[()=>e(a).t(220),()=>e(a).tx(o())]),h(t,l)};var Ln=s(tn);{let t=f(()=>[d,c]),o=f(()=>e(a).cx(221));S(Ln,{get t(){return e(t)},get x(){return e(o)}})}n(tn)}n(rn),n(nn),n(Be);var ze=r(Be,2),Cn=s(ze,!0);n(ze);var Se=r(ze,2);{const d=(o,l=k)=>{var p=zs(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)},c=(o,l=k)=>{var p=Ss(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)},t=(o,l=k)=>{var p=Us(),u=s(p,!0);n(p),b(m=>i(u,m),[()=>e(a).tx(l())]),h(o,p)};var Mn=s(Se);{let o=f(()=>[d,c,t]),l=f(()=>e(a).cx(380));S(Mn,{get t(){return e(o)},get x(){return e(l)}})}n(Se)}var Ue=r(Se,2),Vn=s(Ue,!0);n(Ue);var on=r(Ue,2),Nn=s(on);ps(Nn,N,d=>{var c=Es(),t=s(c,!0);n(c),b(o=>i(t,o),[()=>e(a).t(54)]),h(d,c)},(d,c)=>{var t=Js();Re(t,21,()=>e(c),([o,l])=>o,(o,l)=>{var p=f(()=>ts(e(l),2));let u=()=>e(p)[0],m=()=>e(p)[1];var y=Ps(),A=B(y),I=s(A),D=s(I,!0);n(I),n(A);var F=r(A,2),X=s(F),E=s(X,!0);n(X),n(F),b(()=>{U(I,"href",`https://npmjs.com/package/${u()??""}`),i(D,u()),i(E,m())}),h(o,y)}),n(t),h(d,t)},(d,c)=>{var t=Fs(),o=B(t),l=s(o,!0);n(o);var p=r(o,2),u=s(p,!0);n(p),b(m=>{i(l,m),i(u,e(c))},[()=>e(a).t(115)]),h(d,t)}),n(on),n(v),b((d,c,t,o,l,p,u,m,y,A,I,D,F,X,E,Pe,C,Je,M,$,Fe,Ee,Ke,z,K)=>{i(ae,d),i(x,c),i(wn,t),i(yn,o),i(vn,l),i(Qn,p),i(qn,u),i(Xn,m),i(Bn,y),i(Dn,A),i(zn,I),i(Sn,D),i(Un,F),i(Pn,X),i(Jn,E),i(Fn,Pe),i(En,C),i(Kn,Je),i(Wn,M),i(On,$),i(Tn,Fe),i(Gn,Ee),i(Rn,Ke),i(Cn,z),i(Vn,K)},[()=>e(a).t(45),()=>e(a).t(64),()=>e(a).t(82),()=>e(a).t(167),()=>e(a).t(75),()=>e(a).t(145),()=>e(a).t(213),()=>e(a).t(201),()=>e(a).t(102),()=>e(a).t(68),()=>e(a).t(197),()=>e(a).t(42),()=>e(a).t(28),()=>e(a).t(125),()=>e(a).t(32),()=>e(a).t(23),()=>e(a).t(43),()=>e(a).t(81),()=>e(a).t(193),()=>e(a).t(63),()=>e(a).t(160),()=>e(a).t(98),()=>e(a).t(103),()=>e(a).t(104),()=>e(a).t(100)]),h(Q,G),is()}export{Ns as component};
