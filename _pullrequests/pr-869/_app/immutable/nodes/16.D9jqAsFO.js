...
`,vs=(y,v=Q)=>{var i=gn(),u=I(i);Re(u,19,()=>v().sort(()=>Math.random()-.5),({url:q,name:D})=>q||D,(q,D,C)=>{let W=()=>s(D).url,H=()=>s(D).name;var K=Pn(),R=I(K);{var $=j=>{var k=ie(",");h(j,k)};T(R,j=>{s(C)>0&&j($)})}var N=a(R,2);{var ae=j=>{var k=Jn(),L=n(k,!0);e(k),f(()=>{P(k,"href",W()),t(L,H())}),h(j,k)},ee=j=>{var k=ie();f(()=>t(k,H())),h(j,k)};T(N,j=>{W()?j(ae):j(ee,!1)})}h(q,K)}),h(y,i)},_=(y,v=Q,i=Q)=>{var u=Wn();let q;var D=n(u);yn(D,i,(C,W)=>{W(C,{})}),e(u),f(()=>q=xn(u,"",q,{color:`var(--fg-${v()??""})`,"background-color":`var(--bg-${v()??""})`})),h(y,u)};var Jn=g('<a target="_blank"> </a>'),Pn=g("<!> <!>",1),Wn=g('<div class="swatch svelte-6yh93n"><!></div>'),Kn=g('<a href="https://enseeiht.fr"> </a>'),Fn=g('<dd class="svelte-6yh93n"><code> </code></dd>'),On=g("<!> <code> </code>",1),Gn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"></dd>',1),En=g('<dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!></dl></dd>',1),Tn=g("<code> </code>"),Cn=g("<code> </code>"),Hn=g("<code></code>"),Rn=g("<a> </a>"),Nn=g("<a> </a>"),Ln=g("<a> </a>"),Mn=g("<a> </a>"),Vn=g("<a> </a>"),Zn=g('<a href="https://remixicon.com"> </a>'),_n=g('<a href="https://www.zhangxiaochun.com/"> </a>'),$n=g('<a href="https://gaoquanquan.com/"> </a>'),ei=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),si=g('<dl class="dependencies svelte-6yh93n"></dl>'),ni=g("<p> </p> <p> </p>",1),ii=g("<p> </p>"),ai=g('<header class="svelte-6yh93n"><!> <div class="text"><h1> </h1> <p class="subtitle svelte-6yh93n"> </p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames"> </a></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <dt> </dt> <dd class="svelte-6yh93n"> </dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/"> </a></dt> <dd class="svelte-6yh93n"><span><!></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code><!></code></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt></dt> <dd class="svelte-6yh93n"><!> <!> <!> <!> <!></dd></dl>',1);function yi(y,v){un(v,!0);const i=w(()=>vn("main"));An({title:s(i).t(201)});let u=xs(void 0);ws(()=>{window.versions&&(ys(u,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(d=>{s(u)&&(s(u).os=d,s(u).sw=d.serviceWorkers)}))});let q=xs(0);ws(()=>{const d=setInterval(()=>{ys(q,Math.max(1,s(q)+.03),!0)},10);return()=>{s(q)>=1&&clearInterval(d)}});const D=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({name:d,gitlab:p,url:r})=>({name:d,url:r??`https://git.inpt.fr/${p}`})),C=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function W(){const{workspaces:d,packages:p}=zn.parse(Un);return[...Object.keys(d[""].dependencies),...Object.keys(d[""].devDependencies)].map(o=>[o,p[o][0].replace(`${o}@`,"")])}var H=ai(),K=I(H),R=n(K);qn(R,{get drawpercent(){return s(q)}});var $=a(R,2),N=n($),ae=n(N,!0);e(N);var ee=a(N,2),j=n(ee,!0);e(ee),e($),e(K);var k=a(K,2),L=n(k),qs=n(L,!0);e(L);var te=a(L,2),As=n(te);vs(As,()=>D),e(te);var re=a(te,2),Ds=n(re,!0);e(re);var oe=a(re,2),Xs=n(oe);vs(Xs,()=>C),e(oe);var ce=a(oe,2),zs=n(ce,!0);e(ce);var pe=a(ce,2);{const d=(p,r=Q)=>{var o=Kn(),l=n(o,!0);e(o),f(c=>t(l,c),[()=>s(i).tx(r())]),h(p,o)};var Bs=n(pe);{let p=w(()=>[d]),r=w(()=>s(i).cx(203));J(Bs,{get t(){return s(p)},get x(){return s(r)}})}e(pe)}var Ne=a(pe,2);{var Is=d=>{var p=En(),r=I(p),o=n(r,!0);e(r);var l=a(r,2),c=n(l),m=n(c),b=n(m,!0);e(m);var x=a(m,2),X=n(x),Y=n(X,!0);e(X),e(x);var S=a(x,2),F=n(S,!0);e(S);var z=a(S,2),O=n(z),We=n(O,!0);e(O),e(z);var M=a(z,2),Ke=n(M,!0);e(M);var V=a(M,2),se=n(V),Fe=n(se,!0);e(se),e(V);var Oe=a(V,2);{var Ge=U=>{var G=Gn(),Z=I(G),Ee=n(Z,!0);e(Z);var Te=a(Z,2),us=n(Te),on=n(us,!0);e(us),e(Te);var ms=a(Te,2);{var cn=A=>{var B=Fn(),E=n(B),ne=n(E,!0);e(E),e(B),f(()=>t(ne,s(u).os.architecture)),h(A,B)};T(ms,A=>{s(u).os.archIsUnusual&&A(cn)})}var Ce=a(ms,2),pn=n(Ce,!0);e(Ce);var gs=a(Ce,2);Re(gs,22,()=>s(u).sw,A=>A,(A,B,E)=>{var ne=On(),bs=I(ne);{var ln=He=>{var hn=ie(",");h(He,hn)};T(bs,He=>{s(E)>0&&He(ln)})}var fs=a(bs,2),dn=n(fs,!0);e(fs),f(()=>t(dn,B)),h(A,ne)},A=>{fn();var B=ie();f(E=>t(B,E),[()=>s(i).t(204)]),h(A,B)}),e(gs),f(A=>{t(Ee,s(u).os.name),t(on,s(u).os.version),t(pn,A)},[()=>s(i).t(161)]),h(U,G)};T(Oe,U=>{"os"in s(u)&&U(Ge)})}e(c),e(l),f((U,G,Z,Ee)=>{t(o,U),t(b,G),t(Y,s(u).node),t(F,Z),t(We,s(u).chrome),t(Ke,Ee),t(Fe,s(u).electron)},[()=>s(i).t(186),()=>s(i).t(133),()=>s(i).t(61),()=>s(i).t(83)]),h(d,p)};T(Ne,d=>{s(u)&&d(Is)})}var le=a(Ne,2),Ys=n(le,!0);e(le);var de=a(le,2),Le=n(de),he=n(Le),Ss=n(he,!0);e(he);var ue=a(he,2);{const d=p=>{var r=Tn(),o=n(r,!0);e(r),f(()=>t(o,v.data.parallelism)),h(p,r)};var Us=n(ue);{let p=w(()=>[d]),r=w(()=>s(i).cx(19));J(Us,{get t(){return s(p)},get x(){return s(r)}})}e(ue)}var me=a(ue,2),Js=n(me,!0);e(me);var ge=a(me,2);{const d=p=>{var r=Cn(),o=n(r,!0);e(r),f(()=>t(o,v.data.parallelism)),h(p,r)};var Ps=n(ge);{let p=w(()=>[d]),r=w(()=>s(i).cx(20));J(Ps,{get t(){return s(p)},get x(){return s(r)}})}e(ge)}var be=a(ge,2),Ws=n(be,!0);e(be);var Me=a(be,2);{const d=p=>{var r=Hn();r.textContent=navigator.hardwareConcurrency,h(p,r)};var Ks=n(Me);{let p=w(()=>[d]),r=w(()=>s(i).cx(22));J(Ks,{get t(){return s(p)},get x(){return s(r)}})}e(Me)}e(Le),e(de);var fe=a(de,2),Fs=n(fe,!0);e(fe);var we=a(fe,2),Ve=n(we),Os=n(Ve,!0);e(Ve),e(we);var ye=a(we,2),Gs=n(ye,!0);e(ye);var xe=a(ye,2),Ze=n(xe),ve=n(Ze),Es=n(ve,!0);e(ve);var je=a(ve,2),_e=n(je),Ts=n(_e,!0);e(_e),e(je);var ke=a(je,2),Cs=n(ke,!0);e(ke);var $e=a(ke,2),es=n($e),Hs=n(es,!0);e(es),e($e),e(Ze),e(xe);var Qe=a(xe,2),Rs=n(Qe,!0);e(Qe);var qe=a(Qe,2),ss=n(qe),Ae=n(ss),Ns=n(Ae,!0);e(Ae);var De=a(Ae,2),Ls=n(De,!0);e(De);var Xe=a(De,2),Ms=n(Xe,!0);e(Xe);var ns=a(Xe,2),Vs=n(ns,!0);e(ns),e(ss),e(qe);var ze=a(qe,2),Zs=n(ze,!0);e(ze);var Be=a(ze,2),is=n(Be),Ie=n(is),as=n(Ie),_s=n(as,!0);e(as),e(Ie);var Ye=a(Ie,2),ts=n(Ye);{const d=(o,l=Q)=>{var c=Rn(),m=n(c,!0);e(c),f((b,x)=>{P(c,"href",b),t(m,x)},[()=>s(i).t(216),()=>s(i).tx(l())]),h(o,c)},p=(o,l=Q)=>{var c=Nn(),m=n(c,!0);e(c),f((b,x)=>{P(c,"href",b),t(m,x)},[()=>s(i).t(217),()=>s(i).tx(l())]),h(o,c)},r=(o,l=Q)=>{var c=Ln(),m=n(c,!0);e(c),f((b,x)=>{P(c,"href",b),t(m,x)},[()=>s(i).t(218),()=>s(i).tx(l())]),h(o,c)};var $s=n(ts);{let o=w(()=>[d,p,r]),l=w(()=>s(i).cx(193));J($s,{get t(){return s(o)},get x(){return s(l)}})}e(ts)}e(Ye);var rs=a(Ye,4),os=n(rs);{const d=(r,o=Q)=>{var l=Mn(),c=n(l,!0);e(l),f((m,b)=>{P(l,"href",m),t(c,b)},[()=>s(i).t(213),()=>s(i).tx(o())]),h(r,l)},p=(r,o=Q)=>{var l=Vn(),c=n(l,!0);e(l),f((m,b)=>{P(l,"href",m),t(c,b)},[()=>s(i).t(214),()=>s(i).tx(o())]),h(r,l)};var en=n(os);{let r=w(()=>[d,p]),o=w(()=>s(i).cx(215));J(en,{get t(){return s(r)},get x(){return s(o)}})}e(os)}e(rs),e(is),e(Be);var Se=a(Be,2),sn=n(Se,!0);e(Se);var Ue=a(Se,2);{const d=(o,l=Q)=>{var c=Zn(),m=n(c,!0);e(c),f(b=>t(m,b),[()=>s(i).tx(l())]),h(o,c)},p=(o,l=Q)=>{var c=_n(),m=n(c,!0);e(c),f(b=>t(m,b),[()=>s(i).tx(l())]),h(o,c)},r=(o,l=Q)=>{var c=$n(),m=n(c,!0);e(c),f(b=>t(m,b),[()=>s(i).tx(l())]),h(o,c)};var nn=n(Ue);{let o=w(()=>[d,p,r]),l=w(()=>s(i).cx(362));J(nn,{get t(){return s(o)},get x(){return s(l)}})}e(Ue)}var Je=a(Ue,2),an=n(Je,!0);e(Je);var Pe=a(Je,2),tn=n(Pe);wn(tn,W,d=>{var p=ii(),r=n(p,!0);e(p),f(o=>t(r,o),[()=>s(i).t(54)]),h(d,p)},(d,p)=>{var r=si();Re(r,21,()=>s(p),([o,l])=>o,(o,l)=>{var c=w(()=>bn(s(l),2));let m=()=>s(c)[0],b=()=>s(c)[1];var x=ei(),X=I(x),Y=n(X),S=n(Y,!0);e(Y),e(X);var F=a(X,2),z=n(F),O=n(z,!0);e(z),e(F),f(()=>{P(Y,"href",`https://npmjs.com/package/${m()??""}`),t(S,m()),t(O,b())}),h(o,x)}),e(r),h(d,r)},(d,p)=>{var r=ni(),o=I(r),l=n(o,!0);e(o);var c=a(o,2),m=n(c,!0);e(c),f(b=>{t(l,b),t(m,s(p))},[()=>s(i).t(113)]),h(d,r)}),e(Pe);var cs=a(Pe,4),ps=n(cs);_(ps,()=>"error",()=>kn);var ls=a(ps,2);_(ls,()=>"warning",()=>Qn);var ds=a(ls,2);_(ds,()=>"success",()=>jn);var hs=a(ds,2);_(hs,()=>"primary",()=>In);var rn=a(hs,2);_(rn,()=>"neutral",()=>Sn),e(cs),e(k),f((d,p,r,o,l,c,m,b,x,X,Y,S,F,z,O,We,M,Ke,V,se,Fe,Oe,Ge,U,G)=>{t(ae,d),t(j,p),t(qs,r),t(Ds,o),t(zs,l),t(Ys,c),t(Ss,m),t(Js,b),t(Ws,x),t(Fs,X),t(Os,Y),t(Gs,S),t(Es,F),t(Ts,z),t(Cs,O),t(Hs,We),t(Rs,M),t(Ns,Ke),t(Ls,V),t(Ms,se),t(Vs,Fe),t(Zs,Oe),t(_s,Ge),t(sn,U),t(an,G)},[()=>s(i).t(45),()=>s(i).t(63),()=>s(i).t(81),()=>s(i).t(162),()=>s(i).t(74),()=>s(i).t(140),()=>s(i).t(208),()=>s(i).t(196),()=>s(i).t(101),()=>s(i).t(67),()=>s(i).t(192),()=>s(i).t(42),()=>s(i).t(28),()=>s(i).t(121),()=>s(i).t(32),()=>s(i).t(23),()=>s(i).t(43),()=>s(i).t(80),()=>s(i).t(188),()=>s(i).t(62),()=>s(i).t(155),()=>s(i).t(97),()=>s(i).t(102),()=>s(i).t(103),()=>s(i).t(99)]),h(y,H),mn()}export{yi as component};
