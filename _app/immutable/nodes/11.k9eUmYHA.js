import"../chunks/DsnmJJEf.js";import{p as Be,d as fe,au as xe,c as i,at as we,h as g,j as w,n as Je,aq as n,ar as f,a as o,b as Te,as as a,k as Le,av as P,r as e,aR as H,u as Ke,b9 as He}from"../chunks/CtLKvhh7.js";import{s as t}from"../chunks/mpcu8TYc.js";import{a as Me}from"../chunks/C5M5TbRx.js";import{i as A}from"../chunks/DHIFQ1x6.js";import{e as ae}from"../chunks/C7D25C5L.js";import{c as ve}from"../chunks/wAng4ifM.js";import{L as Re}from"../chunks/C6oA8TGp.js";import{s as Ce}from"../chunks/dpx-VjmY.js";import{g as M}from"../chunks/B0nJzvm_.js";const Ee=()=>"Developed by",je=()=>"Développé par",Ve=je,Ne=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ee():s==="fr"?je():Ve()},Ze=()=>"About",ke=()=>"À propos",_e=ke,$e=(u={},d={})=>{const s=d.locale??M();return s==="en"?Ze():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(u={},d={})=>{const s=d.locale??M();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(u={},d={})=>{const s=d.locale??M();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:u=>{u=String(u);try{return JSON.parse(u)}catch{return JSON.parse(u.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
