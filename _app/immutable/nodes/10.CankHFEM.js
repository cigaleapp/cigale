import"../chunks/DsnmJJEf.js";import{as as Xe,y as le,aA as ce,m as i,az as de,z as g,A as w,B as We,t as y,a as t,at as Ue,au as s,av as r,D as Ge,ax as me,E as e,ay as M,aw as Ye,ba as Pe}from"../chunks/CAVl0i4x.js";import{s as o}from"../chunks/QHlMoSnV.js";import{a as Se}from"../chunks/D2iw8d_X.js";import{i as A}from"../chunks/BJ8PpdDL.js";import{e as ee}from"../chunks/CjhfvqTy.js";import{c as ue}from"../chunks/QN1x3yhr.js";import{L as Te}from"../chunks/SbDwaWaj.js";import{s as Oe}from"../chunks/BbXJwlsT.js";import{g as L}from"../chunks/DEue9iQn.js";const Be=()=>"Developed by",ge=()=>"Développé par",Ie=ge,Fe=(m={},h={})=>{const n=h.locale??L();return n==="en"?Be():n==="fr"?ge():Ie()},He=()=>"About",be=()=>"À propos",Je=be,Me=(m={},h={})=>{const n=h.locale??L();return n==="en"?He():n==="fr"?be():Je()},Le=()=>"Under the supervision of",ye=()=>"Sous la supervision de",Ee=ye,Ke=(m={},h={})=>{const n=h.locale??L();return n==="en"?Le():n==="fr"?ye():Ee()},Re=()=>"As part of",fe=()=>"Dans le cadre d'un",Ce=fe,Ze=(m={},h={})=>{const n=h.locale??L();return n==="en"?Re():n==="fr"?fe():Ce()},Ve=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,Ne=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,_e={parse:m=>{m=String(m);try{return JSON.parse(m)}catch{return JSON.parse(m.replace(Ve,"$1").replace(Ne,"$1"))}}},$e=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
