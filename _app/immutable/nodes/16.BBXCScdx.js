import"../chunks/DsnmJJEf.js";import{f as ks,a as h,p as wn,g as s,u as f,k as ys,i as xs,s as vs,c as g,d as Y,n as Q,_ as b,b as fn,am as n,an as a,e as yn,r as e,Z as re,bk as xn,ao as vn}from"../chunks/MjbizcKA.js";import{a as r}from"../chunks/DbtmWplF.js";import{e as Le}from"../chunks/BRjtu-sh.js";import{a as jn}from"../chunks/D_gnN6Mn.js";import{r as Qs,i as R}from"../chunks/gQFXblbv.js";import{c as kn}from"../chunks/BLpyeD-h.js";import{a as qs,s as O,d as Qn,b as qn}from"../chunks/BwZOQIYa.js";import{C as An}from"../chunks/CisDRGFK.js";import{C as Dn}from"../chunks/DvllgsR_.js";import{E as Bn}from"../chunks/B-EbFQs3.js";import{v as Xn}from"../chunks/qkPHtQ5_.js";import{L as zn}from"../chunks/Z_1nmMCG.js";import{s as Yn}from"../chunks/CISZhSSW.js";import{R as W}from"../chunks/CPqSekZq.js";const In=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,Sn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,Jn={parse:y=>{y=String(y);try{return JSON.parse(y)}catch{return JSON.parse(y.replace(In,"$1").replace(Sn,"$1"))}}};var Un=ks('<svg><path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10m0-2a8 8 0 1 0 0-16a8 8 0 0 0 0 16M11 7h2v2h-2zm0 4h2v6h-2z"></path></svg>');function Pn(y,x){const i=Qs(x,["$$slots","$$events","$$legacy"]);var u=Un();qs(u,()=>({class:"icon",viewBox:"0 0 24 24",width:"1.2em",height:"1.2em",...i})),h(y,u)}var Kn=ks('<svg><path fill="currentColor" d="M21 4H3v2h18zm0 7H8v2h13zm0 7H8v2h13zM5 11H3v9h2z"></path></svg>');function Wn(y,x){const i=Qs(x,["$$slots","$$events","$$legacy"]);var u=Kn();qs(u,()=>({class:"icon",viewBox:"0 0 24 24",width:"1.2em",height:"1.2em",...i})),h(y,u)}const On=`{
  "lockfileVersion": 1,
  "configVersion": 0,
  "workspaces": {
    "": {
      ...
      "dependencies": {
        ...
        "piexifjs": "^1.0.6",
        "runed": "^0.37.0",
        "svelte-mathml": "gwennlbh/svelte-mathml#4f4a70d9c50942769b52d40fcf9adbe04bd973ac",
  ...
  "packages": {
    ...
    "@asamuzakjp/css-color": ["@asamuzakjp/css-color@4.0.4", "", { "dependencies": { "@csstools/css-calc": "^2.1.4", "@csstools/css-color-parser": "^3.0.10", "@csstools/css-parser-algorithms": "^3.0.5", "@csstools/css-tokenizer": "^3.0.4", "lru-cache": "^11.1.0" } }, "sha512-cKjSKvWGmAziQWbCouOsFwb14mp1betm8Y7Fn+yglDMUUu3r9DCbJ9iJbeFDenLMqFbIMC0pQP8K+B8LAxX3OQ=="],
    ...
    "@oxc-resolver/binding-android-arm-eabi": ["@oxc-resolver/binding-android-arm-eabi@11.13.2", "", { "os": "android", "cpu": "arm" }, "sha512-vWd1NEaclg/t2DtEmYzRRBNQOueMI8tixw/fSNZ9XETXLRJiAjQMYpYeflQdRASloGze6ZelHE/wIBNt4S+pkw=="],

    "@oxc-resolver/binding-android-arm64": ["@oxc-resolver/binding-android-arm64@11.13.2", "", { "os": "android", "cpu": "arm64" }, "sha512-jxZrYcxgpI6IuQpguQVAQNrZfUyiYfMVqR4pKVU3PRLCM7AsfXNKp0TIgcvp+l6dYVdoZ1MMMMa5Ayjd09rNOw=="],

    "@oxc-resolver/binding-darwin-arm64": ["@oxc-resolver/binding-darwin-arm64@11.13.2", "", { "os": "darwin", "cpu": "arm64" }, "sha512-RDS3HUe1FvgjNS1xfBUqiEJ8938Zb5r7iKABwxEblp3K4ufZZNAtoaHjdUH2TJ0THDmuf0OxxVUO/Y+4Ep4QfQ=="],

    "@oxc-resolver/binding-darwin-x64": ["@oxc-resolver/binding-darwin-x64@11.13.2", "", { "os": "darwin", "cpu": "x64" }, "sha512-tDcyWtkUzkt6auJLP2dOjL84BxqHkKW4mz2lNRIGPTq7b+HBraB+m8RdRH6BgqTvbnNECOxR3XAMaKBKC8J51g=="],

    "@oxc-resolver/binding-freebsd-x64": ["@oxc-resolver/binding-freebsd-x64@11.13.2", "", { "os": "freebsd", "cpu": "x64" }, "sha512-fpaeN8Q0kWvKns9uSMg6CcKo7cdgmWt6J91stPf8sdM+EKXzZ0YcRnWWyWF8SM16QcLUPCy5Iwt5Z8aYBGaZYA=="],

    "@oxc-resolver/binding-linux-arm-gnueabihf": ["@oxc-resolver/binding-linux-arm-gnueabihf@11.13.2", "", { "os": "linux", "cpu": "arm" }, "sha512-idBgJU5AvSsGOeaIWiFBKbNBjpuduHsJmrG4CBbEUNW/Ykx+ISzcuj1PHayiYX6R9stVsRhj3d2PyymfC5KWRg=="],

    "@oxc-resolver/binding-linux-arm-musleabihf": ["@oxc-resolver/binding-linux-arm-musleabihf@11.13.2", "", { "os": "linux", "cpu": "arm" }, "sha512-BlBvQUhvvIM/7s96KlKhMk0duR2sj8T7Hyii46/5QnwfN/pHwobvOL5czZ6/SKrHNB/F/qDY4hGsBuB1y7xgTg=="],

    "@oxc-resolver/binding-linux-arm64-gnu": ["@oxc-resolver/binding-linux-arm64-gnu@11.13.2", "", { "os": "linux", "cpu": "arm64" }, "sha512-lUmDTmYOGpbIK+FBfZ0ySaQTo7g1Ia/WnDnQR2wi/0AtehZIg/ZZIgiT/fD0iRvKEKma612/0PVo8dXdAKaAGA=="],

    "@oxc-resolver/binding-linux-arm64-musl": ["@oxc-resolver/binding-linux-arm64-musl@11.13.2", "", { "os": "linux", "cpu": "arm64" }, "sha512-dkGzOxo+I9lA4Er6qzFgkFevl3JvwyI9i0T/PkOJHva04rb1p9dz8GPogTO9uMK4lrwLWzm/piAu+tHYC7v7+w=="],

    "@oxc-resolver/binding-linux-ppc64-gnu": ["@oxc-resolver/binding-linux-ppc64-gnu@11.13.2", "", { "os": "linux", "cpu": "ppc64" }, "sha512-53kWsjLkVFnoSA7COdps38pBssN48zI8LfsOvupsmQ0/4VeMYb+0Ao9O6r52PtmFZsGB3S1Qjqbjl/Pswj1a3g=="],

    "@oxc-resolver/binding-linux-riscv64-gnu": ["@oxc-resolver/binding-linux-riscv64-gnu@11.13.2", "", { "os": "linux", "cpu": "none" }, "sha512-MfxN6DMpvmdCbGlheJ+ihy11oTcipqDfcEIQV9ah3FGXBRCZtBOHJpQDk8qI2Y+nCXVr3Nln7OSsOzoC4+rSYQ=="],

    "@oxc-resolver/binding-linux-riscv64-musl": ["@oxc-resolver/binding-linux-riscv64-musl@11.13.2", "", { "os": "linux", "cpu": "none" }, "sha512-WXrm4YiRU0ijqb72WHSjmfYaQZ7t6/kkQrFc4JtU+pUE4DZA/DEdxOuQEd4Q43VqmLvICTJWSaZMlCGQ4PSRUg=="],

    "@oxc-resolver/binding-linux-s390x-gnu": ["@oxc-resolver/binding-linux-s390x-gnu@11.13.2", "", { "os": "linux", "cpu": "s390x" }, "sha512-4pISWIlOFRUhWyvGCB3XUhtcwyvwGGhlXhHz7IXCXuGufaQtvR05trvw8U1ZnaPhsdPBkRhOMIedX11ayi5uXw=="],
    ...
    "@oxc-resolver/binding-linux-x64-musl": ["@oxc-resolver/binding-linux-x64-musl@11.13.2", "", { "os": "linux", "cpu": "x64" }, "sha512-6WqrE+hQBFP35KdwQjWcZpldbTq6yJmuTVThISu+rY3+j6MaDp2ciLHTr1X68r2H/7ocOIl4k3NnOVIzeRJE3w=="],

    "@oxc-resolver/binding-wasm32-wasi": ["@oxc-resolver/binding-wasm32-wasi@11.13.2", "", { "dependencies": { "@napi-rs/wasm-runtime": "^1.0.7" }, "cpu": "none" }, "sha512-YpxvQmP2D+mNUkLQZbBjGz20g/pY8XoOBdPPoWMl9X68liFFjXxkPQTrZxWw4zzG/UkTM5z6dPRTyTePRsMcjw=="],

    "@oxc-resolver/binding-win32-arm64-msvc": ["@oxc-resolver/binding-win32-arm64-msvc@11.13.2", "", { "os": "win32", "cpu": "arm64" }, "sha512-1SKBw6KcCmvPBdEw1/Qdpv6eSDf23lCXTWz9VxTe6QUQ/1wR+HZR2uS4q6C8W6jnIswMTQbxpTvVwdRXl+ufeA=="],

    "@oxc-resolver/binding-win32-ia32-msvc": ["@oxc-resolver/binding-win32-ia32-msvc@11.13.2", "", { "os": "win32", "cpu": "ia32" }, "sha512-KEVV7wggDucxRn3vvyHnmTCPXoCT7vWpH18UVLTygibHJvNRP2zl5lBaQcCIdIaYYZjKt1aGI/yZqxZvHoiCdg=="],

    "@oxc-resolver/binding-win32-x64-msvc": ["@oxc-resolver/binding-win32-x64-msvc@11.13.2", "", { "os": "win32", "cpu": "x64" }, "sha512-6AAdN9v/wO5c3td1yidgNLKYlzuNgfOtEqBq60WE469bJWR7gHgG/S5aLR2pH6/gyPLs9UXtItxi934D+0Estg=="],
    ...
    "@vitest/coverage-v8": ["@vitest/coverage-v8@4.0.14", "", { "dependencies": { "@bcoe/v8-coverage": "^1.0.2", "@vitest/utils": "4.0.14", "ast-v8-to-istanbul": "^0.3.8", "istanbul-lib-coverage": "^3.2.2", "istanbul-lib-report": "^3.0.1", "istanbul-lib-source-maps": "^5.0.6", "istanbul-reports": "^3.2.0", "magicast": "^0.5.1", "obug": "^2.1.1", "std-env": "^3.10.0", "tinyrainbow": "^3.0.3" }, "peerDependencies": { "@vitest/browser": "4.0.14", "vitest": "4.0.14" }, "optionalPeers": ["@vitest/browser"] }, "sha512-EYHLqN/BY6b47qHH7gtMxAg++saoGmsjWmAq9MlXxAz4M0NcHh9iOyKhBZyU4yxZqOd8Xnqp80/5saeitz4Cng=="],
    ...
    "@vitest/ui": ["@vitest/ui@4.0.14", "", { "dependencies": { "@vitest/utils": "4.0.14", "fflate": "^0.8.2", "flatted": "^3.3.3", "pathe": "^2.0.3", "sirv": "^3.0.2", "tinyglobby": "^0.2.15", "tinyrainbow": "^3.0.3" }, "peerDependencies": { "vitest": "4.0.14" } }, "sha512-fvDz8o7SQpFLoSBo6Cudv+fE85/fPCkwTnLAN85M+Jv7k59w2mSIjT9Q5px7XwGrmYqqKBEYxh/09IBGd1E7AQ=="],
    ...
    "@wuchale/svelte": ["@wuchale/svelte@0.17.5", "", { "dependencies": { "svelte": "^5.37.0", "wuchale": "^0.18.5" } }, "sha512-JaCUGuIMa4MFZBo9IC858kxy5HunKA/gFbzZ0Tyv2O2IAdvP6D8g4VWzWxtISLmr35DRN7MDomGoJws3U8f8QA=="],

    "@wuchale/vite-plugin": ["@wuchale/vite-plugin@0.15.3", "", { "dependencies": { "wuchale": "^0.18.3" } }, "sha512-GtPT1gwAGJAb1oc7R5MuGyl1R8m50QdoqFiW/76g2e81d9iPUYNi/CTg8BEeg4WmQJ+91JRR//rwgEo+jG0fZQ=="],
    ...
    "electron": ["electron@39.2.4", "", { "dependencies": { "@electron/get": "^2.0.0", "@types/node": "^22.7.7", "extract-zip": "^2.0.1" }, "bin": { "electron": "cli.js" } }, "sha512-KxPtwpFceQKSxRtUY39piHLYhJMMyHfOhc70e6zRnKGrbRdK6hzEqssth8IGjlKOdkeT4KCvIEngnNraYk39+g=="],
    ...
    "eslint-plugin-oxlint": ["eslint-plugin-oxlint@1.31.0", "", { "dependencies": { "jsonc-parser": "^3.3.1" } }, "sha512-yIUkBg9qZCL9DZVSvH3FklF5urG7LRboZD0/YLf/CvihPpcfBeMyH1onaG3+iKMCIRa/uwXgdRjB5MSOplFTVw=="],
    ...
    "googleapis": ["googleapis@166.0.0", "", { "dependencies": { "google-auth-library": "^10.2.0", "googleapis-common": "^8.0.0" } }, "sha512-Xz7yG+ihVvYMwSULKIMeTp6vDX95rrSbsaR3xUmgYjwQdAkchMQ5ndFeG5QZwcBOIyvJFvG7ZLIZE7mKW2X/hw=="],
    ...
    "oxc-resolver": ["oxc-resolver@11.13.2", "", { "optionalDependencies": { "@oxc-resolver/binding-android-arm-eabi": "11.13.2", "@oxc-resolver/binding-android-arm64": "11.13.2", "@oxc-resolver/binding-darwin-arm64": "11.13.2", "@oxc-resolver/binding-darwin-x64": "11.13.2", "@oxc-resolver/binding-freebsd-x64": "11.13.2", "@oxc-resolver/binding-linux-arm-gnueabihf": "11.13.2", "@oxc-resolver/binding-linux-arm-musleabihf": "11.13.2", "@oxc-resolver/binding-linux-arm64-gnu": "11.13.2", "@oxc-resolver/binding-linux-arm64-musl": "11.13.2", "@oxc-resolver/binding-linux-ppc64-gnu": "11.13.2", "@oxc-resolver/binding-linux-riscv64-gnu": "11.13.2", "@oxc-resolver/binding-linux-riscv64-musl": "11.13.2", "@oxc-resolver/binding-linux-s390x-gnu": "11.13.2", "@oxc-resolver/binding-linux-x64-gnu": "11.13.2", "@oxc-resolver/binding-linux-x64-musl": "11.13.2", "@oxc-resolver/binding-wasm32-wasi": "11.13.2", "@oxc-resolver/binding-win32-arm64-msvc": "11.13.2", "@oxc-resolver/binding-win32-ia32-msvc": "11.13.2", "@oxc-resolver/binding-win32-x64-msvc": "11.13.2" } }, "sha512-1SXVyYQ9bqMX3uZo8Px81EG7jhZkO9PvvR5X9roY5TLYVm4ZA7pbPDNlYaDBBeF9U+YO3OeMNoHde52hrcCu8w=="],
    ...
    "svelte-mathml": ["svelte-mathml@github:gwennlbh/svelte-mathml#4f4a70d", { "peerDependencies": { "svelte": "^5.45.2" } }, "gwennlbh-svelte-mathml-4f4a70d"],
    ...
    "sveltekit-search-params": ["sveltekit-search-params@4.0.0-next.0", "", { "peerDependencies": { "@sveltejs/kit": "^2.0.0", "svelte": "^5.0.0" } }, "sha512-haFr5seakusriPePAv2F5/lsOa37rr9AOGDa5JOZ9CaB0Vrl8V8PdtqNWfh/kF0jlANdkdqz5gKK66nhhHT8tg=="],
    ...
    "wuchale": ["wuchale@0.18.5", "", { "dependencies": { "@sveltejs/acorn-typescript": "^1.0.6", "acorn": "^8.15.0", "chokidar": "^4.0.3", "magic-string": "^0.30.21", "path-to-regexp": "^8.3.0", "picomatch": "^4.0.3", "pofile": "^1.1.4", "tinyglobby": "^0.2.15" }, "bin": { "wuchale": "dist/cli/index.js" } }, "sha512-jCKAKIalzgQsIAC7HFKSHE1zGqTwN9K+44kJ32MNt3Vw9maJS3HBrI9DzER361d/iWApEqTG+SYTyDNGcXxS0A=="],
    ...
    "@wuchale/svelte/svelte": ["svelte@5.43.5", "", { "dependencies": { "@jridgewell/remapping": "^2.3.4", "@jridgewell/sourcemap-codec": "^1.5.0", "@sveltejs/acorn-typescript": "^1.0.5", "@types/estree": "^1.0.5", "acorn": "^8.12.1", "aria-query": "^5.3.1", "axobject-query": "^4.1.0", "clsx": "^2.1.1", "esm-env": "^1.2.1", "esrap": "^2.1.0", "is-reference": "^3.0.3", "locate-character": "^3.0.0", "magic-string": "^0.30.11", "zimmerframe": "^1.1.2" } }, "sha512-HQoZArIewxQVNedseDsgMgnRSC4XOXczxXLF9rOJaPIJkg58INOPUiL8aEtzqZIXNSZJyw8NmqObwg/voajiHQ=="],

    "@wuchale/vite-plugin/wuchale": ["wuchale@0.18.3", "", { "dependencies": { "@sveltejs/acorn-typescript": "^1.0.6", "acorn": "^8.15.0", "chokidar": "^4.0.3", "magic-string": "^0.30.21", "path-to-regexp": "^8.3.0", "picomatch": "^4.0.3", "pofile": "^1.1.4", "tinyglobby": "^0.2.15" }, "bin": { "wuchale": "dist/cli/index.js" } }, "sha512-l4JxOjfGLiqY1u33I3TRlvrTGyMZfrXPei73Gw9wgdIGDicMI85eKN+fBNQxlunOTDavxY1M0qQNRBuv7gjmKQ=="],
    ...
    "vitest/vite": ["vite@7.2.4", "", { "dependencies": { "esbuild": "^0.25.0", "fdir": "^6.5.0", "picomatch": "^4.0.3", "postcss": "^8.5.6", "rollup": "^4.43.0", "tinyglobby": "^0.2.15" }, "optionalDependencies": { "fsevents": "~2.3.3" }, "peerDependencies": { "@types/node": "^20.19.0 || >=22.12.0", "jiti": ">=1.21.0", "less": "^4.0.0", "lightningcss": "^1.21.0", "sass": "^1.70.0", "sass-embedded": "^1.70.0", "stylus": ">=0.54.8", "sugarss": "^5.0.0", "terser": "^5.16.0", "tsx": "^4.8.1", "yaml": "^2.4.2" }, "optionalPeers": ["@types/node", "jiti", "less", "lightningcss", "sass", "sass-embedded", "stylus", "sugarss", "terser", "tsx", "yaml"], "bin": { "vite": "bin/vite.js" } }, "sha512-NL8jTlbo0Tn4dUEXEsUg8KeyG/Lkmc4Fnzb8JXN/Ykm9G4HNImjtABMJgkQoVjOBN/j2WAwDTRytdqJbZsah7w=="],
    ...
    "@wuchale/svelte/svelte/esrap": ["esrap@2.1.0", "", { "dependencies": { "@jridgewell/sourcemap-codec": "^1.4.15" } }, "sha512-yzmPNpl7TBbMRC5Lj2JlJZNPml0tzqoqP5B1JXycNUwtqma9AKCO0M2wHrdgsHcy1WRW7S9rJknAMtByg3usgA=="],

    "@wuchale/vite-plugin/wuchale/picomatch": ["picomatch@4.0.3", "", {}, "sha512-5gTmgEY/sqK6gFXLIsQNH19lWb4ebPDLA4SdLP7dsWkIXHWlG66oPuVvXSGFPppYZz8ZDZq0dYYrbHfBCVUb1Q=="],
...
`,js=(y,x=Q)=>{var i=yn(),u=Y(i);Le(u,19,()=>x().sort(()=>Math.random()-.5),({url:q,name:B})=>q||B,(q,B,T)=>{let F=()=>s(B).url,H=()=>s(B).name;var E=En(),N=Y(E);{var ee=v=>{var j=re(",");h(v,j)};R(N,v=>{s(T)>0&&v(ee)})}var M=a(N,2);{var te=v=>{var j=Fn(),L=n(j,!0);e(j),b(()=>{O(j,"href",F()),r(L,H())}),h(v,j)},se=v=>{var j=re();b(()=>r(j,H())),h(v,j)};R(M,v=>{F()?v(te):v(se,!1)})}h(q,E)}),h(y,i)},$=(y,x=Q,i=Q)=>{var u=Gn();let q;var B=n(u);kn(B,i,(T,F)=>{F(T,{})}),e(u),b(()=>q=Qn(u,"",q,{color:`var(--fg-${x()??""})`,"background-color":`var(--bg-${x()??""})`})),h(y,u)};var Fn=g('<a target="_blank"> </a>'),En=g("<!> <!>",1),Gn=g('<div class="swatch svelte-6yh93n"><!></div>'),Cn=g('<a href="https://enseeiht.fr"> </a>'),Rn=g('<dd class="svelte-6yh93n"><code> </code></dd>'),Tn=g("<!> <code> </code>",1),Hn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!> <dt> </dt> <dd class="svelte-6yh93n"></dd>',1),Nn=g('<dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <dt> </dt> <dd class="svelte-6yh93n"><code> </code></dd> <!>',1),Mn=g("<code> </code>"),Ln=g("<code> </code>"),Vn=g("<code></code>"),Zn=g("<a> </a>"),_n=g("<a> </a>"),$n=g("<a> </a>"),ei=g("<a> </a>"),si=g("<a> </a>"),ni=g('<a href="https://remixicon.com"> </a>'),ii=g('<a href="https://www.zhangxiaochun.com/"> </a>'),ai=g('<a href="https://gaoquanquan.com/"> </a>'),ri=g('<dt><a target="_blank"> </a></dt> <dd class="svelte-6yh93n"><code class="svelte-6yh93n"> </code></dd>',1),ti=g('<dl class="dependencies svelte-6yh93n"></dl>'),oi=g("<p> </p> <p> </p>",1),ci=g("<p> </p>"),pi=g('<header class="svelte-6yh93n"><!> <div class="text"><h1> </h1> <p class="subtitle svelte-6yh93n"> </p></div></header> <dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <!></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://github.com/cigaleapp/cigale"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"><a href="https://jessica-joachim.com/identification"> </a></dd> <dt> </dt> <dd class="svelte-6yh93n"><a href="https://techdocs.gbif.org/en/openapi/v1/species#/Searching%20names/searchNames"> </a></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt> </dt> <dd class="svelte-6yh93n"> </dd> <dt> </dt> <dd class="svelte-6yh93n"> </dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><dl class="svelte-6yh93n"><dt><a href="https://elementtype.co/host-grotesk/"> </a></dt> <dd class="svelte-6yh93n"><span><!></span></dd> <dt><a href="https://evilmartians.com/products/martian-mono"><code>Martian Mono</code></a></dt> <dd class="svelte-6yh93n"><code><!></code></dd></dl></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt> </dt> <dd class="svelte-6yh93n"><!></dd> <dt></dt> <dd class="svelte-6yh93n"><!> <!> <!> <!> <!></dd></dl>',1);function qi(y,x){wn(x,!0);const i=f(()=>qn("main"));Yn({title:s(i).t(201)});let u=vs(void 0);ys(()=>{window.versions&&(xs(u,{node:window.versions.node(),chrome:window.versions.chrome(),electron:window.versions.electron()},!0),window.versions.os().then(d=>{s(u)&&(s(u).os=d,s(u).sw=d.serviceWorkers)}))});let q=vs(0);ys(()=>{const d=setInterval(()=>{xs(q,Math.max(1,s(q)+.03),!0)},10);return()=>{s(q)>=1&&clearInterval(d)}});const B=[{name:"Céleste Tiano",gitlab:"tianoc"},{name:"Gaetan Laumonier",gitlab:"laumong"},{name:"Gwenn Le Bihan",gitlab:"gwennlbh",url:"https://gwen.works"},{name:"Ines Charles",gitlab:"charlei"},{name:"Olivier Lamothe",gitlab:"lamotho"}].map(({gitlab:d,...p})=>({url:`https://git.inpt.fr/${d}`,...p})),T=[{name:"Axel Carlier",url:"https://github.com/axelcarlier"},{name:"Maxime Cauchois",url:"https://github.com/mcauchoix"},{name:"Edgar Remy",url:"https://github.com/edgaremy"},{name:"Thomas Forgione",url:"https://github.com/tforgione"}];async function F(){const{workspaces:d,packages:p}=Jn.parse(On);return[...Object.keys(d[""].dependencies),...Object.keys(d[""].devDependencies)].map(t=>[t,p[t][0].replace(`${t}@`,"")])}var H=pi(),E=Y(H),N=n(E);zn(N,{get drawpercent(){return s(q)}});var ee=a(N,2),M=n(ee),te=n(M,!0);e(M);var se=a(M,2),v=n(se,!0);e(se),e(ee),e(E);var j=a(E,2),L=n(j),As=n(L,!0);e(L);var oe=a(L,2),Ds=n(oe);js(Ds,()=>B),e(oe);var ce=a(oe,2),Bs=n(ce,!0);e(ce);var pe=a(ce,2),Xs=n(pe);js(Xs,()=>T),e(pe);var le=a(pe,2),zs=n(le,!0);e(le);var de=a(le,2);{const d=(p,o=Q)=>{var t=Cn(),l=n(t,!0);e(t),b(c=>r(l,c),[()=>s(i).tx(o())]),h(p,t)};var Ys=n(de);{let p=f(()=>[d]),o=f(()=>s(i).cx(203));W(Ys,{get t(){return s(p)},get x(){return s(o)}})}e(de)}var he=a(de,2),Is=n(he,!0);e(he);var ue=a(he,2),Ve=n(ue),me=n(Ve),Ss=n(me,!0);e(me);var ge=a(me,2),Js=n(ge,!0);e(ge);var Us=a(ge,2);{var Ps=d=>{var p=Nn(),o=Y(p),t=n(o,!0);e(o);var l=a(o,2),c=n(l),w=n(c,!0);e(c),e(l);var m=a(l,2),k=n(m,!0);e(m);var I=a(m,2),S=n(I),J=n(S,!0);e(S),e(I);var D=a(I,2),V=n(D,!0);e(D);var X=a(D,2),U=n(X),Z=n(U,!0);e(U),e(X);var Ce=a(X,2);{var Re=P=>{var G=Hn(),K=Y(G),Te=n(K,!0);e(K);var _=a(K,2),ne=n(_),He=n(ne,!0);e(ne),e(_);var ie=a(_,2);{var hn=A=>{var z=Rn(),C=n(z),ae=n(C,!0);e(C),e(z),b(()=>r(ae,s(u).os.architecture)),h(A,z)};R(ie,A=>{s(u).os.archIsUnusual&&A(hn)})}var Ne=a(ie,2),un=n(Ne,!0);e(Ne);var bs=a(Ne,2);Le(bs,22,()=>s(u).sw,A=>A,(A,z,C)=>{var ae=Tn(),ws=Y(ae);{var mn=Me=>{var bn=re(",");h(Me,bn)};R(ws,Me=>{s(C)>0&&Me(mn)})}var fs=a(ws,2),gn=n(fs,!0);e(fs),b(()=>r(gn,z)),h(A,ae)},A=>{vn();var z=re();b(C=>r(z,C),[()=>s(i).t(204)]),h(A,z)}),e(bs),b(A=>{r(Te,s(u).os.name),r(He,s(u).os.version),r(un,A)},[()=>s(i).t(161)]),h(P,G)};R(Ce,P=>{"os"in s(u)&&P(Re)})}b((P,G,K)=>{r(t,P),r(w,s(u).node),r(k,G),r(J,s(u).chrome),r(V,K),r(Z,s(u).electron)},[()=>s(i).t(133),()=>s(i).t(61),()=>s(i).t(83)]),h(d,p)};R(Us,d=>{s(u)&&d(Ps)})}e(Ve),e(ue);var be=a(ue,2),Ks=n(be,!0);e(be);var we=a(be,2),Ze=n(we),fe=n(Ze),Ws=n(fe,!0);e(fe);var ye=a(fe,2);{const d=p=>{var o=Mn(),t=n(o,!0);e(o),b(()=>r(t,x.data.parallelism)),h(p,o)};var Os=n(ye);{let p=f(()=>[d]),o=f(()=>s(i).cx(19));W(Os,{get t(){return s(p)},get x(){return s(o)}})}e(ye)}var xe=a(ye,2),Fs=n(xe,!0);e(xe);var ve=a(xe,2);{const d=p=>{var o=Ln(),t=n(o,!0);e(o),b(()=>r(t,x.data.parallelism)),h(p,o)};var Es=n(ve);{let p=f(()=>[d]),o=f(()=>s(i).cx(20));W(Es,{get t(){return s(p)},get x(){return s(o)}})}e(ve)}var je=a(ve,2),Gs=n(je,!0);e(je);var _e=a(je,2);{const d=p=>{var o=Vn();o.textContent=navigator.hardwareConcurrency,h(p,o)};var Cs=n(_e);{let p=f(()=>[d]),o=f(()=>s(i).cx(22));W(Cs,{get t(){return s(p)},get x(){return s(o)}})}e(_e)}e(Ze),e(we);var ke=a(we,2),Rs=n(ke,!0);e(ke);var Qe=a(ke,2),$e=n(Qe),Ts=n($e,!0);e($e),e(Qe);var qe=a(Qe,2),Hs=n(qe,!0);e(qe);var Ae=a(qe,2),es=n(Ae),De=n(es),Ns=n(De,!0);e(De);var Be=a(De,2),ss=n(Be),Ms=n(ss,!0);e(ss),e(Be);var Xe=a(Be,2),Ls=n(Xe,!0);e(Xe);var ns=a(Xe,2),is=n(ns),Vs=n(is,!0);e(is),e(ns),e(es),e(Ae);var ze=a(Ae,2),Zs=n(ze,!0);e(ze);var Ye=a(ze,2),as=n(Ye),Ie=n(as),_s=n(Ie,!0);e(Ie);var Se=a(Ie,2),$s=n(Se,!0);e(Se);var Je=a(Se,2),en=n(Je,!0);e(Je);var rs=a(Je,2),sn=n(rs,!0);e(rs),e(as),e(Ye);var Ue=a(Ye,2),nn=n(Ue,!0);e(Ue);var Pe=a(Ue,2),ts=n(Pe),Ke=n(ts),os=n(Ke),an=n(os,!0);e(os),e(Ke);var We=a(Ke,2),cs=n(We);{const d=(t,l=Q)=>{var c=Zn(),w=n(c,!0);e(c),b((m,k)=>{O(c,"href",m),r(w,k)},[()=>s(i).t(216),()=>s(i).tx(l())]),h(t,c)},p=(t,l=Q)=>{var c=_n(),w=n(c,!0);e(c),b((m,k)=>{O(c,"href",m),r(w,k)},[()=>s(i).t(217),()=>s(i).tx(l())]),h(t,c)},o=(t,l=Q)=>{var c=$n(),w=n(c,!0);e(c),b((m,k)=>{O(c,"href",m),r(w,k)},[()=>s(i).t(218),()=>s(i).tx(l())]),h(t,c)};var rn=n(cs);{let t=f(()=>[d,p,o]),l=f(()=>s(i).cx(193));W(rn,{get t(){return s(t)},get x(){return s(l)}})}e(cs)}e(We);var ps=a(We,4),ls=n(ps);{const d=(o,t=Q)=>{var l=ei(),c=n(l,!0);e(l),b((w,m)=>{O(l,"href",w),r(c,m)},[()=>s(i).t(213),()=>s(i).tx(t())]),h(o,l)},p=(o,t=Q)=>{var l=si(),c=n(l,!0);e(l),b((w,m)=>{O(l,"href",w),r(c,m)},[()=>s(i).t(214),()=>s(i).tx(t())]),h(o,l)};var tn=n(ls);{let o=f(()=>[d,p]),t=f(()=>s(i).cx(215));W(tn,{get t(){return s(o)},get x(){return s(t)}})}e(ls)}e(ps),e(ts),e(Pe);var Oe=a(Pe,2),on=n(Oe,!0);e(Oe);var Fe=a(Oe,2);{const d=(t,l=Q)=>{var c=ni(),w=n(c,!0);e(c),b(m=>r(w,m),[()=>s(i).tx(l())]),h(t,c)},p=(t,l=Q)=>{var c=ii(),w=n(c,!0);e(c),b(m=>r(w,m),[()=>s(i).tx(l())]),h(t,c)},o=(t,l=Q)=>{var c=ai(),w=n(c,!0);e(c),b(m=>r(w,m),[()=>s(i).tx(l())]),h(t,c)};var cn=n(Fe);{let t=f(()=>[d,p,o]),l=f(()=>s(i).cx(361));W(cn,{get t(){return s(t)},get x(){return s(l)}})}e(Fe)}var Ee=a(Fe,2),pn=n(Ee,!0);e(Ee);var Ge=a(Ee,2),ln=n(Ge);jn(ln,F,d=>{var p=ci(),o=n(p,!0);e(p),b(t=>r(o,t),[()=>s(i).t(54)]),h(d,p)},(d,p)=>{var o=ti();Le(o,21,()=>s(p),([t,l])=>t,(t,l,c,w)=>{var m=f(()=>xn(s(l),2));let k=()=>s(m)[0],I=()=>s(m)[1];var S=ri(),J=Y(S),D=n(J),V=n(D,!0);e(D),e(J);var X=a(J,2),U=n(X),Z=n(U,!0);e(U),e(X),b(()=>{O(D,"href",`https://npmjs.com/package/${k()??""}`),r(V,k()),r(Z,I())}),h(t,S)}),e(o),h(d,o)},(d,p)=>{var o=oi(),t=Y(o),l=n(t,!0);e(t);var c=a(t,2),w=n(c,!0);e(c),b(m=>{r(l,m),r(w,s(p))},[()=>s(i).t(113)]),h(d,o)}),e(Ge);var ds=a(Ge,4),hs=n(ds);$(hs,()=>"error",()=>Dn);var us=a(hs,2);$(us,()=>"warning",()=>Bn);var ms=a(us,2);$(ms,()=>"success",()=>An);var gs=a(ms,2);$(gs,()=>"primary",()=>Pn);var dn=a(gs,2);$(dn,()=>"neutral",()=>Wn),e(ds),e(j),b((d,p,o,t,l,c,w,m,k,I,S,J,D,V,X,U,Z,Ce,Re,P,G,K,Te,_,ne,He,ie)=>{r(te,d),r(v,p),r(As,o),r(Bs,t),r(zs,l),r(Is,c),r(Ss,w),r(Js,Xn),r(Ks,m),r(Ws,k),r(Fs,I),r(Gs,S),r(Rs,J),r(Ts,D),r(Hs,V),r(Ns,X),r(Ms,U),r(Ls,Z),r(Vs,Ce),r(Zs,Re),r(_s,P),r($s,G),r(en,K),r(sn,Te),r(nn,_),r(an,ne),r(on,He),r(pn,ie)},[()=>s(i).t(45),()=>s(i).t(63),()=>s(i).t(81),()=>s(i).t(162),()=>s(i).t(74),()=>s(i).t(186),()=>s(i).t(386),()=>s(i).t(140),()=>s(i).t(208),()=>s(i).t(196),()=>s(i).t(101),()=>s(i).t(67),()=>s(i).t(192),()=>s(i).t(42),()=>s(i).t(28),()=>s(i).t(121),()=>s(i).t(32),()=>s(i).t(23),()=>s(i).t(43),()=>s(i).t(80),()=>s(i).t(188),()=>s(i).t(62),()=>s(i).t(155),()=>s(i).t(97),()=>s(i).t(102),()=>s(i).t(103),()=>s(i).t(99)]),h(y,H),fn()}export{qi as component};
