import"../chunks/DsnmJJEf.js";import{as as He,y as ye,aA as fe,m as i,az as we,z as g,A as w,B as Ie,au as n,t as y,a as o,at as Fe,av as a,D as Je,ax as T,E as e,ay as L,aw as Me,ba as Le}from"../chunks/CAVl0i4x.js";import{s as t}from"../chunks/QHlMoSnV.js";import{a as Ee}from"../chunks/D2iw8d_X.js";import{i as A}from"../chunks/BJ8PpdDL.js";import{e as ae}from"../chunks/CjhfvqTy.js";import{c as xe}from"../chunks/QN1x3yhr.js";import{L as Ke}from"../chunks/SbDwaWaj.js";import{s as Re}from"../chunks/BbXJwlsT.js";import{g as E}from"../chunks/DgtYXTMU.js";const Ce=()=>"Developed by",je=()=>"Développé par",Ze=je,Ve=(h={},d={})=>{const s=d.locale??E();return s==="en"?Ce():s==="fr"?je():Ze()},Ne=()=>"About",ke=()=>"À propos",_e=ke,$e=(h={},d={})=>{const s=d.locale??E();return s==="en"?Ne():s==="fr"?ke():_e()},en=()=>"Under the supervision of",Qe=()=>"Sous la supervision de",nn=Qe,sn=(h={},d={})=>{const s=d.locale??E();return s==="en"?en():s==="fr"?Qe():nn()},an=()=>"As part of",Ae=()=>"Dans le cadre d'un",rn=Ae,tn=(h={},d={})=>{const s=d.locale??E();return s==="en"?an():s==="fr"?Ae():rn()},on=/("(?:\\?[^])*?")|(\/\/.*)|(\/\*[^]*?\*\/)/g,pn=/("(?:\\?[^])*?")|(,\s*)(?=]|})/g,ln={parse:h=>{h=String(h);try{return JSON.parse(h)}catch{return JSON.parse(h.replace(on,"$1").replace(pn,"$1"))}}},cn=`{
  "lockfileVersion": 1,
  "workspaces": {
    "": {
      "name": "CIGALE",
